...
public final class AbsListView_MultiChoiceModeListener implements org.mases.jcobridge.IJCListener, android.widget.AbsListView.MultiChoiceModeListener {
    ...
    int _onActionItemClickedIndex = 0;
    //@Override
    public boolean onActionItemClicked(android.view.ActionMode arg0, android.view.MenuItem arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActionItemClickedIndex <= 0) _onActionItemClickedIndex = getEventIndex("onActionItemClicked");
        raiseEvent(_onActionItemClickedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onCreateActionModeIndex = 0;
    //@Override
    public boolean onCreateActionMode(android.view.ActionMode arg0, android.view.Menu arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCreateActionModeIndex <= 0) _onCreateActionModeIndex = getEventIndex("onCreateActionMode");
        raiseEvent(_onCreateActionModeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onPrepareActionModeIndex = 0;
    //@Override
    public boolean onPrepareActionMode(android.view.ActionMode arg0, android.view.Menu arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPrepareActionModeIndex <= 0) _onPrepareActionModeIndex = getEventIndex("onPrepareActionMode");
        raiseEvent(_onPrepareActionModeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onDestroyActionModeIndex = 0;
    //@Override
    public void onDestroyActionMode(android.view.ActionMode arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDestroyActionModeIndex <= 0) _onDestroyActionModeIndex = getEventIndex("onDestroyActionMode");
        raiseEvent(_onDestroyActionModeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onItemCheckedStateChangedIndex = 0;
    //@Override
    public void onItemCheckedStateChanged(android.view.ActionMode arg0, int arg1, long arg2, boolean arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onItemCheckedStateChangedIndex <= 0) _onItemCheckedStateChangedIndex = getEventIndex("onItemCheckedStateChanged");
        raiseEvent(_onItemCheckedStateChangedIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
