...
public final class View_OnFocusChangeListener implements org.mases.jcobridge.IJCListener, android.view.View.OnFocusChangeListener {
     ...
     */
    public View_OnFocusChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFocusChangeIndex = 0;
    //@Override
    public void onFocusChange(android.view.View arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFocusChangeIndex <= 0) _onFocusChangeIndex = getEventIndex("onFocusChange");
        raiseEvent(_onFocusChangeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
