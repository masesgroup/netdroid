...
public final class ViewTreeObserver_OnWindowVisibilityChangeListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnWindowVisibilityChangeListener {
     ...
     */
    public ViewTreeObserver_OnWindowVisibilityChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onWindowVisibilityChangedIndex = 0;
    //@Override
    public void onWindowVisibilityChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWindowVisibilityChangedIndex <= 0) _onWindowVisibilityChangedIndex = getEventIndex("onWindowVisibilityChanged");
        raiseEvent(_onWindowVisibilityChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
