...
public final class MediaPlayer_OnMediaTimeDiscontinuityListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnMediaTimeDiscontinuityListener {
    ...
    int _onMediaTimeDiscontinuityIndex = 0;
    //@Override
    public void onMediaTimeDiscontinuity(android.media.MediaPlayer arg0, android.media.MediaTimestamp arg1) {
        ...
        if (_onMediaTimeDiscontinuityIndex <= 0) _onMediaTimeDiscontinuityIndex = getEventIndex("onMediaTimeDiscontinuity");
        raiseEvent(_onMediaTimeDiscontinuityIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
