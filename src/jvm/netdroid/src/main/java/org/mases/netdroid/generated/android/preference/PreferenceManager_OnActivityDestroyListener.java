...
public final class PreferenceManager_OnActivityDestroyListener implements org.mases.jcobridge.IJCListener, android.preference.PreferenceManager.OnActivityDestroyListener {
     ...
     */
    public PreferenceManager_OnActivityDestroyListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onActivityDestroyIndex = 0;
    //@Override
    public void onActivityDestroy() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActivityDestroyIndex <= 0) _onActivityDestroyIndex = getEventIndex("onActivityDestroy");
        raiseEvent(_onActivityDestroyIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
