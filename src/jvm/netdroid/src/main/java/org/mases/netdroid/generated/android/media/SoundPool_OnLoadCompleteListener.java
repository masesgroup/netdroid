...
public final class SoundPool_OnLoadCompleteListener implements org.mases.jcobridge.IJCListener, android.media.SoundPool.OnLoadCompleteListener {
     ...
     */
    public SoundPool_OnLoadCompleteListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onLoadCompleteIndex = 0;
    //@Override
    public void onLoadComplete(android.media.SoundPool arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onLoadCompleteIndex <= 0) _onLoadCompleteIndex = getEventIndex("onLoadComplete");
        raiseEvent(_onLoadCompleteIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
