...
public final class PackageManager_OnChecksumsReadyListener implements org.mases.jcobridge.IJCListener, android.content.pm.PackageManager.OnChecksumsReadyListener {
     ...
     */
    public PackageManager_OnChecksumsReadyListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onChecksumsReadyIndex = 0;
    //@Override
    public void onChecksumsReady(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChecksumsReadyIndex <= 0) _onChecksumsReadyIndex = getEventIndex("onChecksumsReady");
        raiseEvent(_onChecksumsReadyIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
