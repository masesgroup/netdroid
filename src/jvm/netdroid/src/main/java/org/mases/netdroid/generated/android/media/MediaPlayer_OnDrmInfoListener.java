...
public final class MediaPlayer_OnDrmInfoListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnDrmInfoListener {
     ...
     */
    public MediaPlayer_OnDrmInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDrmInfoIndex = 0;
    //@Override
    public void onDrmInfo(android.media.MediaPlayer arg0, android.media.MediaPlayer.DrmInfo arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDrmInfoIndex <= 0) _onDrmInfoIndex = getEventIndex("onDrmInfo");
        raiseEvent(_onDrmInfoIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
