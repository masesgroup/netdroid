...
public final class FragmentManager_OnBackStackChangedListener implements org.mases.jcobridge.IJCListener, android.app.FragmentManager.OnBackStackChangedListener {
    ...
    int _onBackStackChangedIndex = 0;
    //@Override
    public void onBackStackChanged() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBackStackChangedIndex <= 0) _onBackStackChangedIndex = getEventIndex("onBackStackChanged");
        raiseEvent(_onBackStackChangedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
