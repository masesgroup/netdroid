...
public final class ValueAnimator_DurationScaleChangeListener implements org.mases.jcobridge.IJCListener, android.animation.ValueAnimator.DurationScaleChangeListener {
    ...
    int _onChangedIndex = 0;
    //@Override
    public void onChanged(float arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChangedIndex <= 0) _onChangedIndex = getEventIndex("onChanged");
        raiseEvent(_onChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
