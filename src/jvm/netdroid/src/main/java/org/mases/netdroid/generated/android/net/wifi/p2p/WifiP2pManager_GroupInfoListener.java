...
public final class WifiP2pManager_GroupInfoListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.GroupInfoListener {
     ...
     */
    public WifiP2pManager_GroupInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGroupInfoAvailableIndex = 0;
    //@Override
    public void onGroupInfoAvailable(android.net.wifi.p2p.WifiP2pGroup arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGroupInfoAvailableIndex <= 0) _onGroupInfoAvailableIndex = getEventIndex("onGroupInfoAvailable");
        raiseEvent(_onGroupInfoAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
