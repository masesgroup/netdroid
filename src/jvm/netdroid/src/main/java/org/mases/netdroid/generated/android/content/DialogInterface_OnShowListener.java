...
public final class DialogInterface_OnShowListener implements org.mases.jcobridge.IJCListener, android.content.DialogInterface.OnShowListener {
    ...
    public void onShow(android.content.DialogInterface arg0) {
        ...
        if (_onShowIndex <= 0) _onShowIndex = getEventIndex("onShow");
        raiseEvent(_onShowIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
