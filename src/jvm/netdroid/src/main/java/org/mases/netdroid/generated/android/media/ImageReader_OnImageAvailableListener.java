...
public final class ImageReader_OnImageAvailableListener implements org.mases.jcobridge.IJCListener, android.media.ImageReader.OnImageAvailableListener {
     ...
     */
    public ImageReader_OnImageAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onImageAvailableIndex = 0;
    //@Override
    public void onImageAvailable(android.media.ImageReader arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onImageAvailableIndex <= 0) _onImageAvailableIndex = getEventIndex("onImageAvailable");
        raiseEvent(_onImageAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
