...
public final class TelephonyCallback_BarringInfoListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.BarringInfoListener {
     ...
     */
    public TelephonyCallback_BarringInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onBarringInfoChangedIndex = 0;
    //@Override
    public void onBarringInfoChanged(android.telephony.BarringInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBarringInfoChangedIndex <= 0) _onBarringInfoChangedIndex = getEventIndex("onBarringInfoChanged");
        raiseEvent(_onBarringInfoChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
