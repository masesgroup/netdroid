...
public final class AccessibilityManager_TouchExplorationStateChangeListener implements org.mases.jcobridge.IJCListener, android.view.accessibility.AccessibilityManager.TouchExplorationStateChangeListener {
     ...
     */
    public AccessibilityManager_TouchExplorationStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTouchExplorationStateChangedIndex = 0;
    //@Override
    public void onTouchExplorationStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTouchExplorationStateChangedIndex <= 0) _onTouchExplorationStateChangedIndex = getEventIndex("onTouchExplorationStateChanged");
        raiseEvent(_onTouchExplorationStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
