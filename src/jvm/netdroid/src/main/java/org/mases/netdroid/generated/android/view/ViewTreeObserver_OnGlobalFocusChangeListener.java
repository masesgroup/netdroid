...
public final class ViewTreeObserver_OnGlobalFocusChangeListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnGlobalFocusChangeListener {
     ...
     */
    public ViewTreeObserver_OnGlobalFocusChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGlobalFocusChangedIndex = 0;
    //@Override
    public void onGlobalFocusChanged(android.view.View arg0, android.view.View arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGlobalFocusChangedIndex <= 0) _onGlobalFocusChangedIndex = getEventIndex("onGlobalFocusChanged");
        raiseEvent(_onGlobalFocusChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
