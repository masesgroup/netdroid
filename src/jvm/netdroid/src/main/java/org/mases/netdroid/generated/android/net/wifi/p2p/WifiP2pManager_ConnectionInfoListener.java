...
public final class WifiP2pManager_ConnectionInfoListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.ConnectionInfoListener {
     ...
     */
    public WifiP2pManager_ConnectionInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onConnectionInfoAvailableIndex = 0;
    //@Override
    public void onConnectionInfoAvailable(android.net.wifi.p2p.WifiP2pInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onConnectionInfoAvailableIndex <= 0) _onConnectionInfoAvailableIndex = getEventIndex("onConnectionInfoAvailable");
        raiseEvent(_onConnectionInfoAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
