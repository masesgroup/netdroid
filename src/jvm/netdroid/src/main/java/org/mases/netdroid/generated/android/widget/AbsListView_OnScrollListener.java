...
public final class AbsListView_OnScrollListener implements org.mases.jcobridge.IJCListener, android.widget.AbsListView.OnScrollListener {
     ...
     */
    public AbsListView_OnScrollListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    //@Override
    public void onScroll(android.widget.AbsListView arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollIndex <= 0) _onScrollIndex = getEventIndex("onScroll");
        raiseEvent(_onScrollIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onScrollStateChangedIndex = 0;
    //@Override
    public void onScrollStateChanged(android.widget.AbsListView arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollStateChangedIndex <= 0) _onScrollStateChangedIndex = getEventIndex("onScrollStateChanged");
        raiseEvent(_onScrollStateChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
