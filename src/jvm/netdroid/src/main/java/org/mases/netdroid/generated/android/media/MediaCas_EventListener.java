...
public final class MediaCas_EventListener implements org.mases.jcobridge.IJCListener, android.media.MediaCas.EventListener {
    ...
    public void onEvent(android.media.MediaCas arg0, int arg1, int arg2, byte[] arg3) {
        ...
        raiseEvent(_onEventIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onPluginStatusUpdateIndex = 0;
    //@Override
    public void onPluginStatusUpdate(android.media.MediaCas arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPluginStatusUpdateIndex <= 0) _onPluginStatusUpdateIndex = getEventIndex("onPluginStatusUpdate");
        raiseEvent(_onPluginStatusUpdateIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) android.media.MediaCas.EventListener.super.onPluginStatusUpdate(arg0, arg1, arg2);
    }
    ...
    int _onResourceLostIndex = 0;
    //@Override
    public void onResourceLost(android.media.MediaCas arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onResourceLostIndex <= 0) _onResourceLostIndex = getEventIndex("onResourceLost");
        raiseEvent(_onResourceLostIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.media.MediaCas.EventListener.super.onResourceLost(arg0);
    }
    ...
    int _onSessionEventIndex = 0;
    //@Override
    public void onSessionEvent(android.media.MediaCas arg0, android.media.MediaCas.Session arg1, int arg2, int arg3, byte[] arg4) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSessionEventIndex <= 0) _onSessionEventIndex = getEventIndex("onSessionEvent");
        raiseEvent(_onSessionEventIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4); if (!eventDataExchange.getHasOverride()) android.media.MediaCas.EventListener.super.onSessionEvent(arg0, arg1, arg2, arg3, arg4);
    }
