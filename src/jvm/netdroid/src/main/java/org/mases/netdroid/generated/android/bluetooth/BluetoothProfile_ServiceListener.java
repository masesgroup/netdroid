...
public final class BluetoothProfile_ServiceListener implements org.mases.jcobridge.IJCListener, android.bluetooth.BluetoothProfile.ServiceListener {
    ...
    int _onServiceConnectedIndex = 0;
    //@Override
    public void onServiceConnected(int arg0, android.bluetooth.BluetoothProfile arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceConnectedIndex <= 0) _onServiceConnectedIndex = getEventIndex("onServiceConnected");
        raiseEvent(_onServiceConnectedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceDisconnectedIndex = 0;
    //@Override
    public void onServiceDisconnected(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceDisconnectedIndex <= 0) _onServiceDisconnectedIndex = getEventIndex("onServiceDisconnected");
        raiseEvent(_onServiceDisconnectedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
