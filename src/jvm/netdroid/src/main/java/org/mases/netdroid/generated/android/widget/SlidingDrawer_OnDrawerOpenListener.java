...
public final class SlidingDrawer_OnDrawerOpenListener implements org.mases.jcobridge.IJCListener, android.widget.SlidingDrawer.OnDrawerOpenListener {
     ...
     */
    public SlidingDrawer_OnDrawerOpenListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDrawerOpenedIndex = 0;
    //@Override
    public void onDrawerOpened() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDrawerOpenedIndex <= 0) _onDrawerOpenedIndex = getEventIndex("onDrawerOpened");
        raiseEvent(_onDrawerOpenedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
