...
package org.mases.netdroid.generated.android.view.contentcapture;

public final class DataShareWriteAdapter implements org.mases.jcobridge.IJCListener, android.view.contentcapture.DataShareWriteAdapter {
     ...
     */
    public DataShareWriteAdapter(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onRejectedIndex = 0;
    //@Override
    public void onRejected() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRejectedIndex <= 0) _onRejectedIndex = getEventIndex("onRejected");
        raiseEvent(_onRejectedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onWriteIndex = 0;
    //@Override
    public void onWrite(android.os.ParcelFileDescriptor arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWriteIndex <= 0) _onWriteIndex = getEventIndex("onWrite");
        raiseEvent(_onWriteIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onErrorIndex = 0;
    //@Override
    public void onError(int arg0) {
        ...
        raiseEvent(_onErrorIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.view.contentcapture.DataShareWriteAdapter.super.onError(arg0);
    }
    
    //@Override
    public void onErrorDefault(int arg0) {
        android.view.contentcapture.DataShareWriteAdapter.super.onError(arg0);
    }
