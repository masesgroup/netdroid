...
public final class ElementListener implements org.mases.jcobridge.IJCListener, android.sax.ElementListener {
     ...
     */
    public ElementListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void end() {
        ...
        raiseEvent(_endIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _startIndex = 0;
    //@Override
