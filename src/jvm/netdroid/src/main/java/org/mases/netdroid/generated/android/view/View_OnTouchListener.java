...
public final class View_OnTouchListener implements org.mases.jcobridge.IJCListener, android.view.View.OnTouchListener {
     ...
     */
    public View_OnTouchListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public boolean onTouch(android.view.View arg0, android.view.MotionEvent arg1) {
        ...
        if (_onTouchIndex <= 0) _onTouchIndex = getEventIndex("onTouch");
        raiseEvent(_onTouchIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
