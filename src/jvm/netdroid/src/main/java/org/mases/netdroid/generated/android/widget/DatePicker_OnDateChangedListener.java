...
public final class DatePicker_OnDateChangedListener implements org.mases.jcobridge.IJCListener, android.widget.DatePicker.OnDateChangedListener {
     ...
     */
    public DatePicker_OnDateChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDateChangedIndex = 0;
    //@Override
    public void onDateChanged(android.widget.DatePicker arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDateChangedIndex <= 0) _onDateChangedIndex = getEventIndex("onDateChanged");
        raiseEvent(_onDateChangedIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
