...
public final class GnssAntennaInfo_Listener implements org.mases.jcobridge.IJCListener, android.location.GnssAntennaInfo.Listener {
     ...
     */
    public GnssAntennaInfo_Listener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGnssAntennaInfoReceivedIndex = 0;
    //@Override
    public void onGnssAntennaInfoReceived(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGnssAntennaInfoReceivedIndex <= 0) _onGnssAntennaInfoReceivedIndex = getEventIndex("onGnssAntennaInfoReceived");
        raiseEvent(_onGnssAntennaInfoReceivedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
