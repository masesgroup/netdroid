...
package org.mases.netdroid.generated.android.se.omapi;

public final class SEService_OnConnectedListener implements org.mases.jcobridge.IJCListener, android.se.omapi.SEService.OnConnectedListener {
     ...
     */
    public SEService_OnConnectedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onConnectedIndex = 0;
    //@Override
    public void onConnected() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onConnectedIndex <= 0) _onConnectedIndex = getEventIndex("onConnected");
        raiseEvent(_onConnectedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
