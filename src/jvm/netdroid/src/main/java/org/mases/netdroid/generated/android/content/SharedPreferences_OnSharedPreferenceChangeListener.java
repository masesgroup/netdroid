...
public final class SharedPreferences_OnSharedPreferenceChangeListener implements org.mases.jcobridge.IJCListener, android.content.SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    public SharedPreferences_OnSharedPreferenceChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSharedPreferenceChangedIndex = 0;
    //@Override
    public void onSharedPreferenceChanged(android.content.SharedPreferences arg0, java.lang.String arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSharedPreferenceChangedIndex <= 0) _onSharedPreferenceChangedIndex = getEventIndex("onSharedPreferenceChanged");
        raiseEvent(_onSharedPreferenceChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
