...
package org.mases.netdroid.generated.android.view.textservice;

public final class SpellCheckerSession_SpellCheckerSessionListener implements org.mases.jcobridge.IJCListener, android.view.textservice.SpellCheckerSession.SpellCheckerSessionListener {
     ...
     */
    public SpellCheckerSession_SpellCheckerSessionListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGetSentenceSuggestionsIndex = 0;
    //@Override
    public void onGetSentenceSuggestions(android.view.textservice.SentenceSuggestionsInfo[] arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGetSentenceSuggestionsIndex <= 0) _onGetSentenceSuggestionsIndex = getEventIndex("onGetSentenceSuggestions");
        raiseEvent(_onGetSentenceSuggestionsIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onGetSuggestionsIndex = 0;
    //@Override
    public void onGetSuggestions(android.view.textservice.SuggestionsInfo[] arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGetSuggestionsIndex <= 0) _onGetSuggestionsIndex = getEventIndex("onGetSuggestions");
        raiseEvent(_onGetSuggestionsIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
