...
public final class MediaDrm_OnKeyStatusChangeListener implements org.mases.jcobridge.IJCListener, android.media.MediaDrm.OnKeyStatusChangeListener {
    ...
    int _onKeyStatusChangeIndex = 0;
    //@Override
    public void onKeyStatusChange(android.media.MediaDrm arg0, byte[] arg1, java.util.List arg2, boolean arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onKeyStatusChangeIndex <= 0) _onKeyStatusChangeIndex = getEventIndex("onKeyStatusChange");
        raiseEvent(_onKeyStatusChangeIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
