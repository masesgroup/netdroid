...
public final class CancellationSignal_OnCancelListener implements org.mases.jcobridge.IJCListener, android.os.CancellationSignal.OnCancelListener {
     ...
     */
    public CancellationSignal_OnCancelListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCancelIndex = 0;
    //@Override
    public void onCancel() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCancelIndex <= 0) _onCancelIndex = getEventIndex("onCancel");
        raiseEvent(_onCancelIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
