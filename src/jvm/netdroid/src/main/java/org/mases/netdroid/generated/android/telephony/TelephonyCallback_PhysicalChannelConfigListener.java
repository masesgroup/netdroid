...
public final class TelephonyCallback_PhysicalChannelConfigListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.PhysicalChannelConfigListener {
     ...
     */
    public TelephonyCallback_PhysicalChannelConfigListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPhysicalChannelConfigChangedIndex = 0;
    //@Override
    public void onPhysicalChannelConfigChanged(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPhysicalChannelConfigChangedIndex <= 0) _onPhysicalChannelConfigChangedIndex = getEventIndex("onPhysicalChannelConfigChanged");
        raiseEvent(_onPhysicalChannelConfigChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
