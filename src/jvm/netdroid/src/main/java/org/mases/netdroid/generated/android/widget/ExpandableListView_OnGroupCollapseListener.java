...
public final class ExpandableListView_OnGroupCollapseListener implements org.mases.jcobridge.IJCListener, android.widget.ExpandableListView.OnGroupCollapseListener {
     ...
     */
    public ExpandableListView_OnGroupCollapseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onGroupCollapse(int arg0) {
        ...
        raiseEvent(_onGroupCollapseIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
