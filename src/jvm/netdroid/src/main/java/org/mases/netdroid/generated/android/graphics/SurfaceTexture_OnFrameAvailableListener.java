...
public final class SurfaceTexture_OnFrameAvailableListener implements org.mases.jcobridge.IJCListener, android.graphics.SurfaceTexture.OnFrameAvailableListener {
     ...
     */
    public SurfaceTexture_OnFrameAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFrameAvailableIndex = 0;
    //@Override
    public void onFrameAvailable(android.graphics.SurfaceTexture arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFrameAvailableIndex <= 0) _onFrameAvailableIndex = getEventIndex("onFrameAvailable");
        raiseEvent(_onFrameAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
