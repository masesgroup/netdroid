...
public final class WebView_PictureListener implements org.mases.jcobridge.IJCListener, android.webkit.WebView.PictureListener {
     ...
     */
    public WebView_PictureListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onNewPictureIndex = 0;
    //@Override
    public void onNewPicture(android.webkit.WebView arg0, android.graphics.Picture arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNewPictureIndex <= 0) _onNewPictureIndex = getEventIndex("onNewPicture");
        raiseEvent(_onNewPictureIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
