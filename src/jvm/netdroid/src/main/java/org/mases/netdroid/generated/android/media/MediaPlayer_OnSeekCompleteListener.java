...
public final class MediaPlayer_OnSeekCompleteListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnSeekCompleteListener {
     ...
     */
    public MediaPlayer_OnSeekCompleteListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSeekCompleteIndex = 0;
    //@Override
    public void onSeekComplete(android.media.MediaPlayer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSeekCompleteIndex <= 0) _onSeekCompleteIndex = getEventIndex("onSeekComplete");
        raiseEvent(_onSeekCompleteIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
