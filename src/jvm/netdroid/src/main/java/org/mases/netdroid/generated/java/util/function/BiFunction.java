...
public final class BiFunction implements org.mases.jcobridge.IJCListener, java.util.function.BiFunction {
    ...
    public java.util.function.BiFunction andThen(java.util.function.Function arg0) {
        ...
        raiseEvent(_andThenIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.BiFunction.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.BiFunction)retVal;
    }
