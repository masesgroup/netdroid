...
public final class WifiP2pManager_ServiceResponseListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.ServiceResponseListener {
     ...
     */
    public WifiP2pManager_ServiceResponseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onServiceAvailableIndex = 0;
    //@Override
    public void onServiceAvailable(int arg0, byte[] arg1, android.net.wifi.p2p.WifiP2pDevice arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceAvailableIndex <= 0) _onServiceAvailableIndex = getEventIndex("onServiceAvailable");
        raiseEvent(_onServiceAvailableIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onUsdBasedServiceAvailableIndex = 0;
    //@Override
    public void onUsdBasedServiceAvailable(android.net.wifi.p2p.WifiP2pDevice arg0, android.net.wifi.p2p.nsd.WifiP2pUsdBasedServiceResponse arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUsdBasedServiceAvailableIndex <= 0) _onUsdBasedServiceAvailableIndex = getEventIndex("onUsdBasedServiceAvailable");
        raiseEvent(_onUsdBasedServiceAvailableIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) android.net.wifi.p2p.WifiP2pManager.ServiceResponseListener.super.onUsdBasedServiceAvailable(arg0, arg1);
    }
