...
package org.mases.netdroid.generated.android.net;

public final class ConnectivityManager_OnNetworkActiveListener implements org.mases.jcobridge.IJCListener, android.net.ConnectivityManager.OnNetworkActiveListener {
     ...
     */
    public ConnectivityManager_OnNetworkActiveListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onNetworkActiveIndex = 0;
    //@Override
    public void onNetworkActive() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNetworkActiveIndex <= 0) _onNetworkActiveIndex = getEventIndex("onNetworkActive");
        raiseEvent(_onNetworkActiveIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
