...
package org.mases.netdroid.generated.android.sax;

public final class TextElementListener implements org.mases.jcobridge.IJCListener, android.sax.TextElementListener {
     ...
     */
    public TextElementListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void end(java.lang.String arg0) {
        ...
        if (_endIndex <= 0) _endIndex = getEventIndex("end");
        raiseEvent(_endIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _startIndex = 0;
    //@Override
    public void start(org.xml.sax.Attributes arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_startIndex <= 0) _startIndex = getEventIndex("start");
        raiseEvent(_startIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
