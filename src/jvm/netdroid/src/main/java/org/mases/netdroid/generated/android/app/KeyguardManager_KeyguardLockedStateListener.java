...
public final class KeyguardManager_KeyguardLockedStateListener implements org.mases.jcobridge.IJCListener, android.app.KeyguardManager.KeyguardLockedStateListener {
    ...
    int _onKeyguardLockedStateChangedIndex = 0;
    //@Override
    public void onKeyguardLockedStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onKeyguardLockedStateChangedIndex <= 0) _onKeyguardLockedStateChangedIndex = getEventIndex("onKeyguardLockedStateChanged");
        raiseEvent(_onKeyguardLockedStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
