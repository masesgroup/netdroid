...
public final class MediaRouter2_OnGetControllerHintsListener implements org.mases.jcobridge.IJCListener, android.media.MediaRouter2.OnGetControllerHintsListener {
     ...
     */
    public MediaRouter2_OnGetControllerHintsListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGetControllerHintsIndex = 0;
    //@Override
    public android.os.Bundle onGetControllerHints(android.media.MediaRoute2Info arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGetControllerHintsIndex <= 0) _onGetControllerHintsIndex = getEventIndex("onGetControllerHints");
        raiseEvent(_onGetControllerHintsIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (android.os.Bundle)retVal;
    }
