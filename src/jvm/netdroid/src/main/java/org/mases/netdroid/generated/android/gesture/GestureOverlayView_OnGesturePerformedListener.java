...
public final class GestureOverlayView_OnGesturePerformedListener implements org.mases.jcobridge.IJCListener, android.gesture.GestureOverlayView.OnGesturePerformedListener {
     ...
     */
    public GestureOverlayView_OnGesturePerformedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGesturePerformedIndex = 0;
    //@Override
    public void onGesturePerformed(android.gesture.GestureOverlayView arg0, android.gesture.Gesture arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGesturePerformedIndex <= 0) _onGesturePerformedIndex = getEventIndex("onGesturePerformed");
        raiseEvent(_onGesturePerformedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
