...
public final class UiModeManager_ContrastChangeListener implements org.mases.jcobridge.IJCListener, android.app.UiModeManager.ContrastChangeListener {
     ...
     */
    public UiModeManager_ContrastChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onContrastChangedIndex = 0;
    //@Override
    public void onContrastChanged(float arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onContrastChangedIndex <= 0) _onContrastChangedIndex = getEventIndex("onContrastChanged");
        raiseEvent(_onContrastChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
