...
public final class ActionBar_OnMenuVisibilityListener implements org.mases.jcobridge.IJCListener, android.app.ActionBar.OnMenuVisibilityListener {
    ...
    int _onMenuVisibilityChangedIndex = 0;
    //@Override
    public void onMenuVisibilityChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMenuVisibilityChangedIndex <= 0) _onMenuVisibilityChangedIndex = getEventIndex("onMenuVisibilityChanged");
        raiseEvent(_onMenuVisibilityChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
