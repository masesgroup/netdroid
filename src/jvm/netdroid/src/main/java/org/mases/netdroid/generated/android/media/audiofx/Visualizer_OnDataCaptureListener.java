...
package org.mases.netdroid.generated.android.media.audiofx;

public final class Visualizer_OnDataCaptureListener implements org.mases.jcobridge.IJCListener, android.media.audiofx.Visualizer.OnDataCaptureListener {
     ...
     */
    public Visualizer_OnDataCaptureListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFftDataCaptureIndex = 0;
    //@Override
    public void onFftDataCapture(android.media.audiofx.Visualizer arg0, byte[] arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFftDataCaptureIndex <= 0) _onFftDataCaptureIndex = getEventIndex("onFftDataCapture");
        raiseEvent(_onFftDataCaptureIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onWaveFormDataCaptureIndex = 0;
    //@Override
    public void onWaveFormDataCapture(android.media.audiofx.Visualizer arg0, byte[] arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWaveFormDataCaptureIndex <= 0) _onWaveFormDataCaptureIndex = getEventIndex("onWaveFormDataCapture");
        raiseEvent(_onWaveFormDataCaptureIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
