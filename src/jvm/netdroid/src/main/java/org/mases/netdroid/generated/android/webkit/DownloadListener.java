...
public final class DownloadListener implements org.mases.jcobridge.IJCListener, android.webkit.DownloadListener {
     ...
     */
    public DownloadListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onDownloadStart(java.lang.String arg0, java.lang.String arg1, java.lang.String arg2, java.lang.String arg3, long arg4) {
        ...
        if (_onDownloadStartIndex <= 0) _onDownloadStartIndex = getEventIndex("onDownloadStart");
        raiseEvent(_onDownloadStartIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
