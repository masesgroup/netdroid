...
public final class JetPlayer_OnJetEventListener implements org.mases.jcobridge.IJCListener, android.media.JetPlayer.OnJetEventListener {
    ...
    public void onJetEvent(android.media.JetPlayer arg0, short arg1, byte arg2, byte arg3, byte arg4, byte arg5) {
        ...
        if (_onJetEventIndex <= 0) _onJetEventIndex = getEventIndex("onJetEvent");
        raiseEvent(_onJetEventIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4, arg5); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onJetNumQueuedSegmentUpdateIndex = 0;
    //@Override
    public void onJetNumQueuedSegmentUpdate(android.media.JetPlayer arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onJetNumQueuedSegmentUpdateIndex <= 0) _onJetNumQueuedSegmentUpdateIndex = getEventIndex("onJetNumQueuedSegmentUpdate");
        raiseEvent(_onJetNumQueuedSegmentUpdateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onJetPauseUpdateIndex = 0;
    //@Override
    public void onJetPauseUpdate(android.media.JetPlayer arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onJetPauseUpdateIndex <= 0) _onJetPauseUpdateIndex = getEventIndex("onJetPauseUpdate");
        raiseEvent(_onJetPauseUpdateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onJetUserIdUpdateIndex = 0;
    //@Override
    public void onJetUserIdUpdate(android.media.JetPlayer arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onJetUserIdUpdateIndex <= 0) _onJetUserIdUpdateIndex = getEventIndex("onJetUserIdUpdate");
        raiseEvent(_onJetUserIdUpdateIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
