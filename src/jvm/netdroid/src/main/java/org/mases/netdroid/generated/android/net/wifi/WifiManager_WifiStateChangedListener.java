...
public final class WifiManager_WifiStateChangedListener implements org.mases.jcobridge.IJCListener, android.net.wifi.WifiManager.WifiStateChangedListener {
     ...
     */
    public WifiManager_WifiStateChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onWifiStateChangedIndex = 0;
    //@Override
    public void onWifiStateChanged() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWifiStateChangedIndex <= 0) _onWifiStateChangedIndex = getEventIndex("onWifiStateChanged");
        raiseEvent(_onWifiStateChangedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
