...
public final class ImageWriter_OnImageReleasedListener implements org.mases.jcobridge.IJCListener, android.media.ImageWriter.OnImageReleasedListener {
     ...
     */
    public ImageWriter_OnImageReleasedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onImageReleasedIndex = 0;
    //@Override
    public void onImageReleased(android.media.ImageWriter arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onImageReleasedIndex <= 0) _onImageReleasedIndex = getEventIndex("onImageReleased");
        raiseEvent(_onImageReleasedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
