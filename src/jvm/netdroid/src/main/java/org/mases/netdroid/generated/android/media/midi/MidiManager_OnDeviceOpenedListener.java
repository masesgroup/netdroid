...
package org.mases.netdroid.generated.android.media.midi;

public final class MidiManager_OnDeviceOpenedListener implements org.mases.jcobridge.IJCListener, android.media.midi.MidiManager.OnDeviceOpenedListener {
     ...
     */
    public MidiManager_OnDeviceOpenedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDeviceOpenedIndex = 0;
    //@Override
    public void onDeviceOpened(android.media.midi.MidiDevice arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDeviceOpenedIndex <= 0) _onDeviceOpenedIndex = getEventIndex("onDeviceOpened");
        raiseEvent(_onDeviceOpenedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
