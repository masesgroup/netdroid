...
public final class View_OnLayoutChangeListener implements org.mases.jcobridge.IJCListener, android.view.View.OnLayoutChangeListener {
    ...
    public void onLayoutChange(android.view.View arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        ...
        if (_onLayoutChangeIndex <= 0) _onLayoutChangeIndex = getEventIndex("onLayoutChange");
        raiseEvent(_onLayoutChangeIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
