...
public final class TelephonyCallback_ImsCallDisconnectCauseListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.ImsCallDisconnectCauseListener {
     ...
     */
    public TelephonyCallback_ImsCallDisconnectCauseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onImsCallDisconnectCauseChangedIndex = 0;
    //@Override
    public void onImsCallDisconnectCauseChanged(android.telephony.ims.ImsReasonInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onImsCallDisconnectCauseChangedIndex <= 0) _onImsCallDisconnectCauseChangedIndex = getEventIndex("onImsCallDisconnectCauseChanged");
        raiseEvent(_onImsCallDisconnectCauseChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
