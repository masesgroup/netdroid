...
public final class View_OnDragListener implements org.mases.jcobridge.IJCListener, android.view.View.OnDragListener {
    ...
    public boolean onDrag(android.view.View arg0, android.view.DragEvent arg1) {
        ...
        if (_onDragIndex <= 0) _onDragIndex = getEventIndex("onDrag");
        raiseEvent(_onDragIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
