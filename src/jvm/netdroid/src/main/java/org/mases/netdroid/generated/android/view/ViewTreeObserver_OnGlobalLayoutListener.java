...
public final class ViewTreeObserver_OnGlobalLayoutListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnGlobalLayoutListener {
     ...
     */
    public ViewTreeObserver_OnGlobalLayoutListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onGlobalLayout() {
        ...
        raiseEvent(_onGlobalLayoutIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
