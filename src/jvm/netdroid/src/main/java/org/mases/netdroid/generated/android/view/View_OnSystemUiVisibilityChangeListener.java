...
public final class View_OnSystemUiVisibilityChangeListener implements org.mases.jcobridge.IJCListener, android.view.View.OnSystemUiVisibilityChangeListener {
     ...
     */
    public View_OnSystemUiVisibilityChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSystemUiVisibilityChangeIndex = 0;
    //@Override
    public void onSystemUiVisibilityChange(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSystemUiVisibilityChangeIndex <= 0) _onSystemUiVisibilityChangeIndex = getEventIndex("onSystemUiVisibilityChange");
        raiseEvent(_onSystemUiVisibilityChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
