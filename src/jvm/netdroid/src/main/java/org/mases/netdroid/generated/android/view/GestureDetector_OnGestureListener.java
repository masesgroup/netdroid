...
public final class GestureDetector_OnGestureListener implements org.mases.jcobridge.IJCListener, android.view.GestureDetector.OnGestureListener {
     ...
     */
    public GestureDetector_OnGestureListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public boolean onDown(android.view.MotionEvent arg0) {
        ...
        raiseEvent(_onDownIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onFlingIndex = 0;
    //@Override
    ...
    public boolean onScroll(android.view.MotionEvent arg0, android.view.MotionEvent arg1, float arg2, float arg3) {
        ...
        raiseEvent(_onScrollIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    ...
    public boolean onSingleTapUp(android.view.MotionEvent arg0) {
        ...
        raiseEvent(_onSingleTapUpIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    ...
    public void onLongPress(android.view.MotionEvent arg0) {
        ...
        raiseEvent(_onLongPressIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void onShowPress(android.view.MotionEvent arg0) {
        ...
        raiseEvent(_onShowPressIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
