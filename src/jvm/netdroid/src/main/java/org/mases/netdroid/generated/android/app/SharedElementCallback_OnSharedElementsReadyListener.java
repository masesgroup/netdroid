...
public final class SharedElementCallback_OnSharedElementsReadyListener implements org.mases.jcobridge.IJCListener, android.app.SharedElementCallback.OnSharedElementsReadyListener {
     ...
     */
    public SharedElementCallback_OnSharedElementsReadyListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSharedElementsReadyIndex = 0;
    //@Override
    public void onSharedElementsReady() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSharedElementsReadyIndex <= 0) _onSharedElementsReadyIndex = getEventIndex("onSharedElementsReady");
        raiseEvent(_onSharedElementsReadyIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
