...
public final class Loader_OnLoadCanceledListener implements org.mases.jcobridge.IJCListener, android.content.Loader.OnLoadCanceledListener {
     ...
     */
    public Loader_OnLoadCanceledListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onLoadCanceledIndex = 0;
    //@Override
    public void onLoadCanceled(android.content.Loader arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onLoadCanceledIndex <= 0) _onLoadCanceledIndex = getEventIndex("onLoadCanceled");
        raiseEvent(_onLoadCanceledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
