...
public final class ActionBar_OnNavigationListener implements org.mases.jcobridge.IJCListener, android.app.ActionBar.OnNavigationListener {
    ...
    int _onNavigationItemSelectedIndex = 0;
    //@Override
    public boolean onNavigationItemSelected(int arg0, long arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNavigationItemSelectedIndex <= 0) _onNavigationItemSelectedIndex = getEventIndex("onNavigationItemSelected");
        raiseEvent(_onNavigationItemSelectedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
