...
public final class TelephonyCallback_UserMobileDataStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.UserMobileDataStateListener {
     ...
     */
    public TelephonyCallback_UserMobileDataStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onUserMobileDataStateChangedIndex = 0;
    //@Override
    public void onUserMobileDataStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUserMobileDataStateChangedIndex <= 0) _onUserMobileDataStateChangedIndex = getEventIndex("onUserMobileDataStateChanged");
        raiseEvent(_onUserMobileDataStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
