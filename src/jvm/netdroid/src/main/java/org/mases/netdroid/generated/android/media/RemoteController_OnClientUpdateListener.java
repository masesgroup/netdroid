...
public final class RemoteController_OnClientUpdateListener implements org.mases.jcobridge.IJCListener, android.media.RemoteController.OnClientUpdateListener {
    ...
    int _onClientChangeIndex = 0;
    //@Override
    public void onClientChange(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onClientChangeIndex <= 0) _onClientChangeIndex = getEventIndex("onClientChange");
        raiseEvent(_onClientChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onClientMetadataUpdateIndex = 0;
    //@Override
    public void onClientMetadataUpdate(android.media.RemoteController.MetadataEditor arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onClientMetadataUpdateIndex <= 0) _onClientMetadataUpdateIndex = getEventIndex("onClientMetadataUpdate");
        raiseEvent(_onClientMetadataUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onClientPlaybackStateUpdateIndex = 0;
    //@Override
    public void onClientPlaybackStateUpdate(int arg0, long arg1, long arg2, float arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onClientPlaybackStateUpdateIndex <= 0) _onClientPlaybackStateUpdateIndex = getEventIndex("onClientPlaybackStateUpdate");
        raiseEvent(_onClientPlaybackStateUpdateIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onClientPlaybackStateUpdate1Index = 0;
    //@Override
    public void onClientPlaybackStateUpdate(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onClientPlaybackStateUpdate1Index <= 0) _onClientPlaybackStateUpdate1Index = getEventIndex("onClientPlaybackStateUpdate1");
        raiseEvent(_onClientPlaybackStateUpdate1Index, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onClientTransportControlUpdateIndex = 0;
    //@Override
    public void onClientTransportControlUpdate(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onClientTransportControlUpdateIndex <= 0) _onClientTransportControlUpdateIndex = getEventIndex("onClientTransportControlUpdate");
        raiseEvent(_onClientTransportControlUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
