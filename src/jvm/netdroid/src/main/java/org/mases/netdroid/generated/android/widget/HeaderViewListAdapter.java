...
public final class HeaderViewListAdapter extends org.mases.jcobridge.JCListener implements android.widget.WrapperListAdapter, android.widget.Filterable {
    public HeaderViewListAdapter(String key) throws org.mases.jcobridge.JCNativeException {
        super(key);
    }
    ...
    public android.widget.ListAdapter getWrappedAdapter() {
        raiseEvent("getWrappedAdapter"); Object retVal = getReturnData(); return (android.widget.ListAdapter)retVal;
    }
    //@Override
    ...
    //@Override
    public boolean removeFooter(android.view.View arg0) {
        raiseEvent("removeFooter", arg0); Object retVal = getReturnData(); return (boolean)retVal;
    }
    //@Override
    public boolean removeHeader(android.view.View arg0) {
        raiseEvent("removeHeader", arg0); Object retVal = getReturnData(); return (boolean)retVal;
    }
    //@Override
    ...
    public java.lang.CharSequence[] getAutofillOptionsDefault() {
        return android.widget.HeaderViewListAdapter.super.getAutofillOptions();
    }
    //@Override
    public int getCount() {
    ...
    public int getFootersCount() {
        raiseEvent("getFootersCount"); Object retVal = getReturnData(); return (int)retVal;
    }
    //@Override
    public int getHeadersCount() {
        raiseEvent("getHeadersCount"); Object retVal = getReturnData(); return (int)retVal;
    }
    //@Override
