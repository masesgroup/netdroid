...
public final class TelephonyCallback_CallStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CallStateListener {
     ...
     */
    public TelephonyCallback_CallStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCallStateChangedIndex = 0;
    //@Override
    public void onCallStateChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCallStateChangedIndex <= 0) _onCallStateChangedIndex = getEventIndex("onCallStateChanged");
        raiseEvent(_onCallStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
