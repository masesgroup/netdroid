...
public final class Allocation_OnBufferAvailableListener implements org.mases.jcobridge.IJCListener, android.renderscript.Allocation.OnBufferAvailableListener {
     ...
     */
    public Allocation_OnBufferAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onBufferAvailableIndex = 0;
    //@Override
    public void onBufferAvailable(android.renderscript.Allocation arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBufferAvailableIndex <= 0) _onBufferAvailableIndex = getEventIndex("onBufferAvailable");
        raiseEvent(_onBufferAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
