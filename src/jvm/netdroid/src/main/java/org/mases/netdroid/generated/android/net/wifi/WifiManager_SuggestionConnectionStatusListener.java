...
public final class WifiManager_SuggestionConnectionStatusListener implements org.mases.jcobridge.IJCListener, android.net.wifi.WifiManager.SuggestionConnectionStatusListener {
     ...
     */
    public WifiManager_SuggestionConnectionStatusListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onConnectionStatusIndex = 0;
    //@Override
    public void onConnectionStatus(android.net.wifi.WifiNetworkSuggestion arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onConnectionStatusIndex <= 0) _onConnectionStatusIndex = getEventIndex("onConnectionStatus");
        raiseEvent(_onConnectionStatusIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
