...
public final class TelephonyCallback_DisplayInfoListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.DisplayInfoListener {
     ...
     */
    public TelephonyCallback_DisplayInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDisplayInfoChangedIndex = 0;
    //@Override
    public void onDisplayInfoChanged(android.telephony.TelephonyDisplayInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDisplayInfoChangedIndex <= 0) _onDisplayInfoChangedIndex = getEventIndex("onDisplayInfoChanged");
        raiseEvent(_onDisplayInfoChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
