...
public final class WifiP2pManager_NetworkInfoListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.NetworkInfoListener {
     ...
     */
    public WifiP2pManager_NetworkInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onNetworkInfoAvailableIndex = 0;
    //@Override
    public void onNetworkInfoAvailable(android.net.NetworkInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNetworkInfoAvailableIndex <= 0) _onNetworkInfoAvailableIndex = getEventIndex("onNetworkInfoAvailable");
        raiseEvent(_onNetworkInfoAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
