...
public final class Window_OnRestrictedCaptionAreaChangedListener implements org.mases.jcobridge.IJCListener, android.view.Window.OnRestrictedCaptionAreaChangedListener {
     ...
     */
    public Window_OnRestrictedCaptionAreaChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onRestrictedCaptionAreaChangedIndex = 0;
    //@Override
    public void onRestrictedCaptionAreaChanged(android.graphics.Rect arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRestrictedCaptionAreaChangedIndex <= 0) _onRestrictedCaptionAreaChangedIndex = getEventIndex("onRestrictedCaptionAreaChanged");
        raiseEvent(_onRestrictedCaptionAreaChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
