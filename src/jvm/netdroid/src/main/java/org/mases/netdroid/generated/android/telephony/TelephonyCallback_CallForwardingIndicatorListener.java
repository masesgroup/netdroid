...
public final class TelephonyCallback_CallForwardingIndicatorListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CallForwardingIndicatorListener {
     ...
     */
    public TelephonyCallback_CallForwardingIndicatorListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCallForwardingIndicatorChangedIndex = 0;
    //@Override
    public void onCallForwardingIndicatorChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCallForwardingIndicatorChangedIndex <= 0) _onCallForwardingIndicatorChangedIndex = getEventIndex("onCallForwardingIndicatorChanged");
        raiseEvent(_onCallForwardingIndicatorChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
