...
package org.mases.netdroid.generated.android.os;

public final class PowerManager_OnThermalHeadroomChangedListener implements org.mases.jcobridge.IJCListener, android.os.PowerManager.OnThermalHeadroomChangedListener {
     ...
     */
    public PowerManager_OnThermalHeadroomChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onThermalHeadroomChangedIndex = 0;
    //@Override
    public void onThermalHeadroomChanged(float arg0, float arg1, int arg2, java.util.Map arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onThermalHeadroomChangedIndex <= 0) _onThermalHeadroomChangedIndex = getEventIndex("onThermalHeadroomChanged");
        raiseEvent(_onThermalHeadroomChangedIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
