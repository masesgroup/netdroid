...
public final class ModelDownloadListener implements org.mases.jcobridge.IJCListener, android.speech.ModelDownloadListener {
     ...
     */
    public ModelDownloadListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onProgressIndex = 0;
    //@Override
    public void onProgress(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onProgressIndex <= 0) _onProgressIndex = getEventIndex("onProgress");
        raiseEvent(_onProgressIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onScheduledIndex = 0;
    //@Override
    public void onScheduled() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScheduledIndex <= 0) _onScheduledIndex = getEventIndex("onScheduled");
        raiseEvent(_onScheduledIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onSuccessIndex = 0;
    //@Override
    public void onSuccess() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSuccessIndex <= 0) _onSuccessIndex = getEventIndex("onSuccess");
        raiseEvent(_onSuccessIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
