...
public final class WebView_FindListener implements org.mases.jcobridge.IJCListener, android.webkit.WebView.FindListener {
     ...
     */
    public WebView_FindListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFindResultReceivedIndex = 0;
    //@Override
    public void onFindResultReceived(int arg0, int arg1, boolean arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFindResultReceivedIndex <= 0) _onFindResultReceivedIndex = getEventIndex("onFindResultReceived");
        raiseEvent(_onFindResultReceivedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
