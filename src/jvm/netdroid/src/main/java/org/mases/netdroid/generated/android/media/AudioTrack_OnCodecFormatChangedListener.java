...
public final class AudioTrack_OnCodecFormatChangedListener implements org.mases.jcobridge.IJCListener, android.media.AudioTrack.OnCodecFormatChangedListener {
     ...
     */
    public AudioTrack_OnCodecFormatChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCodecFormatChangedIndex = 0;
    //@Override
    public void onCodecFormatChanged(android.media.AudioTrack arg0, android.media.AudioMetadataReadMap arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCodecFormatChangedIndex <= 0) _onCodecFormatChangedIndex = getEventIndex("onCodecFormatChanged");
        raiseEvent(_onCodecFormatChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
