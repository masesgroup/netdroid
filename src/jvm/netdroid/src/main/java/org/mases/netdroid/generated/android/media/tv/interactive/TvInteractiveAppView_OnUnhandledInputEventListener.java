...
public final class TvInteractiveAppView_OnUnhandledInputEventListener implements org.mases.jcobridge.IJCListener, android.media.tv.interactive.TvInteractiveAppView.OnUnhandledInputEventListener {
    ...
    int _onUnhandledInputEventIndex = 0;
    //@Override
    public boolean onUnhandledInputEvent(android.view.InputEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUnhandledInputEventIndex <= 0) _onUnhandledInputEventIndex = getEventIndex("onUnhandledInputEvent");
        raiseEvent(_onUnhandledInputEventIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
