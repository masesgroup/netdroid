...
public final class TelephonyCallback_CellLocationListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CellLocationListener {
     ...
     */
    public TelephonyCallback_CellLocationListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCellLocationChangedIndex = 0;
    //@Override
    public void onCellLocationChanged(android.telephony.CellLocation arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCellLocationChangedIndex <= 0) _onCellLocationChangedIndex = getEventIndex("onCellLocationChanged");
        raiseEvent(_onCellLocationChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
