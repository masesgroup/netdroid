...
public final class GpsStatus_Listener implements org.mases.jcobridge.IJCListener, android.location.GpsStatus.Listener {
     ...
     */
    public GpsStatus_Listener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGpsStatusChangedIndex = 0;
    //@Override
    public void onGpsStatusChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGpsStatusChangedIndex <= 0) _onGpsStatusChangedIndex = getEventIndex("onGpsStatusChanged");
        raiseEvent(_onGpsStatusChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
