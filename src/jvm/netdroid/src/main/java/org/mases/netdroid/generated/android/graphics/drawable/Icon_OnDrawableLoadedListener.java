...
package org.mases.netdroid.generated.android.graphics.drawable;

public final class Icon_OnDrawableLoadedListener implements org.mases.jcobridge.IJCListener, android.graphics.drawable.Icon.OnDrawableLoadedListener {
     ...
     */
    public Icon_OnDrawableLoadedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDrawableLoadedIndex = 0;
    //@Override
    public void onDrawableLoaded(android.graphics.drawable.Drawable arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDrawableLoadedIndex <= 0) _onDrawableLoadedIndex = getEventIndex("onDrawableLoaded");
        raiseEvent(_onDrawableLoadedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
