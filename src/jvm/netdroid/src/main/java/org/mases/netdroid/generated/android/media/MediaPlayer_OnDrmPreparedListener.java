...
public final class MediaPlayer_OnDrmPreparedListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnDrmPreparedListener {
     ...
     */
    public MediaPlayer_OnDrmPreparedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDrmPreparedIndex = 0;
    //@Override
    public void onDrmPrepared(android.media.MediaPlayer arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDrmPreparedIndex <= 0) _onDrmPreparedIndex = getEventIndex("onDrmPrepared");
        raiseEvent(_onDrmPreparedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
