...
public final class IntBinaryOperator implements org.mases.jcobridge.IJCListener, java.util.function.IntBinaryOperator {
    ...
    public int applyAsInt(int arg0, int arg1) {
        ...
        raiseEvent(_applyAsIntIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (int)retVal;
    }
