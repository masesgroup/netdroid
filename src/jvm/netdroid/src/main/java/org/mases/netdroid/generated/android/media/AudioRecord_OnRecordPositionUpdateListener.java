...
public final class AudioRecord_OnRecordPositionUpdateListener implements org.mases.jcobridge.IJCListener, android.media.AudioRecord.OnRecordPositionUpdateListener {
    ...
    int _onMarkerReachedIndex = 0;
    //@Override
    public void onMarkerReached(android.media.AudioRecord arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMarkerReachedIndex <= 0) _onMarkerReachedIndex = getEventIndex("onMarkerReached");
        raiseEvent(_onMarkerReachedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onPeriodicNotificationIndex = 0;
    //@Override
    public void onPeriodicNotification(android.media.AudioRecord arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPeriodicNotificationIndex <= 0) _onPeriodicNotificationIndex = getEventIndex("onPeriodicNotification");
        raiseEvent(_onPeriodicNotificationIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
