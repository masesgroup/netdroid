...
public final class ViewStub_OnInflateListener implements org.mases.jcobridge.IJCListener, android.view.ViewStub.OnInflateListener {
     ...
     */
    public ViewStub_OnInflateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onInflateIndex = 0;
    //@Override
    public void onInflate(android.view.ViewStub arg0, android.view.View arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onInflateIndex <= 0) _onInflateIndex = getEventIndex("onInflate");
        raiseEvent(_onInflateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
