...
public final class StrictMode_OnThreadViolationListener implements org.mases.jcobridge.IJCListener, android.os.StrictMode.OnThreadViolationListener {
     ...
     */
    public StrictMode_OnThreadViolationListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onThreadViolationIndex = 0;
    //@Override
    public void onThreadViolation(android.os.strictmode.Violation arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onThreadViolationIndex <= 0) _onThreadViolationIndex = getEventIndex("onThreadViolation");
        raiseEvent(_onThreadViolationIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
