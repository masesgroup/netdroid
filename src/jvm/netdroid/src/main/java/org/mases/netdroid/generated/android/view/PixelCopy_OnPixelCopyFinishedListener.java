...
public final class PixelCopy_OnPixelCopyFinishedListener implements org.mases.jcobridge.IJCListener, android.view.PixelCopy.OnPixelCopyFinishedListener {
     ...
     */
    public PixelCopy_OnPixelCopyFinishedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPixelCopyFinishedIndex = 0;
    //@Override
    public void onPixelCopyFinished(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPixelCopyFinishedIndex <= 0) _onPixelCopyFinishedIndex = getEventIndex("onPixelCopyFinished");
        raiseEvent(_onPixelCopyFinishedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
