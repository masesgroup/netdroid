...
public final class TelephonyCallback_DataConnectionStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.DataConnectionStateListener {
     ...
     */
    public TelephonyCallback_DataConnectionStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDataConnectionStateChangedIndex = 0;
    //@Override
    public void onDataConnectionStateChanged(int arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDataConnectionStateChangedIndex <= 0) _onDataConnectionStateChangedIndex = getEventIndex("onDataConnectionStateChanged");
        raiseEvent(_onDataConnectionStateChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
