...
public final class ZoomButtonsController_OnZoomListener implements org.mases.jcobridge.IJCListener, android.widget.ZoomButtonsController.OnZoomListener {
     ...
     */
    public ZoomButtonsController_OnZoomListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onVisibilityChangedIndex = 0;
    //@Override
    public void onVisibilityChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onVisibilityChangedIndex <= 0) _onVisibilityChangedIndex = getEventIndex("onVisibilityChanged");
        raiseEvent(_onVisibilityChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onZoomIndex = 0;
    //@Override
    public void onZoom(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onZoomIndex <= 0) _onZoomIndex = getEventIndex("onZoom");
        raiseEvent(_onZoomIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
