...
public final class SlidingDrawer_OnDrawerScrollListener implements org.mases.jcobridge.IJCListener, android.widget.SlidingDrawer.OnDrawerScrollListener {
     ...
     */
    public SlidingDrawer_OnDrawerScrollListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onScrollEndedIndex = 0;
    //@Override
    public void onScrollEnded() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollEndedIndex <= 0) _onScrollEndedIndex = getEventIndex("onScrollEnded");
        raiseEvent(_onScrollEndedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onScrollStartedIndex = 0;
    //@Override
    public void onScrollStarted() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollStartedIndex <= 0) _onScrollStartedIndex = getEventIndex("onScrollStarted");
        raiseEvent(_onScrollStartedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
