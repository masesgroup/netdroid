...
public final class TextToSpeech_OnInitListener implements org.mases.jcobridge.IJCListener, android.speech.tts.TextToSpeech.OnInitListener {
    ...
    public void onInit(int arg0) {
        ...
        if (_onInitIndex <= 0) _onInitIndex = getEventIndex("onInit");
        raiseEvent(_onInitIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
