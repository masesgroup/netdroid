...
public final class MediaPlayer_OnVideoSizeChangedListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnVideoSizeChangedListener {
     ...
     */
    public MediaPlayer_OnVideoSizeChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onVideoSizeChangedIndex = 0;
    //@Override
    public void onVideoSizeChanged(android.media.MediaPlayer arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onVideoSizeChangedIndex <= 0) _onVideoSizeChangedIndex = getEventIndex("onVideoSizeChanged");
        raiseEvent(_onVideoSizeChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
