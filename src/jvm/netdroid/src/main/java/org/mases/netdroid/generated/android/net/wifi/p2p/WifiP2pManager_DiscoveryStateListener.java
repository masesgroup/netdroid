...
public final class WifiP2pManager_DiscoveryStateListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.DiscoveryStateListener {
     ...
     */
    public WifiP2pManager_DiscoveryStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDiscoveryStateAvailableIndex = 0;
    //@Override
    public void onDiscoveryStateAvailable(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDiscoveryStateAvailableIndex <= 0) _onDiscoveryStateAvailableIndex = getEventIndex("onDiscoveryStateAvailable");
        raiseEvent(_onDiscoveryStateAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
