...
public final class AlarmManager_OnAlarmListener implements org.mases.jcobridge.IJCListener, android.app.AlarmManager.OnAlarmListener {
    ...
    public void onAlarm() {
        ...
        if (_onAlarmIndex <= 0) _onAlarmIndex = getEventIndex("onAlarm");
        raiseEvent(_onAlarmIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
