...
public final class LoudnessCodecController_OnLoudnessCodecUpdateListener implements org.mases.jcobridge.IJCListener, android.media.LoudnessCodecController.OnLoudnessCodecUpdateListener {
    ...
    int _onLoudnessCodecUpdateIndex = 0;
    //@Override
    public android.os.Bundle onLoudnessCodecUpdate(android.media.MediaCodec arg0, android.os.Bundle arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onLoudnessCodecUpdateIndex <= 0) _onLoudnessCodecUpdateIndex = getEventIndex("onLoudnessCodecUpdate");
        raiseEvent(_onLoudnessCodecUpdateIndex, eventDataExchange, arg0, arg1); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = android.media.LoudnessCodecController.OnLoudnessCodecUpdateListener.super.onLoudnessCodecUpdate(arg0, arg1); else retVal = eventDataExchange.getReturnData(); return (android.os.Bundle)retVal;
    }
