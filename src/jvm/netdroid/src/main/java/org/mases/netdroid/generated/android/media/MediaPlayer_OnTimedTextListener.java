...
public final class MediaPlayer_OnTimedTextListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnTimedTextListener {
     ...
     */
    public MediaPlayer_OnTimedTextListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTimedTextIndex = 0;
    //@Override
    public void onTimedText(android.media.MediaPlayer arg0, android.media.TimedText arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTimedTextIndex <= 0) _onTimedTextIndex = getEventIndex("onTimedText");
        raiseEvent(_onTimedTextIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
