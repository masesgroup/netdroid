...
public final class AdapterView_OnItemSelectedListener implements org.mases.jcobridge.IJCListener, android.widget.AdapterView.OnItemSelectedListener {
    ...
    int _onItemSelectedIndex = 0;
    //@Override
    public void onItemSelected(android.widget.AdapterView arg0, android.view.View arg1, int arg2, long arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onItemSelectedIndex <= 0) _onItemSelectedIndex = getEventIndex("onItemSelected");
        raiseEvent(_onItemSelectedIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onNothingSelectedIndex = 0;
    //@Override
    public void onNothingSelected(android.widget.AdapterView arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNothingSelectedIndex <= 0) _onNothingSelectedIndex = getEventIndex("onNothingSelected");
        raiseEvent(_onNothingSelectedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
