...
public final class SipRegistrationListener implements org.mases.jcobridge.IJCListener, android.net.sip.SipRegistrationListener {
    ...
    int _onRegisteringIndex = 0;
    //@Override
    public void onRegistering(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRegisteringIndex <= 0) _onRegisteringIndex = getEventIndex("onRegistering");
        raiseEvent(_onRegisteringIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onRegistrationDoneIndex = 0;
    //@Override
    public void onRegistrationDone(java.lang.String arg0, long arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRegistrationDoneIndex <= 0) _onRegistrationDoneIndex = getEventIndex("onRegistrationDone");
        raiseEvent(_onRegistrationDoneIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void onRegistrationFailed(java.lang.String arg0, int arg1, java.lang.String arg2) {
        ...
        raiseEvent(_onRegistrationFailedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
