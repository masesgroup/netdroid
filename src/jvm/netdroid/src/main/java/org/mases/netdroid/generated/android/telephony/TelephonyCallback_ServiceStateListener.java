...
public final class TelephonyCallback_ServiceStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.ServiceStateListener {
     ...
     */
    public TelephonyCallback_ServiceStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onServiceStateChangedIndex = 0;
    //@Override
    public void onServiceStateChanged(android.telephony.ServiceState arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceStateChangedIndex <= 0) _onServiceStateChangedIndex = getEventIndex("onServiceStateChanged");
        raiseEvent(_onServiceStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
