...
public final class EnvironmentalReverb_OnParameterChangeListener implements org.mases.jcobridge.IJCListener, android.media.audiofx.EnvironmentalReverb.OnParameterChangeListener {
     ...
     */
    public EnvironmentalReverb_OnParameterChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onParameterChangeIndex = 0;
    //@Override
    public void onParameterChange(android.media.audiofx.EnvironmentalReverb arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onParameterChangeIndex <= 0) _onParameterChangeIndex = getEventIndex("onParameterChange");
        raiseEvent(_onParameterChangeIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
