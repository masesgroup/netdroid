...
public final class MediaCodec_OnFrameRenderedListener implements org.mases.jcobridge.IJCListener, android.media.MediaCodec.OnFrameRenderedListener {
     ...
     */
    public MediaCodec_OnFrameRenderedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFrameRenderedIndex = 0;
    //@Override
    public void onFrameRendered(android.media.MediaCodec arg0, long arg1, long arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFrameRenderedIndex <= 0) _onFrameRenderedIndex = getEventIndex("onFrameRendered");
        raiseEvent(_onFrameRenderedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
