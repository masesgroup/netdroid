...
public final class AutoCompleteTextView_OnDismissListener implements org.mases.jcobridge.IJCListener, android.widget.AutoCompleteTextView.OnDismissListener {
     ...
     */
    public AutoCompleteTextView_OnDismissListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onDismiss() {
        ...
        raiseEvent(_onDismissIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
