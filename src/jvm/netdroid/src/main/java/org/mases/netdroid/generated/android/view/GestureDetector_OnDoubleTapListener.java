...
public final class GestureDetector_OnDoubleTapListener implements org.mases.jcobridge.IJCListener, android.view.GestureDetector.OnDoubleTapListener {
    ...
    public boolean onDoubleTap(android.view.MotionEvent arg0) {
        ...
        raiseEvent(_onDoubleTapIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
