...
public final class MediaDrm_OnSessionLostStateListener implements org.mases.jcobridge.IJCListener, android.media.MediaDrm.OnSessionLostStateListener {
     ...
     */
    public MediaDrm_OnSessionLostStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSessionLostStateIndex = 0;
    //@Override
    public void onSessionLostState(android.media.MediaDrm arg0, byte[] arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSessionLostStateIndex <= 0) _onSessionLostStateIndex = getEventIndex("onSessionLostState");
        raiseEvent(_onSessionLostStateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
