...
public final class WifiP2pManager_P2pStateListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.P2pStateListener {
     ...
     */
    public WifiP2pManager_P2pStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onP2pStateAvailableIndex = 0;
    //@Override
    public void onP2pStateAvailable(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onP2pStateAvailableIndex <= 0) _onP2pStateAvailableIndex = getEventIndex("onP2pStateAvailable");
        raiseEvent(_onP2pStateAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
