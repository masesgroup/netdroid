...
public final class GestureOverlayView_OnGesturingListener implements org.mases.jcobridge.IJCListener, android.gesture.GestureOverlayView.OnGesturingListener {
     ...
     */
    public GestureOverlayView_OnGesturingListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGesturingEndedIndex = 0;
    //@Override
    public void onGesturingEnded(android.gesture.GestureOverlayView arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGesturingEndedIndex <= 0) _onGesturingEndedIndex = getEventIndex("onGesturingEnded");
        raiseEvent(_onGesturingEndedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onGesturingStartedIndex = 0;
    //@Override
    public void onGesturingStarted(android.gesture.GestureOverlayView arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGesturingStartedIndex <= 0) _onGesturingStartedIndex = getEventIndex("onGesturingStarted");
        raiseEvent(_onGesturingStartedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
