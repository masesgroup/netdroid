...
public final class CarrierConfigManager_CarrierConfigChangeListener implements org.mases.jcobridge.IJCListener, android.telephony.CarrierConfigManager.CarrierConfigChangeListener {
     ...
     */
    public CarrierConfigManager_CarrierConfigChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCarrierConfigChangedIndex = 0;
    //@Override
    public void onCarrierConfigChanged(int arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCarrierConfigChangedIndex <= 0) _onCarrierConfigChangedIndex = getEventIndex("onCarrierConfigChanged");
        raiseEvent(_onCarrierConfigChangedIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
