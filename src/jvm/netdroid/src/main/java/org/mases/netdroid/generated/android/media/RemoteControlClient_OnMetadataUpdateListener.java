...
public final class RemoteControlClient_OnMetadataUpdateListener implements org.mases.jcobridge.IJCListener, android.media.RemoteControlClient.OnMetadataUpdateListener {
     ...
     */
    public RemoteControlClient_OnMetadataUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onMetadataUpdateIndex = 0;
    //@Override
    public void onMetadataUpdate(int arg0, java.lang.Object arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMetadataUpdateIndex <= 0) _onMetadataUpdateIndex = getEventIndex("onMetadataUpdate");
        raiseEvent(_onMetadataUpdateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
