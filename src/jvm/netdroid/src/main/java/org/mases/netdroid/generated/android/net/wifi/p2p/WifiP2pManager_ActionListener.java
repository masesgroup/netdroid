...
public final class WifiP2pManager_ActionListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.ActionListener {
     ...
     */
    public WifiP2pManager_ActionListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFailureIndex = 0;
    //@Override
    public void onFailure(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFailureIndex <= 0) _onFailureIndex = getEventIndex("onFailure");
        raiseEvent(_onFailureIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
