...
package org.mases.netdroid.generated.android.media.effect;

public final class EffectUpdateListener implements org.mases.jcobridge.IJCListener, android.media.effect.EffectUpdateListener {
     ...
     */
    public EffectUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onEffectUpdatedIndex = 0;
    //@Override
    public void onEffectUpdated(android.media.effect.Effect arg0, java.lang.Object arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onEffectUpdatedIndex <= 0) _onEffectUpdatedIndex = getEventIndex("onEffectUpdated");
        raiseEvent(_onEffectUpdatedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
