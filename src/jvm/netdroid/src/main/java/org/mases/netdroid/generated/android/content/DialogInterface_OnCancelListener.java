...
public final class DialogInterface_OnCancelListener implements org.mases.jcobridge.IJCListener, android.content.DialogInterface.OnCancelListener {
     ...
     */
    public DialogInterface_OnCancelListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onCancel(android.content.DialogInterface arg0) {
        ...
        raiseEvent(_onCancelIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
