...
public final class PowerManager_WakeLockStateListener implements org.mases.jcobridge.IJCListener, android.os.PowerManager.WakeLockStateListener {
     ...
     */
    public PowerManager_WakeLockStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onStateChangedIndex = 0;
    //@Override
    public void onStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStateChangedIndex <= 0) _onStateChangedIndex = getEventIndex("onStateChanged");
        raiseEvent(_onStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
