...
public final class SearchView_OnCloseListener implements org.mases.jcobridge.IJCListener, android.widget.SearchView.OnCloseListener {
     ...
     */
    public SearchView_OnCloseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public boolean onClose() {
        ...
        raiseEvent(_onCloseIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
