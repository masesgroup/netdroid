...
public final class PreferenceManager_OnActivityStopListener implements org.mases.jcobridge.IJCListener, android.preference.PreferenceManager.OnActivityStopListener {
     ...
     */
    public PreferenceManager_OnActivityStopListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onActivityStopIndex = 0;
    //@Override
    public void onActivityStop() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActivityStopIndex <= 0) _onActivityStopIndex = getEventIndex("onActivityStop");
        raiseEvent(_onActivityStopIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
