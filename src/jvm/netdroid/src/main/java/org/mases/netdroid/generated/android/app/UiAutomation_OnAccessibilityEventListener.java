...
public final class UiAutomation_OnAccessibilityEventListener implements org.mases.jcobridge.IJCListener, android.app.UiAutomation.OnAccessibilityEventListener {
     ...
     */
    public UiAutomation_OnAccessibilityEventListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAccessibilityEventIndex = 0;
    //@Override
    public void onAccessibilityEvent(android.view.accessibility.AccessibilityEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAccessibilityEventIndex <= 0) _onAccessibilityEventIndex = getEventIndex("onAccessibilityEvent");
        raiseEvent(_onAccessibilityEventIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
