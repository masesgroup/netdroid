...
public final class TelephonyCallback_DataActivationStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.DataActivationStateListener {
     ...
     */
    public TelephonyCallback_DataActivationStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDataActivationStateChangedIndex = 0;
    //@Override
    public void onDataActivationStateChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDataActivationStateChangedIndex <= 0) _onDataActivationStateChangedIndex = getEventIndex("onDataActivationStateChanged");
        raiseEvent(_onDataActivationStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
