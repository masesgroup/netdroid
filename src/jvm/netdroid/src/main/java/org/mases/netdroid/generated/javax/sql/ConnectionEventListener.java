...
package org.mases.netdroid.generated.javax.sql;

public final class ConnectionEventListener implements org.mases.jcobridge.IJCListener, javax.sql.ConnectionEventListener {
    ...
    int _connectionClosedIndex = 0;
    //@Override
    public void connectionClosed(javax.sql.ConnectionEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_connectionClosedIndex <= 0) _connectionClosedIndex = getEventIndex("connectionClosed");
        raiseEvent(_connectionClosedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _connectionErrorOccurredIndex = 0;
    //@Override
    public void connectionErrorOccurred(javax.sql.ConnectionEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_connectionErrorOccurredIndex <= 0) _connectionErrorOccurredIndex = getEventIndex("connectionErrorOccurred");
        raiseEvent(_connectionErrorOccurredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
