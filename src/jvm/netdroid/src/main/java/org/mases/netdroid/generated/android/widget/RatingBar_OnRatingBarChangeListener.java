...
public final class RatingBar_OnRatingBarChangeListener implements org.mases.jcobridge.IJCListener, android.widget.RatingBar.OnRatingBarChangeListener {
     ...
     */
    public RatingBar_OnRatingBarChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onRatingChangedIndex = 0;
    //@Override
    public void onRatingChanged(android.widget.RatingBar arg0, float arg1, boolean arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRatingChangedIndex <= 0) _onRatingChangedIndex = getEventIndex("onRatingChanged");
        raiseEvent(_onRatingChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
