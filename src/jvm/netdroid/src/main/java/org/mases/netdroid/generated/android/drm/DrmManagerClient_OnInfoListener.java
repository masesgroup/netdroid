...
public final class DrmManagerClient_OnInfoListener implements org.mases.jcobridge.IJCListener, android.drm.DrmManagerClient.OnInfoListener {
    ...
    public void onInfo(android.drm.DrmManagerClient arg0, android.drm.DrmInfoEvent arg1) {
        ...
        if (_onInfoIndex <= 0) _onInfoIndex = getEventIndex("onInfo");
        raiseEvent(_onInfoIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
