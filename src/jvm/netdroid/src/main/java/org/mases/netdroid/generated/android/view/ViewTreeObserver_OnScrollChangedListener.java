...
public final class ViewTreeObserver_OnScrollChangedListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnScrollChangedListener {
     ...
     */
    public ViewTreeObserver_OnScrollChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onScrollChangedIndex = 0;
    //@Override
    public void onScrollChanged() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollChangedIndex <= 0) _onScrollChangedIndex = getEventIndex("onScrollChanged");
        raiseEvent(_onScrollChangedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
