...
public final class WallpaperManager_OnColorsChangedListener implements org.mases.jcobridge.IJCListener, android.app.WallpaperManager.OnColorsChangedListener {
     ...
     */
    public WallpaperManager_OnColorsChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onColorsChangedIndex = 0;
    //@Override
    public void onColorsChanged(android.app.WallpaperColors arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onColorsChangedIndex <= 0) _onColorsChangedIndex = getEventIndex("onColorsChanged");
        raiseEvent(_onColorsChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
