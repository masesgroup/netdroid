...
public final class SurfaceControl_OnJankDataListener implements org.mases.jcobridge.IJCListener, android.view.SurfaceControl.OnJankDataListener {
     ...
     */
    public SurfaceControl_OnJankDataListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onJankDataAvailableIndex = 0;
    //@Override
    public void onJankDataAvailable(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onJankDataAvailableIndex <= 0) _onJankDataAvailableIndex = getEventIndex("onJankDataAvailable");
        raiseEvent(_onJankDataAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
