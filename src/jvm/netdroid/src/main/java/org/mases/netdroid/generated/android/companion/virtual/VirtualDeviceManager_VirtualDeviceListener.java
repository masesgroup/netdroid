...
public final class VirtualDeviceManager_VirtualDeviceListener implements org.mases.jcobridge.IJCListener, android.companion.virtual.VirtualDeviceManager.VirtualDeviceListener {
    ...
    int _onVirtualDeviceClosedIndex = 0;
    //@Override
    public void onVirtualDeviceClosed(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onVirtualDeviceClosedIndex <= 0) _onVirtualDeviceClosedIndex = getEventIndex("onVirtualDeviceClosed");
        raiseEvent(_onVirtualDeviceClosedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.companion.virtual.VirtualDeviceManager.VirtualDeviceListener.super.onVirtualDeviceClosed(arg0);
    }
    ...
    int _onVirtualDeviceCreatedIndex = 0;
    //@Override
    public void onVirtualDeviceCreated(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onVirtualDeviceCreatedIndex <= 0) _onVirtualDeviceCreatedIndex = getEventIndex("onVirtualDeviceCreated");
        raiseEvent(_onVirtualDeviceCreatedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.companion.virtual.VirtualDeviceManager.VirtualDeviceListener.super.onVirtualDeviceCreated(arg0);
    }
