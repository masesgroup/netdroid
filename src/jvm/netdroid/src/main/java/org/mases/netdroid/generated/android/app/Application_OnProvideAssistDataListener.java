...
public final class Application_OnProvideAssistDataListener implements org.mases.jcobridge.IJCListener, android.app.Application.OnProvideAssistDataListener {
    ...
    //@Override
    public void onProvideAssistData(android.app.Activity arg0, android.os.Bundle arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onProvideAssistDataIndex <= 0) _onProvideAssistDataIndex = getEventIndex("onProvideAssistData");
        raiseEvent(_onProvideAssistDataIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
