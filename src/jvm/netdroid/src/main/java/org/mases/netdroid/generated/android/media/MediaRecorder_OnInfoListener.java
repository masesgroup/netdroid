...
public final class MediaRecorder_OnInfoListener implements org.mases.jcobridge.IJCListener, android.media.MediaRecorder.OnInfoListener {
    ...
    public void onInfo(android.media.MediaRecorder arg0, int arg1, int arg2) {
        ...
        raiseEvent(_onInfoIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
