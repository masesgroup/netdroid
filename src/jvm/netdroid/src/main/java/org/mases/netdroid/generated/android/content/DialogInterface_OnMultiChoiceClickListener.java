...
public final class DialogInterface_OnMultiChoiceClickListener implements org.mases.jcobridge.IJCListener, android.content.DialogInterface.OnMultiChoiceClickListener {
     ...
     */
    public DialogInterface_OnMultiChoiceClickListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onClick(android.content.DialogInterface arg0, int arg1, boolean arg2) {
        ...
        if (_onClickIndex <= 0) _onClickIndex = getEventIndex("onClick");
        raiseEvent(_onClickIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
