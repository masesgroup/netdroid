...
public final class VirtualDisplayConfig_BrightnessListener implements org.mases.jcobridge.IJCListener, android.hardware.display.VirtualDisplayConfig.BrightnessListener {
     ...
     */
    public VirtualDisplayConfig_BrightnessListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onBrightnessChangedIndex = 0;
    //@Override
    public void onBrightnessChanged(float arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBrightnessChangedIndex <= 0) _onBrightnessChangedIndex = getEventIndex("onBrightnessChanged");
        raiseEvent(_onBrightnessChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
