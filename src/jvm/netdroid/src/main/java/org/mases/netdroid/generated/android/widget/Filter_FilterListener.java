...
public final class Filter_FilterListener implements org.mases.jcobridge.IJCListener, android.widget.Filter.FilterListener {
     ...
     */
    public Filter_FilterListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFilterCompleteIndex = 0;
    //@Override
    public void onFilterComplete(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFilterCompleteIndex <= 0) _onFilterCompleteIndex = getEventIndex("onFilterComplete");
        raiseEvent(_onFilterCompleteIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
