...
public final class PowerManager_OnThermalStatusChangedListener implements org.mases.jcobridge.IJCListener, android.os.PowerManager.OnThermalStatusChangedListener {
     ...
     */
    public PowerManager_OnThermalStatusChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onThermalStatusChangedIndex = 0;
    //@Override
    public void onThermalStatusChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onThermalStatusChangedIndex <= 0) _onThermalStatusChangedIndex = getEventIndex("onThermalStatusChanged");
        raiseEvent(_onThermalStatusChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
