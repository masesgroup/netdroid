...
public final class Chronometer_OnChronometerTickListener implements org.mases.jcobridge.IJCListener, android.widget.Chronometer.OnChronometerTickListener {
     ...
     */
    public Chronometer_OnChronometerTickListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onChronometerTickIndex = 0;
    //@Override
    public void onChronometerTick(android.widget.Chronometer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChronometerTickIndex <= 0) _onChronometerTickIndex = getEventIndex("onChronometerTick");
        raiseEvent(_onChronometerTickIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
