...
public final class View_OnScrollChangeListener implements org.mases.jcobridge.IJCListener, android.view.View.OnScrollChangeListener {
     ...
     */
    public View_OnScrollChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onScrollChangeIndex = 0;
    //@Override
    public void onScrollChange(android.view.View arg0, int arg1, int arg2, int arg3, int arg4) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollChangeIndex <= 0) _onScrollChangeIndex = getEventIndex("onScrollChange");
        raiseEvent(_onScrollChangeIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
