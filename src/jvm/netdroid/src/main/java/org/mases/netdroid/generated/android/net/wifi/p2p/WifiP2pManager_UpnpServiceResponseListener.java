...
public final class WifiP2pManager_UpnpServiceResponseListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.UpnpServiceResponseListener {
     ...
     */
    public WifiP2pManager_UpnpServiceResponseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onUpnpServiceAvailableIndex = 0;
    //@Override
    public void onUpnpServiceAvailable(java.util.List arg0, android.net.wifi.p2p.WifiP2pDevice arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUpnpServiceAvailableIndex <= 0) _onUpnpServiceAvailableIndex = getEventIndex("onUpnpServiceAvailable");
        raiseEvent(_onUpnpServiceAvailableIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
