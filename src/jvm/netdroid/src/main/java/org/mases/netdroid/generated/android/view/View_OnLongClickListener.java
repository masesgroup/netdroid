...
public final class View_OnLongClickListener implements org.mases.jcobridge.IJCListener, android.view.View.OnLongClickListener {
    ...
    int _onLongClickIndex = 0;
    //@Override
    public boolean onLongClick(android.view.View arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onLongClickIndex <= 0) _onLongClickIndex = getEventIndex("onLongClick");
        raiseEvent(_onLongClickIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onLongClickUseDefaultHapticFeedbackIndex = 0;
    //@Override
    public boolean onLongClickUseDefaultHapticFeedback(android.view.View arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onLongClickUseDefaultHapticFeedbackIndex <= 0) _onLongClickUseDefaultHapticFeedbackIndex = getEventIndex("onLongClickUseDefaultHapticFeedback");
        raiseEvent(_onLongClickUseDefaultHapticFeedbackIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = android.view.View.OnLongClickListener.super.onLongClickUseDefaultHapticFeedback(arg0); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
