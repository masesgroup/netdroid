...
public final class TelephonyCallback_EmergencyNumberListListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.EmergencyNumberListListener {
     ...
     */
    public TelephonyCallback_EmergencyNumberListListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onEmergencyNumberListChangedIndex = 0;
    //@Override
    public void onEmergencyNumberListChanged(java.util.Map arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onEmergencyNumberListChangedIndex <= 0) _onEmergencyNumberListChangedIndex = getEventIndex("onEmergencyNumberListChanged");
        raiseEvent(_onEmergencyNumberListChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
