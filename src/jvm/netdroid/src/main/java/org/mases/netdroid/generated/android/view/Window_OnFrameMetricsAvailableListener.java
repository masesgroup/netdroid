...
public final class Window_OnFrameMetricsAvailableListener implements org.mases.jcobridge.IJCListener, android.view.Window.OnFrameMetricsAvailableListener {
     ...
     */
    public Window_OnFrameMetricsAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFrameMetricsAvailableIndex = 0;
    //@Override
    public void onFrameMetricsAvailable(android.view.Window arg0, android.view.FrameMetrics arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFrameMetricsAvailableIndex <= 0) _onFrameMetricsAvailableIndex = getEventIndex("onFrameMetricsAvailable");
        raiseEvent(_onFrameMetricsAvailableIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
