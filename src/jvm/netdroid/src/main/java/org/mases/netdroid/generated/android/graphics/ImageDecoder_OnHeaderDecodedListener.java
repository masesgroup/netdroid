...
package org.mases.netdroid.generated.android.graphics;

public final class ImageDecoder_OnHeaderDecodedListener implements org.mases.jcobridge.IJCListener, android.graphics.ImageDecoder.OnHeaderDecodedListener {
     ...
     */
    public ImageDecoder_OnHeaderDecodedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onHeaderDecodedIndex = 0;
    //@Override
    public void onHeaderDecoded(android.graphics.ImageDecoder arg0, android.graphics.ImageDecoder.ImageInfo arg1, android.graphics.ImageDecoder.Source arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onHeaderDecodedIndex <= 0) _onHeaderDecodedIndex = getEventIndex("onHeaderDecoded");
        raiseEvent(_onHeaderDecodedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
