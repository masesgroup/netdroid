...
public final class AudioEffect_OnControlStatusChangeListener implements org.mases.jcobridge.IJCListener, android.media.audiofx.AudioEffect.OnControlStatusChangeListener {
     ...
     */
    public AudioEffect_OnControlStatusChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onControlStatusChangeIndex = 0;
    //@Override
    public void onControlStatusChange(android.media.audiofx.AudioEffect arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onControlStatusChangeIndex <= 0) _onControlStatusChangeIndex = getEventIndex("onControlStatusChange");
        raiseEvent(_onControlStatusChangeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
