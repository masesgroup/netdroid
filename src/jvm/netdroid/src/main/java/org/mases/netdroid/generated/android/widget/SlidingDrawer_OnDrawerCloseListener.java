...
public final class SlidingDrawer_OnDrawerCloseListener implements org.mases.jcobridge.IJCListener, android.widget.SlidingDrawer.OnDrawerCloseListener {
     ...
     */
    public SlidingDrawer_OnDrawerCloseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDrawerClosedIndex = 0;
    //@Override
    public void onDrawerClosed() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDrawerClosedIndex <= 0) _onDrawerClosedIndex = getEventIndex("onDrawerClosed");
        raiseEvent(_onDrawerClosedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
