...
public final class NsdManager_ResolveListener implements org.mases.jcobridge.IJCListener, android.net.nsd.NsdManager.ResolveListener {
    ...
    int _onResolveFailedIndex = 0;
    //@Override
    public void onResolveFailed(android.net.nsd.NsdServiceInfo arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onResolveFailedIndex <= 0) _onResolveFailedIndex = getEventIndex("onResolveFailed");
        raiseEvent(_onResolveFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceResolvedIndex = 0;
    //@Override
    public void onServiceResolved(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceResolvedIndex <= 0) _onServiceResolvedIndex = getEventIndex("onServiceResolved");
        raiseEvent(_onServiceResolvedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onResolutionStoppedIndex = 0;
    //@Override
    public void onResolutionStopped(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onResolutionStoppedIndex <= 0) _onResolutionStoppedIndex = getEventIndex("onResolutionStopped");
        raiseEvent(_onResolutionStoppedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.net.nsd.NsdManager.ResolveListener.super.onResolutionStopped(arg0);
    }
    ...
    int _onStopResolutionFailedIndex = 0;
    //@Override
    public void onStopResolutionFailed(android.net.nsd.NsdServiceInfo arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStopResolutionFailedIndex <= 0) _onStopResolutionFailedIndex = getEventIndex("onStopResolutionFailed");
        raiseEvent(_onStopResolutionFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) android.net.nsd.NsdManager.ResolveListener.super.onStopResolutionFailed(arg0, arg1);
    }
