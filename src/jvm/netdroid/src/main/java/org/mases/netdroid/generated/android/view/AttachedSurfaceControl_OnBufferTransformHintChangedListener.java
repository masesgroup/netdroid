...
public final class AttachedSurfaceControl_OnBufferTransformHintChangedListener implements org.mases.jcobridge.IJCListener, android.view.AttachedSurfaceControl.OnBufferTransformHintChangedListener {
     ...
     */
    public AttachedSurfaceControl_OnBufferTransformHintChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onBufferTransformHintChangedIndex = 0;
    //@Override
    public void onBufferTransformHintChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBufferTransformHintChangedIndex <= 0) _onBufferTransformHintChangedIndex = getEventIndex("onBufferTransformHintChanged");
        raiseEvent(_onBufferTransformHintChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
