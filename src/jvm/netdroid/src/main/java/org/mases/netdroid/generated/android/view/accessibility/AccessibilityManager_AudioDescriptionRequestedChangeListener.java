...
public final class AccessibilityManager_AudioDescriptionRequestedChangeListener implements org.mases.jcobridge.IJCListener, android.view.accessibility.AccessibilityManager.AudioDescriptionRequestedChangeListener {
     ...
     */
    public AccessibilityManager_AudioDescriptionRequestedChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAudioDescriptionRequestedChangedIndex = 0;
    //@Override
    public void onAudioDescriptionRequestedChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAudioDescriptionRequestedChangedIndex <= 0) _onAudioDescriptionRequestedChangedIndex = getEventIndex("onAudioDescriptionRequestedChanged");
        raiseEvent(_onAudioDescriptionRequestedChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
