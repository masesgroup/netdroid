...
public final class ViewGroup_OnHierarchyChangeListener implements org.mases.jcobridge.IJCListener, android.view.ViewGroup.OnHierarchyChangeListener {
     ...
     */
    public ViewGroup_OnHierarchyChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onChildViewAddedIndex = 0;
    //@Override
    public void onChildViewAdded(android.view.View arg0, android.view.View arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChildViewAddedIndex <= 0) _onChildViewAddedIndex = getEventIndex("onChildViewAdded");
        raiseEvent(_onChildViewAddedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onChildViewRemovedIndex = 0;
    //@Override
    public void onChildViewRemoved(android.view.View arg0, android.view.View arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChildViewRemovedIndex <= 0) _onChildViewRemovedIndex = getEventIndex("onChildViewRemoved");
        raiseEvent(_onChildViewRemovedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
