...
public final class AbsListView_RecyclerListener implements org.mases.jcobridge.IJCListener, android.widget.AbsListView.RecyclerListener {
     ...
     */
    public AbsListView_RecyclerListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onMovedToScrapHeapIndex = 0;
    //@Override
    public void onMovedToScrapHeap(android.view.View arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMovedToScrapHeapIndex <= 0) _onMovedToScrapHeapIndex = getEventIndex("onMovedToScrapHeap");
        raiseEvent(_onMovedToScrapHeapIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
