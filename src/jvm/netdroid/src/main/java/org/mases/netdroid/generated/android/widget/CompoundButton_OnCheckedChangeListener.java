...
public final class CompoundButton_OnCheckedChangeListener implements org.mases.jcobridge.IJCListener, android.widget.CompoundButton.OnCheckedChangeListener {
     ...
     */
    public CompoundButton_OnCheckedChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCheckedChangedIndex = 0;
    //@Override
    public void onCheckedChanged(android.widget.CompoundButton arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCheckedChangedIndex <= 0) _onCheckedChangedIndex = getEventIndex("onCheckedChanged");
        raiseEvent(_onCheckedChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
