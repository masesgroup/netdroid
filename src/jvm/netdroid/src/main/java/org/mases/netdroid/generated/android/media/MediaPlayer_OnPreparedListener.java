...
public final class MediaPlayer_OnPreparedListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnPreparedListener {
     ...
     */
    public MediaPlayer_OnPreparedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPreparedIndex = 0;
    //@Override
    public void onPrepared(android.media.MediaPlayer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPreparedIndex <= 0) _onPreparedIndex = getEventIndex("onPrepared");
        raiseEvent(_onPreparedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
