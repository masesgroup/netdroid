...
package org.mases.netdroid.generated.android.net.http;

public final class UrlRequest_StatusListener implements org.mases.jcobridge.IJCListener, android.net.http.UrlRequest.StatusListener {
     ...
     */
    public UrlRequest_StatusListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onStatusIndex = 0;
    //@Override
    public void onStatus(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStatusIndex <= 0) _onStatusIndex = getEventIndex("onStatus");
        raiseEvent(_onStatusIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
