...
public final class WindowInsetsAnimationControlListener implements org.mases.jcobridge.IJCListener, android.view.WindowInsetsAnimationControlListener {
     ...
     */
    public WindowInsetsAnimationControlListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCancelledIndex = 0;
    //@Override
    public void onCancelled(android.view.WindowInsetsAnimationController arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCancelledIndex <= 0) _onCancelledIndex = getEventIndex("onCancelled");
        raiseEvent(_onCancelledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onFinishedIndex = 0;
    //@Override
    public void onFinished(android.view.WindowInsetsAnimationController arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFinishedIndex <= 0) _onFinishedIndex = getEventIndex("onFinished");
        raiseEvent(_onFinishedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onReadyIndex = 0;
    //@Override
    public void onReady(android.view.WindowInsetsAnimationController arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onReadyIndex <= 0) _onReadyIndex = getEventIndex("onReady");
        raiseEvent(_onReadyIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
