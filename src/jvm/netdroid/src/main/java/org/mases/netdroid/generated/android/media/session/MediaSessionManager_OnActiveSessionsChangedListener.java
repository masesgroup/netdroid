...
public final class MediaSessionManager_OnActiveSessionsChangedListener implements org.mases.jcobridge.IJCListener, android.media.session.MediaSessionManager.OnActiveSessionsChangedListener {
     ...
     */
    public MediaSessionManager_OnActiveSessionsChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onActiveSessionsChangedIndex = 0;
    //@Override
    public void onActiveSessionsChanged(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActiveSessionsChangedIndex <= 0) _onActiveSessionsChangedIndex = getEventIndex("onActiveSessionsChanged");
        raiseEvent(_onActiveSessionsChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
