...
public final class Camera_FaceDetectionListener implements org.mases.jcobridge.IJCListener, android.hardware.Camera.FaceDetectionListener {
     ...
     */
    public Camera_FaceDetectionListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFaceDetectionIndex = 0;
    //@Override
    public void onFaceDetection(android.hardware.Camera.Face[] arg0, android.hardware.Camera arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFaceDetectionIndex <= 0) _onFaceDetectionIndex = getEventIndex("onFaceDetection");
        raiseEvent(_onFaceDetectionIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
