...
public final class DrmManagerClient_OnErrorListener implements org.mases.jcobridge.IJCListener, android.drm.DrmManagerClient.OnErrorListener {
     ...
     */
    public DrmManagerClient_OnErrorListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onError(android.drm.DrmManagerClient arg0, android.drm.DrmErrorEvent arg1) {
        ...
        raiseEvent(_onErrorIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
