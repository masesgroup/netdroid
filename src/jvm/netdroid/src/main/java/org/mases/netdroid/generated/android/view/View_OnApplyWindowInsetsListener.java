...
public final class View_OnApplyWindowInsetsListener implements org.mases.jcobridge.IJCListener, android.view.View.OnApplyWindowInsetsListener {
     ...
     */
    public View_OnApplyWindowInsetsListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onApplyWindowInsetsIndex = 0;
    //@Override
    public android.view.WindowInsets onApplyWindowInsets(android.view.View arg0, android.view.WindowInsets arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onApplyWindowInsetsIndex <= 0) _onApplyWindowInsetsIndex = getEventIndex("onApplyWindowInsets");
        raiseEvent(_onApplyWindowInsetsIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (android.view.WindowInsets)retVal;
    }
