...
public final class AudioManager_OnModeChangedListener implements org.mases.jcobridge.IJCListener, android.media.AudioManager.OnModeChangedListener {
     ...
     */
    public AudioManager_OnModeChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onModeChangedIndex = 0;
    //@Override
    public void onModeChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onModeChangedIndex <= 0) _onModeChangedIndex = getEventIndex("onModeChanged");
        raiseEvent(_onModeChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
