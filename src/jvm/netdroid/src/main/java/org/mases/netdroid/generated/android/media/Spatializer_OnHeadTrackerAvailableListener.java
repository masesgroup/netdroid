...
public final class Spatializer_OnHeadTrackerAvailableListener implements org.mases.jcobridge.IJCListener, android.media.Spatializer.OnHeadTrackerAvailableListener {
     ...
     */
    public Spatializer_OnHeadTrackerAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onHeadTrackerAvailableChangedIndex = 0;
    //@Override
    public void onHeadTrackerAvailableChanged(android.media.Spatializer arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onHeadTrackerAvailableChangedIndex <= 0) _onHeadTrackerAvailableChangedIndex = getEventIndex("onHeadTrackerAvailableChanged");
        raiseEvent(_onHeadTrackerAvailableChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
