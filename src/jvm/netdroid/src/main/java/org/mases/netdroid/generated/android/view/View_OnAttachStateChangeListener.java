...
public final class View_OnAttachStateChangeListener implements org.mases.jcobridge.IJCListener, android.view.View.OnAttachStateChangeListener {
     ...
     */
    public View_OnAttachStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onViewAttachedToWindowIndex = 0;
    //@Override
    public void onViewAttachedToWindow(android.view.View arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onViewAttachedToWindowIndex <= 0) _onViewAttachedToWindowIndex = getEventIndex("onViewAttachedToWindow");
        raiseEvent(_onViewAttachedToWindowIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onViewDetachedFromWindowIndex = 0;
    //@Override
    public void onViewDetachedFromWindow(android.view.View arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onViewDetachedFromWindowIndex <= 0) _onViewDetachedFromWindowIndex = getEventIndex("onViewDetachedFromWindow");
        raiseEvent(_onViewDetachedFromWindowIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
