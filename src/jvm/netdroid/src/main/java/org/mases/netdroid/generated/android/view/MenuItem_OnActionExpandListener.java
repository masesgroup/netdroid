...
public final class MenuItem_OnActionExpandListener implements org.mases.jcobridge.IJCListener, android.view.MenuItem.OnActionExpandListener {
    ...
    int _onMenuItemActionCollapseIndex = 0;
    //@Override
    public boolean onMenuItemActionCollapse(android.view.MenuItem arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMenuItemActionCollapseIndex <= 0) _onMenuItemActionCollapseIndex = getEventIndex("onMenuItemActionCollapse");
        raiseEvent(_onMenuItemActionCollapseIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onMenuItemActionExpandIndex = 0;
    //@Override
    public boolean onMenuItemActionExpand(android.view.MenuItem arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMenuItemActionExpandIndex <= 0) _onMenuItemActionExpandIndex = getEventIndex("onMenuItemActionExpand");
        raiseEvent(_onMenuItemActionExpandIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
