...
public final class AccessibilityManager_AccessibilityStateChangeListener implements org.mases.jcobridge.IJCListener, android.view.accessibility.AccessibilityManager.AccessibilityStateChangeListener {
     ...
     */
    public AccessibilityManager_AccessibilityStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAccessibilityStateChangedIndex = 0;
    //@Override
    public void onAccessibilityStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAccessibilityStateChangedIndex <= 0) _onAccessibilityStateChangedIndex = getEventIndex("onAccessibilityStateChanged");
        raiseEvent(_onAccessibilityStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
