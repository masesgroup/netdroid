...
public final class AdapterView_OnItemClickListener implements org.mases.jcobridge.IJCListener, android.widget.AdapterView.OnItemClickListener {
     ...
     */
    public AdapterView_OnItemClickListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onItemClickIndex = 0;
    //@Override
    public void onItemClick(android.widget.AdapterView arg0, android.view.View arg1, int arg2, long arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onItemClickIndex <= 0) _onItemClickIndex = getEventIndex("onItemClick");
        raiseEvent(_onItemClickIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
