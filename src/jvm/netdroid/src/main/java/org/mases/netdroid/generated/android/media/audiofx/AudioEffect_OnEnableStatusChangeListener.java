...
public final class AudioEffect_OnEnableStatusChangeListener implements org.mases.jcobridge.IJCListener, android.media.audiofx.AudioEffect.OnEnableStatusChangeListener {
     ...
     */
    public AudioEffect_OnEnableStatusChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onEnableStatusChangeIndex = 0;
    //@Override
    public void onEnableStatusChange(android.media.audiofx.AudioEffect arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onEnableStatusChangeIndex <= 0) _onEnableStatusChangeIndex = getEventIndex("onEnableStatusChange");
        raiseEvent(_onEnableStatusChangeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
