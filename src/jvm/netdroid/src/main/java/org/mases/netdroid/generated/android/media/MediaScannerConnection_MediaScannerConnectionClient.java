...
public final class MediaScannerConnection_MediaScannerConnectionClient implements org.mases.jcobridge.IJCListener, android.media.MediaScannerConnection.MediaScannerConnectionClient {
    ...
    int _onMediaScannerConnectedIndex = 0;
    //@Override
    public void onMediaScannerConnected() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMediaScannerConnectedIndex <= 0) _onMediaScannerConnectedIndex = getEventIndex("onMediaScannerConnected");
        raiseEvent(_onMediaScannerConnectedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onScanCompletedIndex = 0;
    //@Override
    public void onScanCompleted(java.lang.String arg0, android.net.Uri arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScanCompletedIndex <= 0) _onScanCompletedIndex = getEventIndex("onScanCompleted");
        raiseEvent(_onScanCompletedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
