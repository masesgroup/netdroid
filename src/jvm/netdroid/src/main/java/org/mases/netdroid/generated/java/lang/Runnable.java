...
package org.mases.netdroid.generated.java.lang;
...
public final class Runnable implements org.mases.jcobridge.IJCListener, java.lang.Runnable {
    ...
    public void run() {
        ...
        if (_runIndex <= 0) _runIndex = getEventIndex("run");
        raiseEvent(_runIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
