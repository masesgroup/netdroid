...
public final class AudioManager_OnCommunicationDeviceChangedListener implements org.mases.jcobridge.IJCListener, android.media.AudioManager.OnCommunicationDeviceChangedListener {
     ...
     */
    public AudioManager_OnCommunicationDeviceChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCommunicationDeviceChangedIndex = 0;
    //@Override
    public void onCommunicationDeviceChanged(android.media.AudioDeviceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCommunicationDeviceChangedIndex <= 0) _onCommunicationDeviceChangedIndex = getEventIndex("onCommunicationDeviceChanged");
        raiseEvent(_onCommunicationDeviceChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
