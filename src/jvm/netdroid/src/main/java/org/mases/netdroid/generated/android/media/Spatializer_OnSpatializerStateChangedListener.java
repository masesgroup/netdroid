...
public final class Spatializer_OnSpatializerStateChangedListener implements org.mases.jcobridge.IJCListener, android.media.Spatializer.OnSpatializerStateChangedListener {
     ...
     */
    public Spatializer_OnSpatializerStateChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSpatializerAvailableChangedIndex = 0;
    //@Override
    public void onSpatializerAvailableChanged(android.media.Spatializer arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSpatializerAvailableChangedIndex <= 0) _onSpatializerAvailableChangedIndex = getEventIndex("onSpatializerAvailableChanged");
        raiseEvent(_onSpatializerAvailableChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onSpatializerEnabledChangedIndex = 0;
    //@Override
    public void onSpatializerEnabledChanged(android.media.Spatializer arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSpatializerEnabledChangedIndex <= 0) _onSpatializerEnabledChangedIndex = getEventIndex("onSpatializerEnabledChanged");
        raiseEvent(_onSpatializerEnabledChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
