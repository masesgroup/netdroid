...
public final class LayoutTransition_TransitionListener implements org.mases.jcobridge.IJCListener, android.animation.LayoutTransition.TransitionListener {
    ...
    public void endTransition(android.animation.LayoutTransition arg0, android.view.ViewGroup arg1, android.view.View arg2, int arg3) {
        ...
        if (_endTransitionIndex <= 0) _endTransitionIndex = getEventIndex("endTransition");
        raiseEvent(_endTransitionIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _startTransitionIndex = 0;
    //@Override
    public void startTransition(android.animation.LayoutTransition arg0, android.view.ViewGroup arg1, android.view.View arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_startTransitionIndex <= 0) _startTransitionIndex = getEventIndex("startTransition");
        raiseEvent(_startTransitionIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
