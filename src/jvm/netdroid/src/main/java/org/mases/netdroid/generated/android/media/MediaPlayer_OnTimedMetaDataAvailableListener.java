...
public final class MediaPlayer_OnTimedMetaDataAvailableListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnTimedMetaDataAvailableListener {
     ...
     */
    public MediaPlayer_OnTimedMetaDataAvailableListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTimedMetaDataAvailableIndex = 0;
    //@Override
    public void onTimedMetaDataAvailable(android.media.MediaPlayer arg0, android.media.TimedMetaData arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTimedMetaDataAvailableIndex <= 0) _onTimedMetaDataAvailableIndex = getEventIndex("onTimedMetaDataAvailable");
        raiseEvent(_onTimedMetaDataAvailableIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
