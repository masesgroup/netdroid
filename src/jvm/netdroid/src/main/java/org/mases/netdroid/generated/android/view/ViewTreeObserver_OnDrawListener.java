...
public final class ViewTreeObserver_OnDrawListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnDrawListener {
    ...
    public void onDraw() {
        ...
        if (_onDrawIndex <= 0) _onDrawIndex = getEventIndex("onDraw");
        raiseEvent(_onDrawIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
