...
public final class NsdManager_DiscoveryListener implements org.mases.jcobridge.IJCListener, android.net.nsd.NsdManager.DiscoveryListener {
    ...
    int _onDiscoveryStartedIndex = 0;
    //@Override
    public void onDiscoveryStarted(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDiscoveryStartedIndex <= 0) _onDiscoveryStartedIndex = getEventIndex("onDiscoveryStarted");
        raiseEvent(_onDiscoveryStartedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onDiscoveryStoppedIndex = 0;
    //@Override
    public void onDiscoveryStopped(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDiscoveryStoppedIndex <= 0) _onDiscoveryStoppedIndex = getEventIndex("onDiscoveryStopped");
        raiseEvent(_onDiscoveryStoppedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceFoundIndex = 0;
    //@Override
    public void onServiceFound(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceFoundIndex <= 0) _onServiceFoundIndex = getEventIndex("onServiceFound");
        raiseEvent(_onServiceFoundIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceLostIndex = 0;
    //@Override
    public void onServiceLost(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceLostIndex <= 0) _onServiceLostIndex = getEventIndex("onServiceLost");
        raiseEvent(_onServiceLostIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onStartDiscoveryFailedIndex = 0;
    //@Override
    public void onStartDiscoveryFailed(java.lang.String arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStartDiscoveryFailedIndex <= 0) _onStartDiscoveryFailedIndex = getEventIndex("onStartDiscoveryFailed");
        raiseEvent(_onStartDiscoveryFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onStopDiscoveryFailedIndex = 0;
    //@Override
    public void onStopDiscoveryFailed(java.lang.String arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStopDiscoveryFailedIndex <= 0) _onStopDiscoveryFailedIndex = getEventIndex("onStopDiscoveryFailed");
        raiseEvent(_onStopDiscoveryFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
