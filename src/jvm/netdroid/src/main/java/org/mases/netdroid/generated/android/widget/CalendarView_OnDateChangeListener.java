...
public final class CalendarView_OnDateChangeListener implements org.mases.jcobridge.IJCListener, android.widget.CalendarView.OnDateChangeListener {
     ...
     */
    public CalendarView_OnDateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSelectedDayChangeIndex = 0;
    //@Override
    public void onSelectedDayChange(android.widget.CalendarView arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSelectedDayChangeIndex <= 0) _onSelectedDayChangeIndex = getEventIndex("onSelectedDayChange");
        raiseEvent(_onSelectedDayChangeIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
