...
public final class SearchView_OnQueryTextListener implements org.mases.jcobridge.IJCListener, android.widget.SearchView.OnQueryTextListener {
    ...
    int _onQueryTextChangeIndex = 0;
    //@Override
    public boolean onQueryTextChange(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onQueryTextChangeIndex <= 0) _onQueryTextChangeIndex = getEventIndex("onQueryTextChange");
        raiseEvent(_onQueryTextChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onQueryTextSubmitIndex = 0;
    //@Override
    public boolean onQueryTextSubmit(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onQueryTextSubmitIndex <= 0) _onQueryTextSubmitIndex = getEventIndex("onQueryTextSubmit");
        raiseEvent(_onQueryTextSubmitIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
