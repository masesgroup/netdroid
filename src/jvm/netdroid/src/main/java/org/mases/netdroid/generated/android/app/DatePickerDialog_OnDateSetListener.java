...
public final class DatePickerDialog_OnDateSetListener implements org.mases.jcobridge.IJCListener, android.app.DatePickerDialog.OnDateSetListener {
    ...
    int _onDateSetIndex = 0;
    //@Override
    public void onDateSet(android.widget.DatePicker arg0, int arg1, int arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDateSetIndex <= 0) _onDateSetIndex = getEventIndex("onDateSet");
        raiseEvent(_onDateSetIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
