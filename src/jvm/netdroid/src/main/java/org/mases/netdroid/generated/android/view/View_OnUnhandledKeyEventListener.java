...
public final class View_OnUnhandledKeyEventListener implements org.mases.jcobridge.IJCListener, android.view.View.OnUnhandledKeyEventListener {
     ...
     */
    public View_OnUnhandledKeyEventListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onUnhandledKeyEventIndex = 0;
    //@Override
    public boolean onUnhandledKeyEvent(android.view.View arg0, android.view.KeyEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUnhandledKeyEventIndex <= 0) _onUnhandledKeyEventIndex = getEventIndex("onUnhandledKeyEvent");
        raiseEvent(_onUnhandledKeyEventIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
