...
package org.mases.netdroid.generated.android.gesture;

public final class GestureOverlayView_OnGestureListener implements org.mases.jcobridge.IJCListener, android.gesture.GestureOverlayView.OnGestureListener {
     ...
     */
    public GestureOverlayView_OnGestureListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGestureIndex = 0;
    //@Override
    public void onGesture(android.gesture.GestureOverlayView arg0, android.view.MotionEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGestureIndex <= 0) _onGestureIndex = getEventIndex("onGesture");
        raiseEvent(_onGestureIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onGestureCancelledIndex = 0;
    //@Override
    public void onGestureCancelled(android.gesture.GestureOverlayView arg0, android.view.MotionEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGestureCancelledIndex <= 0) _onGestureCancelledIndex = getEventIndex("onGestureCancelled");
        raiseEvent(_onGestureCancelledIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onGestureEndedIndex = 0;
    //@Override
    public void onGestureEnded(android.gesture.GestureOverlayView arg0, android.view.MotionEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGestureEndedIndex <= 0) _onGestureEndedIndex = getEventIndex("onGestureEnded");
        raiseEvent(_onGestureEndedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onGestureStartedIndex = 0;
    //@Override
    public void onGestureStarted(android.gesture.GestureOverlayView arg0, android.view.MotionEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGestureStartedIndex <= 0) _onGestureStartedIndex = getEventIndex("onGestureStarted");
        raiseEvent(_onGestureStartedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
