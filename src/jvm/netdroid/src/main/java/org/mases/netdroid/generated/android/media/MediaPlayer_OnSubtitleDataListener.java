...
public final class MediaPlayer_OnSubtitleDataListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnSubtitleDataListener {
     ...
     */
    public MediaPlayer_OnSubtitleDataListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSubtitleDataIndex = 0;
    //@Override
    public void onSubtitleData(android.media.MediaPlayer arg0, android.media.SubtitleData arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSubtitleDataIndex <= 0) _onSubtitleDataIndex = getEventIndex("onSubtitleData");
        raiseEvent(_onSubtitleDataIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
