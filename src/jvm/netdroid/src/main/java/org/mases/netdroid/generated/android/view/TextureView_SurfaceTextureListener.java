...
public final class TextureView_SurfaceTextureListener implements org.mases.jcobridge.IJCListener, android.view.TextureView.SurfaceTextureListener {
    ...
    int _onSurfaceTextureDestroyedIndex = 0;
    //@Override
    public boolean onSurfaceTextureDestroyed(android.graphics.SurfaceTexture arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSurfaceTextureDestroyedIndex <= 0) _onSurfaceTextureDestroyedIndex = getEventIndex("onSurfaceTextureDestroyed");
        raiseEvent(_onSurfaceTextureDestroyedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onSurfaceTextureAvailableIndex = 0;
    //@Override
    public void onSurfaceTextureAvailable(android.graphics.SurfaceTexture arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSurfaceTextureAvailableIndex <= 0) _onSurfaceTextureAvailableIndex = getEventIndex("onSurfaceTextureAvailable");
        raiseEvent(_onSurfaceTextureAvailableIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onSurfaceTextureSizeChangedIndex = 0;
    //@Override
    public void onSurfaceTextureSizeChanged(android.graphics.SurfaceTexture arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSurfaceTextureSizeChangedIndex <= 0) _onSurfaceTextureSizeChangedIndex = getEventIndex("onSurfaceTextureSizeChanged");
        raiseEvent(_onSurfaceTextureSizeChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onSurfaceTextureUpdatedIndex = 0;
    //@Override
    public void onSurfaceTextureUpdated(android.graphics.SurfaceTexture arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSurfaceTextureUpdatedIndex <= 0) _onSurfaceTextureUpdatedIndex = getEventIndex("onSurfaceTextureUpdated");
        raiseEvent(_onSurfaceTextureUpdatedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
