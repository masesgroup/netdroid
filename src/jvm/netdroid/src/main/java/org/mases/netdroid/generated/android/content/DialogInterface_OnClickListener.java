...
public final class DialogInterface_OnClickListener implements org.mases.jcobridge.IJCListener, android.content.DialogInterface.OnClickListener {
     ...
     */
    public DialogInterface_OnClickListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onClick(android.content.DialogInterface arg0, int arg1) {
        ...
        raiseEvent(_onClickIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
