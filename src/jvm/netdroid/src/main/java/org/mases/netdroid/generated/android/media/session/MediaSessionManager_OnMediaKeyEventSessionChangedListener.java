...
public final class MediaSessionManager_OnMediaKeyEventSessionChangedListener implements org.mases.jcobridge.IJCListener, android.media.session.MediaSessionManager.OnMediaKeyEventSessionChangedListener {
     ...
     */
    public MediaSessionManager_OnMediaKeyEventSessionChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onMediaKeyEventSessionChangedIndex = 0;
    //@Override
    public void onMediaKeyEventSessionChanged(java.lang.String arg0, android.media.session.MediaSession.Token arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMediaKeyEventSessionChangedIndex <= 0) _onMediaKeyEventSessionChangedIndex = getEventIndex("onMediaKeyEventSessionChanged");
        raiseEvent(_onMediaKeyEventSessionChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
