...
public final class AccessibilityManager_AccessibilityServicesStateChangeListener implements org.mases.jcobridge.IJCListener, android.view.accessibility.AccessibilityManager.AccessibilityServicesStateChangeListener {
     ...
     */
    public AccessibilityManager_AccessibilityServicesStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAccessibilityServicesStateChangedIndex = 0;
    //@Override
    public void onAccessibilityServicesStateChanged(android.view.accessibility.AccessibilityManager arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAccessibilityServicesStateChangedIndex <= 0) _onAccessibilityServicesStateChangedIndex = getEventIndex("onAccessibilityServicesStateChanged");
        raiseEvent(_onAccessibilityServicesStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
