...
public final class ClipboardManager_OnPrimaryClipChangedListener implements org.mases.jcobridge.IJCListener, android.content.ClipboardManager.OnPrimaryClipChangedListener {
     ...
     */
    public ClipboardManager_OnPrimaryClipChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPrimaryClipChangedIndex = 0;
    //@Override
    public void onPrimaryClipChanged() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPrimaryClipChangedIndex <= 0) _onPrimaryClipChangedIndex = getEventIndex("onPrimaryClipChanged");
        raiseEvent(_onPrimaryClipChangedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
