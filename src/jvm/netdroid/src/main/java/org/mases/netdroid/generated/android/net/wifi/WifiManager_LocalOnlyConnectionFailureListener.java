...
public final class WifiManager_LocalOnlyConnectionFailureListener implements org.mases.jcobridge.IJCListener, android.net.wifi.WifiManager.LocalOnlyConnectionFailureListener {
     ...
     */
    public WifiManager_LocalOnlyConnectionFailureListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onConnectionFailedIndex = 0;
    //@Override
    public void onConnectionFailed(android.net.wifi.WifiNetworkSpecifier arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onConnectionFailedIndex <= 0) _onConnectionFailedIndex = getEventIndex("onConnectionFailed");
        raiseEvent(_onConnectionFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
