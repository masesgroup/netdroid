...
public final class MediaPlayer_OnCompletionListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnCompletionListener {
     ...
     */
    public MediaPlayer_OnCompletionListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCompletionIndex = 0;
    //@Override
    public void onCompletion(android.media.MediaPlayer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCompletionIndex <= 0) _onCompletionIndex = getEventIndex("onCompletion");
        raiseEvent(_onCompletionIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
