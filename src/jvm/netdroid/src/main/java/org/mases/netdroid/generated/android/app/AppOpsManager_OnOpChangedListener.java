...
public final class AppOpsManager_OnOpChangedListener implements org.mases.jcobridge.IJCListener, android.app.AppOpsManager.OnOpChangedListener {
    ...
    int _onOpChangedIndex = 0;
    //@Override
    public void onOpChanged(java.lang.String arg0, java.lang.String arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onOpChangedIndex <= 0) _onOpChangedIndex = getEventIndex("onOpChanged");
        raiseEvent(_onOpChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onOpChanged4Index = 0;
    //@Override
    public void onOpChanged(java.lang.String arg0, java.lang.String arg1, int arg2, java.lang.String arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onOpChanged4Index <= 0) _onOpChanged4Index = getEventIndex("onOpChanged4");
        raiseEvent(_onOpChanged4Index, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) android.app.AppOpsManager.OnOpChangedListener.super.onOpChanged(arg0, arg1, arg2, arg3);
    }
