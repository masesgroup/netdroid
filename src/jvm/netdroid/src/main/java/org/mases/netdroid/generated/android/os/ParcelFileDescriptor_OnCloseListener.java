...
public final class ParcelFileDescriptor_OnCloseListener implements org.mases.jcobridge.IJCListener, android.os.ParcelFileDescriptor.OnCloseListener {
     ...
     */
    public ParcelFileDescriptor_OnCloseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    public void onClose(java.io.IOException arg0) {
        ...
        if (_onCloseIndex <= 0) _onCloseIndex = getEventIndex("onClose");
        raiseEvent(_onCloseIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
