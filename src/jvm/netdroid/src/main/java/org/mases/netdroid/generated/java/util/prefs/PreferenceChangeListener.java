...
package org.mases.netdroid.generated.java.util.prefs;

public final class PreferenceChangeListener implements org.mases.jcobridge.IJCListener, java.util.prefs.PreferenceChangeListener {
    ...
    int _preferenceChangeIndex = 0;
    //@Override
    public void preferenceChange(java.util.prefs.PreferenceChangeEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_preferenceChangeIndex <= 0) _preferenceChangeIndex = getEventIndex("preferenceChange");
        raiseEvent(_preferenceChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
