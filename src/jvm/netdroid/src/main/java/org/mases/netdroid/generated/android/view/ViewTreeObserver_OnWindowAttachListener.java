...
public final class ViewTreeObserver_OnWindowAttachListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnWindowAttachListener {
     ...
     */
    public ViewTreeObserver_OnWindowAttachListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onWindowAttachedIndex = 0;
    //@Override
    public void onWindowAttached() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWindowAttachedIndex <= 0) _onWindowAttachedIndex = getEventIndex("onWindowAttached");
        raiseEvent(_onWindowAttachedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onWindowDetachedIndex = 0;
    //@Override
    public void onWindowDetached() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onWindowDetachedIndex <= 0) _onWindowDetachedIndex = getEventIndex("onWindowDetached");
        raiseEvent(_onWindowDetachedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
