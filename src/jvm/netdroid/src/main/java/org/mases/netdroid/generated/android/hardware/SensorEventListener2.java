...
public final class SensorEventListener2 implements org.mases.jcobridge.IJCListener, android.hardware.SensorEventListener2 {
    ...
    int _onAccuracyChangedIndex = 0;
    //@Override
    public void onAccuracyChanged(android.hardware.Sensor arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAccuracyChangedIndex <= 0) _onAccuracyChangedIndex = getEventIndex("onAccuracyChanged");
        raiseEvent(_onAccuracyChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onSensorChangedIndex = 0;
    //@Override
    public void onSensorChanged(android.hardware.SensorEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSensorChangedIndex <= 0) _onSensorChangedIndex = getEventIndex("onSensorChanged");
        raiseEvent(_onSensorChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void onFlushCompleted(android.hardware.Sensor arg0) {
        ...
        raiseEvent(_onFlushCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
