...
public final class OnNmeaMessageListener implements org.mases.jcobridge.IJCListener, android.location.OnNmeaMessageListener {
     ...
     */
    public OnNmeaMessageListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onNmeaMessageIndex = 0;
    //@Override
    public void onNmeaMessage(java.lang.String arg0, long arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNmeaMessageIndex <= 0) _onNmeaMessageIndex = getEventIndex("onNmeaMessage");
        raiseEvent(_onNmeaMessageIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
