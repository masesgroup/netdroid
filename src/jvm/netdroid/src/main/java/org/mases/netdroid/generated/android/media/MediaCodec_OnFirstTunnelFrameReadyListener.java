...
public final class MediaCodec_OnFirstTunnelFrameReadyListener implements org.mases.jcobridge.IJCListener, android.media.MediaCodec.OnFirstTunnelFrameReadyListener {
     ...
     */
    public MediaCodec_OnFirstTunnelFrameReadyListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFirstTunnelFrameReadyIndex = 0;
    //@Override
    public void onFirstTunnelFrameReady(android.media.MediaCodec arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFirstTunnelFrameReadyIndex <= 0) _onFirstTunnelFrameReadyIndex = getEventIndex("onFirstTunnelFrameReady");
        raiseEvent(_onFirstTunnelFrameReadyIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
