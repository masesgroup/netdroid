...
package org.mases.netdroid.generated.android.app.sdksandbox.sdkprovider;

public final class SdkSandboxClientImportanceListener implements org.mases.jcobridge.IJCListener, android.app.sdksandbox.sdkprovider.SdkSandboxClientImportanceListener {
     ...
     */
    public SdkSandboxClientImportanceListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onForegroundImportanceChangedIndex = 0;
    //@Override
    public void onForegroundImportanceChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onForegroundImportanceChangedIndex <= 0) _onForegroundImportanceChangedIndex = getEventIndex("onForegroundImportanceChanged");
        raiseEvent(_onForegroundImportanceChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
