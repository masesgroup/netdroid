...
public final class StrictMode_OnVmViolationListener implements org.mases.jcobridge.IJCListener, android.os.StrictMode.OnVmViolationListener {
     ...
     */
    public StrictMode_OnVmViolationListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onVmViolationIndex = 0;
    //@Override
    public void onVmViolation(android.os.strictmode.Violation arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onVmViolationIndex <= 0) _onVmViolationIndex = getEventIndex("onVmViolation");
        raiseEvent(_onVmViolationIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
