...
public final class WifiP2pManager_DnsSdTxtRecordListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.DnsSdTxtRecordListener {
    ...
    int _onDnsSdTxtRecordAvailableIndex = 0;
    //@Override
    public void onDnsSdTxtRecordAvailable(java.lang.String arg0, java.util.Map arg1, android.net.wifi.p2p.WifiP2pDevice arg2) {
        ...
        if (_onDnsSdTxtRecordAvailableIndex <= 0) _onDnsSdTxtRecordAvailableIndex = getEventIndex("onDnsSdTxtRecordAvailable");
        raiseEvent(_onDnsSdTxtRecordAvailableIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
