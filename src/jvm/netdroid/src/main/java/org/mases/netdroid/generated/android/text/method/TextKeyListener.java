...
public final class TextKeyListener extends android.text.method.TextKeyListener implements org.mases.jcobridge.IJCListener {
    ...
    public void release() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent("release", eventDataExchange); if (!eventDataExchange.getHasOverride()) super.release();
    }
