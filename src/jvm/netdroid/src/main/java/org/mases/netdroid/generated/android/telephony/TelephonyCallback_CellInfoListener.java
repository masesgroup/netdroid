...
public final class TelephonyCallback_CellInfoListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CellInfoListener {
     ...
     */
    public TelephonyCallback_CellInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCellInfoChangedIndex = 0;
    //@Override
    public void onCellInfoChanged(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCellInfoChangedIndex <= 0) _onCellInfoChangedIndex = getEventIndex("onCellInfoChanged");
        raiseEvent(_onCellInfoChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
