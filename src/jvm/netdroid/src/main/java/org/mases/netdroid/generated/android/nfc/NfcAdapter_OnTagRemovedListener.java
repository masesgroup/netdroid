...
public final class NfcAdapter_OnTagRemovedListener implements org.mases.jcobridge.IJCListener, android.nfc.NfcAdapter.OnTagRemovedListener {
     ...
     */
    public NfcAdapter_OnTagRemovedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTagRemovedIndex = 0;
    //@Override
    public void onTagRemoved() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTagRemovedIndex <= 0) _onTagRemovedIndex = getEventIndex("onTagRemoved");
        raiseEvent(_onTagRemovedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
