...
public final class NumberPicker_OnValueChangeListener implements org.mases.jcobridge.IJCListener, android.widget.NumberPicker.OnValueChangeListener {
     ...
     */
    public NumberPicker_OnValueChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onValueChangeIndex = 0;
    //@Override
    public void onValueChange(android.widget.NumberPicker arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onValueChangeIndex <= 0) _onValueChangeIndex = getEventIndex("onValueChange");
        raiseEvent(_onValueChangeIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
