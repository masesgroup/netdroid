...
public final class GpsStatus_NmeaListener implements org.mases.jcobridge.IJCListener, android.location.GpsStatus.NmeaListener {
     ...
     */
    public GpsStatus_NmeaListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onNmeaReceivedIndex = 0;
    //@Override
    public void onNmeaReceived(long arg0, java.lang.String arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNmeaReceivedIndex <= 0) _onNmeaReceivedIndex = getEventIndex("onNmeaReceived");
        raiseEvent(_onNmeaReceivedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
