...
public final class TimeAnimator_TimeListener implements org.mases.jcobridge.IJCListener, android.animation.TimeAnimator.TimeListener {
    ...
    public void onTimeUpdate(android.animation.TimeAnimator arg0, long arg1, long arg2) {
        ...
        raiseEvent("onTimeUpdate", eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
