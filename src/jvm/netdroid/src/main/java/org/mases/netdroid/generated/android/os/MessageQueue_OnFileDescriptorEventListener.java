...
public final class MessageQueue_OnFileDescriptorEventListener implements org.mases.jcobridge.IJCListener, android.os.MessageQueue.OnFileDescriptorEventListener {
     ...
     */
    public MessageQueue_OnFileDescriptorEventListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onFileDescriptorEventsIndex = 0;
    //@Override
    public int onFileDescriptorEvents(java.io.FileDescriptor arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onFileDescriptorEventsIndex <= 0) _onFileDescriptorEventsIndex = getEventIndex("onFileDescriptorEvents");
        raiseEvent(_onFileDescriptorEventsIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (int)retVal;
    }
