...
public final class MediaDrm_OnExpirationUpdateListener implements org.mases.jcobridge.IJCListener, android.media.MediaDrm.OnExpirationUpdateListener {
     ...
     */
    public MediaDrm_OnExpirationUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onExpirationUpdateIndex = 0;
    //@Override
    public void onExpirationUpdate(android.media.MediaDrm arg0, byte[] arg1, long arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onExpirationUpdateIndex <= 0) _onExpirationUpdateIndex = getEventIndex("onExpirationUpdate");
        raiseEvent(_onExpirationUpdateIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
