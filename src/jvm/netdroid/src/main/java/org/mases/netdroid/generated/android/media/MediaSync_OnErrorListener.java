...
public final class MediaSync_OnErrorListener implements org.mases.jcobridge.IJCListener, android.media.MediaSync.OnErrorListener {
     ...
     */
    public MediaSync_OnErrorListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onErrorIndex = 0;
    //@Override
    public void onError(android.media.MediaSync arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onErrorIndex <= 0) _onErrorIndex = getEventIndex("onError");
        raiseEvent(_onErrorIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
