...
public final class OnAccountsUpdateListener implements org.mases.jcobridge.IJCListener, android.accounts.OnAccountsUpdateListener {
     ...
     */
    public OnAccountsUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAccountsUpdatedIndex = 0;
    //@Override
    public void onAccountsUpdated(android.accounts.Account[] arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAccountsUpdatedIndex <= 0) _onAccountsUpdatedIndex = getEventIndex("onAccountsUpdated");
        raiseEvent(_onAccountsUpdatedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
