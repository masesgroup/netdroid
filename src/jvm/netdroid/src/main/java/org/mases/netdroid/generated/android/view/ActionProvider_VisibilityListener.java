...
public final class ActionProvider_VisibilityListener implements org.mases.jcobridge.IJCListener, android.view.ActionProvider.VisibilityListener {
     ...
     */
    public ActionProvider_VisibilityListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onActionProviderVisibilityChangedIndex = 0;
    //@Override
    public void onActionProviderVisibilityChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActionProviderVisibilityChangedIndex <= 0) _onActionProviderVisibilityChangedIndex = getEventIndex("onActionProviderVisibilityChanged");
        raiseEvent(_onActionProviderVisibilityChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
