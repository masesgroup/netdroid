...
public final class NsdManager_RegistrationListener implements org.mases.jcobridge.IJCListener, android.net.nsd.NsdManager.RegistrationListener {
     ...
     */
    public NsdManager_RegistrationListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onRegistrationFailedIndex = 0;
    //@Override
    public void onRegistrationFailed(android.net.nsd.NsdServiceInfo arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRegistrationFailedIndex <= 0) _onRegistrationFailedIndex = getEventIndex("onRegistrationFailed");
        raiseEvent(_onRegistrationFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceRegisteredIndex = 0;
    //@Override
    public void onServiceRegistered(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceRegisteredIndex <= 0) _onServiceRegisteredIndex = getEventIndex("onServiceRegistered");
        raiseEvent(_onServiceRegisteredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onServiceUnregisteredIndex = 0;
    //@Override
    public void onServiceUnregistered(android.net.nsd.NsdServiceInfo arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onServiceUnregisteredIndex <= 0) _onServiceUnregisteredIndex = getEventIndex("onServiceUnregistered");
        raiseEvent(_onServiceUnregisteredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onUnregistrationFailedIndex = 0;
    //@Override
    public void onUnregistrationFailed(android.net.nsd.NsdServiceInfo arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUnregistrationFailedIndex <= 0) _onUnregistrationFailedIndex = getEventIndex("onUnregistrationFailed");
        raiseEvent(_onUnregistrationFailedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
