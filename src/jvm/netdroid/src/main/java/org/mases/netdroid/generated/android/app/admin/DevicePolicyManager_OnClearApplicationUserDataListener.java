...
package org.mases.netdroid.generated.android.app.admin;

public final class DevicePolicyManager_OnClearApplicationUserDataListener implements org.mases.jcobridge.IJCListener, android.app.admin.DevicePolicyManager.OnClearApplicationUserDataListener {
     ...
     */
    public DevicePolicyManager_OnClearApplicationUserDataListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onApplicationUserDataClearedIndex = 0;
    //@Override
    public void onApplicationUserDataCleared(java.lang.String arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onApplicationUserDataClearedIndex <= 0) _onApplicationUserDataClearedIndex = getEventIndex("onApplicationUserDataCleared");
        raiseEvent(_onApplicationUserDataClearedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
