...
public final class MediaPlayer_OnBufferingUpdateListener implements org.mases.jcobridge.IJCListener, android.media.MediaPlayer.OnBufferingUpdateListener {
     ...
     */
    public MediaPlayer_OnBufferingUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onBufferingUpdateIndex = 0;
    //@Override
    public void onBufferingUpdate(android.media.MediaPlayer arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onBufferingUpdateIndex <= 0) _onBufferingUpdateIndex = getEventIndex("onBufferingUpdate");
        raiseEvent(_onBufferingUpdateIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
