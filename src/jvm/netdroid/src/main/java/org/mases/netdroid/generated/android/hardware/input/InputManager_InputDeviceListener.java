...
public final class InputManager_InputDeviceListener implements org.mases.jcobridge.IJCListener, android.hardware.input.InputManager.InputDeviceListener {
     ...
     */
    public InputManager_InputDeviceListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onInputDeviceAddedIndex = 0;
    //@Override
    public void onInputDeviceAdded(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onInputDeviceAddedIndex <= 0) _onInputDeviceAddedIndex = getEventIndex("onInputDeviceAdded");
        raiseEvent(_onInputDeviceAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onInputDeviceChangedIndex = 0;
    //@Override
    public void onInputDeviceChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onInputDeviceChangedIndex <= 0) _onInputDeviceChangedIndex = getEventIndex("onInputDeviceChanged");
        raiseEvent(_onInputDeviceChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onInputDeviceRemovedIndex = 0;
    //@Override
    public void onInputDeviceRemoved(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onInputDeviceRemovedIndex <= 0) _onInputDeviceRemovedIndex = getEventIndex("onInputDeviceRemoved");
        raiseEvent(_onInputDeviceRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
