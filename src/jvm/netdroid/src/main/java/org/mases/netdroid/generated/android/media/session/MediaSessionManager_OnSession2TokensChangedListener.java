...
public final class MediaSessionManager_OnSession2TokensChangedListener implements org.mases.jcobridge.IJCListener, android.media.session.MediaSessionManager.OnSession2TokensChangedListener {
    ...
    int _onSession2TokensChangedIndex = 0;
    //@Override
    public void onSession2TokensChanged(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSession2TokensChangedIndex <= 0) _onSession2TokensChangedIndex = getEventIndex("onSession2TokensChanged");
        raiseEvent(_onSession2TokensChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
