...
public final class TimePickerDialog_OnTimeSetListener implements org.mases.jcobridge.IJCListener, android.app.TimePickerDialog.OnTimeSetListener {
     ...
     */
    public TimePickerDialog_OnTimeSetListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTimeSetIndex = 0;
    //@Override
    public void onTimeSet(android.widget.TimePicker arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTimeSetIndex <= 0) _onTimeSetIndex = getEventIndex("onTimeSet");
        raiseEvent(_onTimeSetIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
