...
public final class SeekBar_OnSeekBarChangeListener implements org.mases.jcobridge.IJCListener, android.widget.SeekBar.OnSeekBarChangeListener {
    ...
    int _onProgressChangedIndex = 0;
    //@Override
    public void onProgressChanged(android.widget.SeekBar arg0, int arg1, boolean arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onProgressChangedIndex <= 0) _onProgressChangedIndex = getEventIndex("onProgressChanged");
        raiseEvent(_onProgressChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onStartTrackingTouchIndex = 0;
    //@Override
    public void onStartTrackingTouch(android.widget.SeekBar arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStartTrackingTouchIndex <= 0) _onStartTrackingTouchIndex = getEventIndex("onStartTrackingTouch");
        raiseEvent(_onStartTrackingTouchIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onStopTrackingTouchIndex = 0;
    //@Override
    public void onStopTrackingTouch(android.widget.SeekBar arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onStopTrackingTouchIndex <= 0) _onStopTrackingTouchIndex = getEventIndex("onStopTrackingTouch");
        raiseEvent(_onStopTrackingTouchIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
