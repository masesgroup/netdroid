...
public final class Animator_AnimatorPauseListener implements org.mases.jcobridge.IJCListener, android.animation.Animator.AnimatorPauseListener {
    ...
    int _onAnimationPauseIndex = 0;
    //@Override
    public void onAnimationPause(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationPauseIndex <= 0) _onAnimationPauseIndex = getEventIndex("onAnimationPause");
        raiseEvent(_onAnimationPauseIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onAnimationResumeIndex = 0;
    //@Override
    public void onAnimationResume(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationResumeIndex <= 0) _onAnimationResumeIndex = getEventIndex("onAnimationResume");
        raiseEvent(_onAnimationResumeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
