...
public final class AudioManager_OnAudioFocusChangeListener implements org.mases.jcobridge.IJCListener, android.media.AudioManager.OnAudioFocusChangeListener {
     ...
     */
    public AudioManager_OnAudioFocusChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onAudioFocusChangeIndex = 0;
    //@Override
    public void onAudioFocusChange(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAudioFocusChangeIndex <= 0) _onAudioFocusChangeIndex = getEventIndex("onAudioFocusChange");
        raiseEvent(_onAudioFocusChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
