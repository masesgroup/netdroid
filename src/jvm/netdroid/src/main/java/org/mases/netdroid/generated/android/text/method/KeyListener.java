...
public final class KeyListener implements org.mases.jcobridge.IJCListener, android.text.method.KeyListener {
    ...
    public void clearMetaKeyState(android.view.View arg0, android.text.Editable arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent("clearMetaKeyState", eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
