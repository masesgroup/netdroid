...
public final class TelephonyCallback_DataActivityListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.DataActivityListener {
     ...
     */
    public TelephonyCallback_DataActivityListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDataActivityIndex = 0;
    //@Override
    public void onDataActivity(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDataActivityIndex <= 0) _onDataActivityIndex = getEventIndex("onDataActivity");
        raiseEvent(_onDataActivityIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
