...
public final class NumberPicker_OnScrollListener implements org.mases.jcobridge.IJCListener, android.widget.NumberPicker.OnScrollListener {
     ...
     */
    public NumberPicker_OnScrollListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onScrollStateChangeIndex = 0;
    //@Override
    public void onScrollStateChange(android.widget.NumberPicker arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScrollStateChangeIndex <= 0) _onScrollStateChangeIndex = getEventIndex("onScrollStateChange");
        raiseEvent(_onScrollStateChangeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
