...
public final class ViewTreeObserver_OnPreDrawListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnPreDrawListener {
     ...
     */
    public ViewTreeObserver_OnPreDrawListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPreDrawIndex = 0;
    //@Override
    public boolean onPreDraw() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPreDrawIndex <= 0) _onPreDrawIndex = getEventIndex("onPreDraw");
        raiseEvent(_onPreDrawIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
