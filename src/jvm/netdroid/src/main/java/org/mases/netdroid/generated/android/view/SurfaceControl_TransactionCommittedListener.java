...
public final class SurfaceControl_TransactionCommittedListener implements org.mases.jcobridge.IJCListener, android.view.SurfaceControl.TransactionCommittedListener {
     ...
     */
    public SurfaceControl_TransactionCommittedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTransactionCommittedIndex = 0;
    //@Override
    public void onTransactionCommitted() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransactionCommittedIndex <= 0) _onTransactionCommittedIndex = getEventIndex("onTransactionCommitted");
        raiseEvent(_onTransactionCommittedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
