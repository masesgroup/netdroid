...
package org.mases.netdroid.generated.java.beans;

public final class PropertyChangeListener implements org.mases.jcobridge.IJCListener, java.beans.PropertyChangeListener {
    ...
    int _propertyChangeIndex = 0;
    //@Override
    public void propertyChange(java.beans.PropertyChangeEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_propertyChangeIndex <= 0) _propertyChangeIndex = getEventIndex("propertyChange");
        raiseEvent(_propertyChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
