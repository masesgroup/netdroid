...
public final class Preference_OnPreferenceClickListener implements org.mases.jcobridge.IJCListener, android.preference.Preference.OnPreferenceClickListener {
    ...
    int _onPreferenceClickIndex = 0;
    //@Override
    public boolean onPreferenceClick(android.preference.Preference arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPreferenceClickIndex <= 0) _onPreferenceClickIndex = getEventIndex("onPreferenceClick");
        raiseEvent(_onPreferenceClickIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
