...
public final class AccessibilityService_MagnificationController_OnMagnificationChangedListener implements org.mases.jcobridge.IJCListener, android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener {
    ...
    int _onMagnificationChangedIndex = 0;
    //@Override
    public void onMagnificationChanged(android.accessibilityservice.AccessibilityService.MagnificationController arg0, android.graphics.Region arg1, float arg2, float arg3, float arg4) {
        ...
        if (_onMagnificationChangedIndex <= 0) _onMagnificationChangedIndex = getEventIndex("onMagnificationChanged");
        raiseEvent(_onMagnificationChangedIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onMagnificationChanged3Index = 0;
    //@Override
    public void onMagnificationChanged(android.accessibilityservice.AccessibilityService.MagnificationController arg0, android.graphics.Region arg1, android.accessibilityservice.MagnificationConfig arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMagnificationChanged3Index <= 0) _onMagnificationChanged3Index = getEventIndex("onMagnificationChanged3");
        raiseEvent(_onMagnificationChanged3Index, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener.super.onMagnificationChanged(arg0, arg1, arg2);
    }
