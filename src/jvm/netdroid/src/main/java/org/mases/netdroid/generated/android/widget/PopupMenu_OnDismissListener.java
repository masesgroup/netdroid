...
public final class PopupMenu_OnDismissListener implements org.mases.jcobridge.IJCListener, android.widget.PopupMenu.OnDismissListener {
     ...
     */
    public PopupMenu_OnDismissListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDismissIndex = 0;
    //@Override
    public void onDismiss(android.widget.PopupMenu arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDismissIndex <= 0) _onDismissIndex = getEventIndex("onDismiss");
        raiseEvent(_onDismissIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
