...
public final class AudioRecord_OnRoutingChangedListener implements org.mases.jcobridge.IJCListener, android.media.AudioRecord.OnRoutingChangedListener {
     ...
     */
    public AudioRecord_OnRoutingChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onRoutingChangedIndex = 0;
    //@Override
    public void onRoutingChanged(android.media.AudioRecord arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRoutingChangedIndex <= 0) _onRoutingChangedIndex = getEventIndex("onRoutingChanged");
        raiseEvent(_onRoutingChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onRoutingChanged1Index = 0;
    //@Override
    public void onRoutingChanged(android.media.AudioRouting arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRoutingChanged1Index <= 0) _onRoutingChanged1Index = getEventIndex("onRoutingChanged1");
        raiseEvent(_onRoutingChanged1Index, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.media.AudioRecord.OnRoutingChangedListener.super.onRoutingChanged(arg0);
    }
    
    //@Override
    public void onRoutingChangedDefault(android.media.AudioRouting arg0) {
        android.media.AudioRecord.OnRoutingChangedListener.super.onRoutingChanged(arg0);
    }
