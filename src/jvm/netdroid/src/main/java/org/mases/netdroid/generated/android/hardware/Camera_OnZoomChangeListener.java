...
public final class Camera_OnZoomChangeListener implements org.mases.jcobridge.IJCListener, android.hardware.Camera.OnZoomChangeListener {
    ...
    int _onZoomChangeIndex = 0;
    //@Override
    public void onZoomChange(int arg0, boolean arg1, android.hardware.Camera arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onZoomChangeIndex <= 0) _onZoomChangeIndex = getEventIndex("onZoomChange");
        raiseEvent(_onZoomChangeIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
