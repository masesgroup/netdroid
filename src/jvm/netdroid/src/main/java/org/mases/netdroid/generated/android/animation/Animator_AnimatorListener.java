...
public final class Animator_AnimatorListener implements org.mases.jcobridge.IJCListener, android.animation.Animator.AnimatorListener {
    ...
    int _onAnimationCancelIndex = 0;
    //@Override
    public void onAnimationCancel(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationCancelIndex <= 0) _onAnimationCancelIndex = getEventIndex("onAnimationCancel");
        raiseEvent(_onAnimationCancelIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onAnimationEndIndex = 0;
    //@Override
    public void onAnimationEnd(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationEndIndex <= 0) _onAnimationEndIndex = getEventIndex("onAnimationEnd");
        raiseEvent(_onAnimationEndIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onAnimationRepeatIndex = 0;
    //@Override
    public void onAnimationRepeat(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationRepeatIndex <= 0) _onAnimationRepeatIndex = getEventIndex("onAnimationRepeat");
        raiseEvent(_onAnimationRepeatIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onAnimationStartIndex = 0;
    //@Override
    public void onAnimationStart(android.animation.Animator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationStartIndex <= 0) _onAnimationStartIndex = getEventIndex("onAnimationStart");
        raiseEvent(_onAnimationStartIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onAnimationEnd2Index = 0;
    //@Override
    public void onAnimationEnd(android.animation.Animator arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationEnd2Index <= 0) _onAnimationEnd2Index = getEventIndex("onAnimationEnd2");
        raiseEvent(_onAnimationEnd2Index, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) android.animation.Animator.AnimatorListener.super.onAnimationEnd(arg0, arg1);
    }
    ...
    int _onAnimationStart2Index = 0;
    //@Override
    public void onAnimationStart(android.animation.Animator arg0, boolean arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationStart2Index <= 0) _onAnimationStart2Index = getEventIndex("onAnimationStart2");
        raiseEvent(_onAnimationStart2Index, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) android.animation.Animator.AnimatorListener.super.onAnimationStart(arg0, arg1);
    }
