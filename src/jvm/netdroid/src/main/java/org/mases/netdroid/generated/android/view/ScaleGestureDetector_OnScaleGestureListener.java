...
public final class ScaleGestureDetector_OnScaleGestureListener implements org.mases.jcobridge.IJCListener, android.view.ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean onScale(android.view.ScaleGestureDetector arg0) {
        ...
        if (_onScaleIndex <= 0) _onScaleIndex = getEventIndex("onScale");
        raiseEvent(_onScaleIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onScaleBeginIndex = 0;
    //@Override
    public boolean onScaleBegin(android.view.ScaleGestureDetector arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScaleBeginIndex <= 0) _onScaleBeginIndex = getEventIndex("onScaleBegin");
        raiseEvent(_onScaleBeginIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onScaleEndIndex = 0;
    //@Override
    public void onScaleEnd(android.view.ScaleGestureDetector arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onScaleEndIndex <= 0) _onScaleEndIndex = getEventIndex("onScaleEnd");
        raiseEvent(_onScaleEndIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
