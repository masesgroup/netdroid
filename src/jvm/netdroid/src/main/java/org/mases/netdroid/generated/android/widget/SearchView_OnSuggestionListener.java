...
public final class SearchView_OnSuggestionListener implements org.mases.jcobridge.IJCListener, android.widget.SearchView.OnSuggestionListener {
    ...
    int _onSuggestionClickIndex = 0;
    //@Override
    public boolean onSuggestionClick(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSuggestionClickIndex <= 0) _onSuggestionClickIndex = getEventIndex("onSuggestionClick");
        raiseEvent(_onSuggestionClickIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onSuggestionSelectIndex = 0;
    //@Override
    public boolean onSuggestionSelect(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSuggestionSelectIndex <= 0) _onSuggestionSelectIndex = getEventIndex("onSuggestionSelect");
        raiseEvent(_onSuggestionSelectIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
