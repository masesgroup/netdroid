...
public final class TabHost_OnTabChangeListener implements org.mases.jcobridge.IJCListener, android.widget.TabHost.OnTabChangeListener {
     ...
     */
    public TabHost_OnTabChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTabChangedIndex = 0;
    //@Override
    public void onTabChanged(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTabChangedIndex <= 0) _onTabChangedIndex = getEventIndex("onTabChanged");
        raiseEvent(_onTabChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
