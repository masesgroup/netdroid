...
public final class TelephonyCallback_PreciseDataConnectionStateListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.PreciseDataConnectionStateListener {
     ...
     */
    public TelephonyCallback_PreciseDataConnectionStateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPreciseDataConnectionStateChangedIndex = 0;
    //@Override
    public void onPreciseDataConnectionStateChanged(android.telephony.PreciseDataConnectionState arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPreciseDataConnectionStateChangedIndex <= 0) _onPreciseDataConnectionStateChangedIndex = getEventIndex("onPreciseDataConnectionStateChanged");
        raiseEvent(_onPreciseDataConnectionStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
