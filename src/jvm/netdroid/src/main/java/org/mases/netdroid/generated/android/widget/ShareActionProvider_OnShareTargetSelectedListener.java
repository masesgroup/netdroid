...
public final class ShareActionProvider_OnShareTargetSelectedListener implements org.mases.jcobridge.IJCListener, android.widget.ShareActionProvider.OnShareTargetSelectedListener {
     ...
     */
    public ShareActionProvider_OnShareTargetSelectedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onShareTargetSelectedIndex = 0;
    //@Override
    public boolean onShareTargetSelected(android.widget.ShareActionProvider arg0, android.content.Intent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onShareTargetSelectedIndex <= 0) _onShareTargetSelectedIndex = getEventIndex("onShareTargetSelected");
        raiseEvent(_onShareTargetSelectedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
