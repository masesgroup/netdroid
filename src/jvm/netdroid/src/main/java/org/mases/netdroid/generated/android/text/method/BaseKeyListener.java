...
public final class BaseKeyListener extends android.text.method.BaseKeyListener implements org.mases.jcobridge.IJCListener {
    ...
    int _getInputTypeIndex = 0;
    //@Override
    public int getInputType() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_getInputTypeIndex <= 0) _getInputTypeIndex = getEventIndex("getInputType");
        raiseEvent(_getInputTypeIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (int)retVal;
    }
    int _backspaceIndex = 0;
    //@Override
    public boolean backspace(android.view.View arg0, android.text.Editable arg1, int arg2, android.view.KeyEvent arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_backspaceIndex <= 0) _backspaceIndex = getEventIndex("backspace");
        raiseEvent(_backspaceIndex, eventDataExchange, arg0, arg1, arg2, arg3); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.backspace(arg0, arg1, arg2, arg3); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _forwardDeleteIndex = 0;
    //@Override
    public boolean forwardDelete(android.view.View arg0, android.text.Editable arg1, int arg2, android.view.KeyEvent arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_forwardDeleteIndex <= 0) _forwardDeleteIndex = getEventIndex("forwardDelete");
        raiseEvent(_forwardDeleteIndex, eventDataExchange, arg0, arg1, arg2, arg3); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.forwardDelete(arg0, arg1, arg2, arg3); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    ...
    public boolean onKeyDown(android.view.View arg0, android.text.Editable arg1, int arg2, android.view.KeyEvent arg3) {
        ...
        raiseEvent(_onKeyDownIndex, eventDataExchange, arg0, arg1, arg2, arg3); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.onKeyDown(arg0, arg1, arg2, arg3); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onKeyOtherIndex = 0;
    //@Override
    public boolean onKeyOther(android.view.View arg0, android.text.Editable arg1, android.view.KeyEvent arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onKeyOtherIndex <= 0) _onKeyOtherIndex = getEventIndex("onKeyOther");
        raiseEvent(_onKeyOtherIndex, eventDataExchange, arg0, arg1, arg2); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.onKeyOther(arg0, arg1, arg2); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _onKeyUpIndex = 0;
    //@Override
    public boolean onKeyUp(android.view.View arg0, android.text.Editable arg1, int arg2, android.view.KeyEvent arg3) {
        ...
        raiseEvent(_onKeyUpIndex, eventDataExchange, arg0, arg1, arg2, arg3); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.onKeyUp(arg0, arg1, arg2, arg3); else retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
    int _clearMetaKeyStateIndex = 0;
    //@Override
    public long clearMetaKeyState(long arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_clearMetaKeyStateIndex <= 0) _clearMetaKeyStateIndex = getEventIndex("clearMetaKeyState");
        raiseEvent(_clearMetaKeyStateIndex, eventDataExchange, arg0, arg1); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = super.clearMetaKeyState(arg0, arg1); else retVal = eventDataExchange.getReturnData(); return (long)retVal;
    }
    int _clearMetaKeyState3Index = 0;
    //@Override
    public void clearMetaKeyState(android.view.View arg0, android.text.Editable arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_clearMetaKeyState3Index <= 0) _clearMetaKeyState3Index = getEventIndex("clearMetaKeyState3");
        raiseEvent(_clearMetaKeyState3Index, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) super.clearMetaKeyState(arg0, arg1, arg2);
    }
