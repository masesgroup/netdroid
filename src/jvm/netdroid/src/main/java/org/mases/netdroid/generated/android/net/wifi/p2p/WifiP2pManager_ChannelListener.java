...
public final class WifiP2pManager_ChannelListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.ChannelListener {
     ...
     */
    public WifiP2pManager_ChannelListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onChannelDisconnectedIndex = 0;
    //@Override
    public void onChannelDisconnected() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onChannelDisconnectedIndex <= 0) _onChannelDisconnectedIndex = getEventIndex("onChannelDisconnected");
        raiseEvent(_onChannelDisconnectedIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
