...
public final class SensorListener implements org.mases.jcobridge.IJCListener, android.hardware.SensorListener {
    ...
    public void onSensorChanged(int arg0, float[] arg1) {
        ...
        raiseEvent(_onSensorChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
