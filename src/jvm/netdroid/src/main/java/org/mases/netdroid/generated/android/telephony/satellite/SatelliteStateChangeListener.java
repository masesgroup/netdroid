...
package org.mases.netdroid.generated.android.telephony.satellite;

public final class SatelliteStateChangeListener implements org.mases.jcobridge.IJCListener, android.telephony.satellite.SatelliteStateChangeListener {
     ...
     */
    public SatelliteStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onEnabledStateChangedIndex = 0;
    //@Override
    public void onEnabledStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onEnabledStateChangedIndex <= 0) _onEnabledStateChangedIndex = getEventIndex("onEnabledStateChanged");
        raiseEvent(_onEnabledStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
