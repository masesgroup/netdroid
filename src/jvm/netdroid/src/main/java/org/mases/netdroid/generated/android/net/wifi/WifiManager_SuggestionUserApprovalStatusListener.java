...
public final class WifiManager_SuggestionUserApprovalStatusListener implements org.mases.jcobridge.IJCListener, android.net.wifi.WifiManager.SuggestionUserApprovalStatusListener {
     ...
     */
    public WifiManager_SuggestionUserApprovalStatusListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onUserApprovalStatusChangeIndex = 0;
    //@Override
    public void onUserApprovalStatusChange(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUserApprovalStatusChangeIndex <= 0) _onUserApprovalStatusChangeIndex = getEventIndex("onUserApprovalStatusChange");
        raiseEvent(_onUserApprovalStatusChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
