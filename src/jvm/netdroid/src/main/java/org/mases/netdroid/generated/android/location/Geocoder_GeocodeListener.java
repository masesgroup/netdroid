...
public final class Geocoder_GeocodeListener implements org.mases.jcobridge.IJCListener, android.location.Geocoder.GeocodeListener {
     ...
     */
    public Geocoder_GeocodeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onGeocodeIndex = 0;
    //@Override
    public void onGeocode(java.util.List arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onGeocodeIndex <= 0) _onGeocodeIndex = getEventIndex("onGeocode");
        raiseEvent(_onGeocodeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onErrorIndex = 0;
    //@Override
    public void onError(java.lang.String arg0) {
        ...
        raiseEvent(_onErrorIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) android.location.Geocoder.GeocodeListener.super.onError(arg0);
    }
    
    //@Override
    public void onErrorDefault(java.lang.String arg0) {
        android.location.Geocoder.GeocodeListener.super.onError(arg0);
    }
