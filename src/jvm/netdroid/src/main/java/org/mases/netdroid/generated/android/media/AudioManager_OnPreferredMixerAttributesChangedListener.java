...
public final class AudioManager_OnPreferredMixerAttributesChangedListener implements org.mases.jcobridge.IJCListener, android.media.AudioManager.OnPreferredMixerAttributesChangedListener {
     ...
     */
    public AudioManager_OnPreferredMixerAttributesChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPreferredMixerAttributesChangedIndex = 0;
    //@Override
    public void onPreferredMixerAttributesChanged(android.media.AudioAttributes arg0, android.media.AudioDeviceInfo arg1, android.media.AudioMixerAttributes arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPreferredMixerAttributesChangedIndex <= 0) _onPreferredMixerAttributesChangedIndex = getEventIndex("onPreferredMixerAttributesChanged");
        raiseEvent(_onPreferredMixerAttributesChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
