...
public final class WifiP2pManager_DnsSdServiceResponseListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.DnsSdServiceResponseListener {
     ...
     */
    public WifiP2pManager_DnsSdServiceResponseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDnsSdServiceAvailableIndex = 0;
    //@Override
    public void onDnsSdServiceAvailable(java.lang.String arg0, java.lang.String arg1, android.net.wifi.p2p.WifiP2pDevice arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDnsSdServiceAvailableIndex <= 0) _onDnsSdServiceAvailableIndex = getEventIndex("onDnsSdServiceAvailable");
        raiseEvent(_onDnsSdServiceAvailableIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
