...
public final class WebIconDatabase_IconListener implements org.mases.jcobridge.IJCListener, android.webkit.WebIconDatabase.IconListener {
     ...
     */
    public WebIconDatabase_IconListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onReceivedIconIndex = 0;
    //@Override
    public void onReceivedIcon(java.lang.String arg0, android.graphics.Bitmap arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onReceivedIconIndex <= 0) _onReceivedIconIndex = getEventIndex("onReceivedIcon");
        raiseEvent(_onReceivedIconIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
