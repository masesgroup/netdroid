...
public final class View_OnHoverListener implements org.mases.jcobridge.IJCListener, android.view.View.OnHoverListener {
     ...
     */
    public View_OnHoverListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onHoverIndex = 0;
    //@Override
    public boolean onHover(android.view.View arg0, android.view.MotionEvent arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onHoverIndex <= 0) _onHoverIndex = getEventIndex("onHover");
        raiseEvent(_onHoverIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (boolean)retVal;
    }
