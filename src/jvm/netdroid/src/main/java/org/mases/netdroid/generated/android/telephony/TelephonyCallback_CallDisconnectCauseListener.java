...
public final class TelephonyCallback_CallDisconnectCauseListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CallDisconnectCauseListener {
     ...
     */
    public TelephonyCallback_CallDisconnectCauseListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCallDisconnectCauseChangedIndex = 0;
    //@Override
    public void onCallDisconnectCauseChanged(int arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCallDisconnectCauseChangedIndex <= 0) _onCallDisconnectCauseChangedIndex = getEventIndex("onCallDisconnectCauseChanged");
        raiseEvent(_onCallDisconnectCauseChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
