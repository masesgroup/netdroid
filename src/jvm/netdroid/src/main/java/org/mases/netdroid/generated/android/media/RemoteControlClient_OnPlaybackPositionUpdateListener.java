...
public final class RemoteControlClient_OnPlaybackPositionUpdateListener implements org.mases.jcobridge.IJCListener, android.media.RemoteControlClient.OnPlaybackPositionUpdateListener {
     ...
     */
    public RemoteControlClient_OnPlaybackPositionUpdateListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPlaybackPositionUpdateIndex = 0;
    //@Override
    public void onPlaybackPositionUpdate(long arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPlaybackPositionUpdateIndex <= 0) _onPlaybackPositionUpdateIndex = getEventIndex("onPlaybackPositionUpdate");
        raiseEvent(_onPlaybackPositionUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
