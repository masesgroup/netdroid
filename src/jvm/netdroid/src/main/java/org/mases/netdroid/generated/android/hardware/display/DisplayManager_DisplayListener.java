...
public final class DisplayManager_DisplayListener implements org.mases.jcobridge.IJCListener, android.hardware.display.DisplayManager.DisplayListener {
    ...
    int _onDisplayAddedIndex = 0;
    //@Override
    public void onDisplayAdded(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDisplayAddedIndex <= 0) _onDisplayAddedIndex = getEventIndex("onDisplayAdded");
        raiseEvent(_onDisplayAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onDisplayChangedIndex = 0;
    //@Override
    public void onDisplayChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDisplayChangedIndex <= 0) _onDisplayChangedIndex = getEventIndex("onDisplayChanged");
        raiseEvent(_onDisplayChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onDisplayRemovedIndex = 0;
    //@Override
    public void onDisplayRemoved(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDisplayRemovedIndex <= 0) _onDisplayRemovedIndex = getEventIndex("onDisplayRemoved");
        raiseEvent(_onDisplayRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
