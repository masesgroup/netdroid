...
public final class TelephonyCallback_ActiveDataSubscriptionIdListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.ActiveDataSubscriptionIdListener {
     ...
     */
    public TelephonyCallback_ActiveDataSubscriptionIdListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onActiveDataSubscriptionIdChangedIndex = 0;
    //@Override
    public void onActiveDataSubscriptionIdChanged(int arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onActiveDataSubscriptionIdChangedIndex <= 0) _onActiveDataSubscriptionIdChangedIndex = getEventIndex("onActiveDataSubscriptionIdChanged");
        raiseEvent(_onActiveDataSubscriptionIdChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
