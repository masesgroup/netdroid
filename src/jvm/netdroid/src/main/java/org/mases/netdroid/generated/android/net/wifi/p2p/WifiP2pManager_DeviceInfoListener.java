...
public final class WifiP2pManager_DeviceInfoListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.DeviceInfoListener {
     ...
     */
    public WifiP2pManager_DeviceInfoListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onDeviceInfoAvailableIndex = 0;
    //@Override
    public void onDeviceInfoAvailable(android.net.wifi.p2p.WifiP2pDevice arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onDeviceInfoAvailableIndex <= 0) _onDeviceInfoAvailableIndex = getEventIndex("onDeviceInfoAvailable");
        raiseEvent(_onDeviceInfoAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
