...
public final class TelephonyCallback_SignalStrengthsListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.SignalStrengthsListener {
     ...
     */
    public TelephonyCallback_SignalStrengthsListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSignalStrengthsChangedIndex = 0;
    //@Override
    public void onSignalStrengthsChanged(android.telephony.SignalStrength arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSignalStrengthsChangedIndex <= 0) _onSignalStrengthsChangedIndex = getEventIndex("onSignalStrengthsChanged");
        raiseEvent(_onSignalStrengthsChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
