...
package org.mases.netdroid.generated.android.transition;

public final class Transition_TransitionListener implements org.mases.jcobridge.IJCListener, android.transition.Transition.TransitionListener {
     ...
     */
    public Transition_TransitionListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTransitionCancelIndex = 0;
    //@Override
    public void onTransitionCancel(android.transition.Transition arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransitionCancelIndex <= 0) _onTransitionCancelIndex = getEventIndex("onTransitionCancel");
        raiseEvent(_onTransitionCancelIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onTransitionEndIndex = 0;
    //@Override
    public void onTransitionEnd(android.transition.Transition arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransitionEndIndex <= 0) _onTransitionEndIndex = getEventIndex("onTransitionEnd");
        raiseEvent(_onTransitionEndIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onTransitionPauseIndex = 0;
    //@Override
    public void onTransitionPause(android.transition.Transition arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransitionPauseIndex <= 0) _onTransitionPauseIndex = getEventIndex("onTransitionPause");
        raiseEvent(_onTransitionPauseIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onTransitionResumeIndex = 0;
    //@Override
    public void onTransitionResume(android.transition.Transition arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransitionResumeIndex <= 0) _onTransitionResumeIndex = getEventIndex("onTransitionResume");
        raiseEvent(_onTransitionResumeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onTransitionStartIndex = 0;
    //@Override
    public void onTransitionStart(android.transition.Transition arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTransitionStartIndex <= 0) _onTransitionStartIndex = getEventIndex("onTransitionStart");
        raiseEvent(_onTransitionStartIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
