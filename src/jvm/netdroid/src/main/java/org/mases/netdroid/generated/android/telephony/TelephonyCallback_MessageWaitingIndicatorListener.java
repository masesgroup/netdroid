...
public final class TelephonyCallback_MessageWaitingIndicatorListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.MessageWaitingIndicatorListener {
     ...
     */
    public TelephonyCallback_MessageWaitingIndicatorListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onMessageWaitingIndicatorChangedIndex = 0;
    //@Override
    public void onMessageWaitingIndicatorChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onMessageWaitingIndicatorChangedIndex <= 0) _onMessageWaitingIndicatorChangedIndex = getEventIndex("onMessageWaitingIndicatorChanged");
        raiseEvent(_onMessageWaitingIndicatorChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
