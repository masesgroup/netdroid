...
public final class AccessibilityManager_HighContrastTextStateChangeListener implements org.mases.jcobridge.IJCListener, android.view.accessibility.AccessibilityManager.HighContrastTextStateChangeListener {
     ...
     */
    public AccessibilityManager_HighContrastTextStateChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onHighContrastTextStateChangedIndex = 0;
    //@Override
    public void onHighContrastTextStateChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onHighContrastTextStateChangedIndex <= 0) _onHighContrastTextStateChangedIndex = getEventIndex("onHighContrastTextStateChanged");
        raiseEvent(_onHighContrastTextStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
