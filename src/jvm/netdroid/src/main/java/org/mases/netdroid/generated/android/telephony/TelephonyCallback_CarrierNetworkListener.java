...
public final class TelephonyCallback_CarrierNetworkListener implements org.mases.jcobridge.IJCListener, android.telephony.TelephonyCallback.CarrierNetworkListener {
     ...
     */
    public TelephonyCallback_CarrierNetworkListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onCarrierNetworkChangeIndex = 0;
    //@Override
    public void onCarrierNetworkChange(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCarrierNetworkChangeIndex <= 0) _onCarrierNetworkChangeIndex = getEventIndex("onCarrierNetworkChange");
        raiseEvent(_onCarrierNetworkChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
