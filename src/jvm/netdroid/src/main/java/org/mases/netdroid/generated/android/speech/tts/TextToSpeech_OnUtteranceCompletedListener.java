...
public final class TextToSpeech_OnUtteranceCompletedListener implements org.mases.jcobridge.IJCListener, android.speech.tts.TextToSpeech.OnUtteranceCompletedListener {
     ...
     */
    public TextToSpeech_OnUtteranceCompletedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onUtteranceCompletedIndex = 0;
    //@Override
    public void onUtteranceCompleted(java.lang.String arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onUtteranceCompletedIndex <= 0) _onUtteranceCompletedIndex = getEventIndex("onUtteranceCompleted");
        raiseEvent(_onUtteranceCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
