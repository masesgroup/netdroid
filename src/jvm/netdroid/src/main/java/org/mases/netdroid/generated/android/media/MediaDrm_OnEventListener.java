...
public final class MediaDrm_OnEventListener implements org.mases.jcobridge.IJCListener, android.media.MediaDrm.OnEventListener {
     ...
     */
    public MediaDrm_OnEventListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onEventIndex = 0;
    //@Override
    public void onEvent(android.media.MediaDrm arg0, byte[] arg1, int arg2, int arg3, byte[] arg4) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onEventIndex <= 0) _onEventIndex = getEventIndex("onEvent");
        raiseEvent(_onEventIndex, eventDataExchange, arg0, arg1, arg2, arg3, arg4); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
