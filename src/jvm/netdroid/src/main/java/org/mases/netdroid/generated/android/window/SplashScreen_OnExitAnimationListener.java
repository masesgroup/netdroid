...
package org.mases.netdroid.generated.android.window;

public final class SplashScreen_OnExitAnimationListener implements org.mases.jcobridge.IJCListener, android.window.SplashScreen.OnExitAnimationListener {
     ...
     */
    public SplashScreen_OnExitAnimationListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onSplashScreenExitIndex = 0;
    //@Override
    public void onSplashScreenExit(android.window.SplashScreenView arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onSplashScreenExitIndex <= 0) _onSplashScreenExitIndex = getEventIndex("onSplashScreenExit");
        raiseEvent(_onSplashScreenExitIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
