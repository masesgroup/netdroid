...
public final class HandshakeCompletedListener implements org.mases.jcobridge.IJCListener, javax.net.ssl.HandshakeCompletedListener {
    ...
    int _handshakeCompletedIndex = 0;
    //@Override
    public void handshakeCompleted(javax.net.ssl.HandshakeCompletedEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_handshakeCompletedIndex <= 0) _handshakeCompletedIndex = getEventIndex("handshakeCompleted");
        raiseEvent(_handshakeCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
