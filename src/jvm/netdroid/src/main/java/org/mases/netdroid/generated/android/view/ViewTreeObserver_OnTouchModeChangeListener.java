...
public final class ViewTreeObserver_OnTouchModeChangeListener implements org.mases.jcobridge.IJCListener, android.view.ViewTreeObserver.OnTouchModeChangeListener {
     ...
     */
    public ViewTreeObserver_OnTouchModeChangeListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTouchModeChangedIndex = 0;
    //@Override
    public void onTouchModeChanged(boolean arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTouchModeChangedIndex <= 0) _onTouchModeChangedIndex = getEventIndex("onTouchModeChanged");
        raiseEvent(_onTouchModeChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
