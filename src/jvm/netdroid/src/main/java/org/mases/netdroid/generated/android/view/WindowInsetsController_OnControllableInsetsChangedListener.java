...
public final class WindowInsetsController_OnControllableInsetsChangedListener implements org.mases.jcobridge.IJCListener, android.view.WindowInsetsController.OnControllableInsetsChangedListener {
     ...
     */
    public WindowInsetsController_OnControllableInsetsChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onControllableInsetsChangedIndex = 0;
    //@Override
    public void onControllableInsetsChanged(android.view.WindowInsetsController arg0, int arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onControllableInsetsChangedIndex <= 0) _onControllableInsetsChangedIndex = getEventIndex("onControllableInsetsChanged");
        raiseEvent(_onControllableInsetsChangedIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
