...
public final class WifiP2pManager_PeerListListener implements org.mases.jcobridge.IJCListener, android.net.wifi.p2p.WifiP2pManager.PeerListListener {
     ...
     */
    public WifiP2pManager_PeerListListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onPeersAvailableIndex = 0;
    //@Override
    public void onPeersAvailable(android.net.wifi.p2p.WifiP2pDeviceList arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPeersAvailableIndex <= 0) _onPeersAvailableIndex = getEventIndex("onPeersAvailable");
        raiseEvent(_onPeersAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
