...
public final class ValueAnimator_AnimatorUpdateListener implements org.mases.jcobridge.IJCListener, android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    int _onAnimationUpdateIndex = 0;
    //@Override
    public void onAnimationUpdate(android.animation.ValueAnimator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onAnimationUpdateIndex <= 0) _onAnimationUpdateIndex = getEventIndex("onAnimationUpdate");
        raiseEvent(_onAnimationUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
