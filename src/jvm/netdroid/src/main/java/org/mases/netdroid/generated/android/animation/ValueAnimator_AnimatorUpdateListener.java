...
public final class ValueAnimator_AnimatorUpdateListener implements org.mases.jcobridge.IJCListener, android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator arg0) {
        ...
        raiseEvent("onAnimationUpdate", eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
