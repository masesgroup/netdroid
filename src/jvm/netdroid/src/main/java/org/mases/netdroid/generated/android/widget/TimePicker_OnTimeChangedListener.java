...
public final class TimePicker_OnTimeChangedListener implements org.mases.jcobridge.IJCListener, android.widget.TimePicker.OnTimeChangedListener {
     ...
     */
    public TimePicker_OnTimeChangedListener(String key) throws org.mases.jcobridge.JCNativeException {
        super();
    ...
    int _onTimeChangedIndex = 0;
    //@Override
    public void onTimeChanged(android.widget.TimePicker arg0, int arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onTimeChangedIndex <= 0) _onTimeChangedIndex = getEventIndex("onTimeChanged");
        raiseEvent(_onTimeChangedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
