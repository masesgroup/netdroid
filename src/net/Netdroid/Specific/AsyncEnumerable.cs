...
namespace MASES.Netdroid.Specific
{
    ...
    public class NetdroidAsyncEnumerator<TObject> : JVMBridgeBasePrefetchableEnumerator<TObject>, IAsyncEnumerator<TObject>
    {
        ...
        /// <summary>
        /// Initialize a new <see cref="NetdroidAsyncEnumerator{TObject}"/>
        /// </summary>
        ...
        public NetdroidAsyncEnumerator(IJavaObject refObj, IEnumerableExtension extension, CancellationToken cancellationToken)
    ...
    public abstract class NetdroidAsyncEnumerable<TClass, TObject> : JVMBridgeBaseEnumerable<TClass, TObject>, IAsyncEnumerable<TObject>
        where TClass : JVMBridgeBase, new()
    {
        /// <summary>
        /// Create an instance of <see cref="NetdroidAsyncEnumerable{TClass, TObject}"/>
        /// </summary>
        public NetdroidAsyncEnumerable()
        {
        }
        /// <summary>
        /// Create an instance of <see cref="NetdroidAsyncEnumerable{TClass, TObject}"/>
        ...
        public NetdroidAsyncEnumerable(params object[] args)
            : base(args)
        {
        }
        ...
        {
            return new NetdroidAsyncEnumerator<TObject>(IExecute("iterator") as IJavaObject, this, cancellationToken);
        }
    }
}
