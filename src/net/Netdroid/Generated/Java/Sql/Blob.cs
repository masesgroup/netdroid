...
namespace Java.Sql
{
    ...
    public partial class Blob : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Blob>
    {
        ...
        public Blob(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IBlob
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/sql/Blob.html"/>
    /// </summary>
