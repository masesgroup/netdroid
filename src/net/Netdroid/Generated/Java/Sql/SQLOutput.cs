...
namespace Java.Sql
{
    ...
    public partial class SQLOutput : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SQLOutput>
    {
        ...
        public SQLOutput(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region ISQLOutput
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/sql/SQLOutput.html"/>
    /// </summary>
