...
namespace Java.Sql
{
    ...
    public partial class Ref : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Ref>
    {
        ...
        public Ref(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IRef
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/sql/Ref.html"/>
    /// </summary>
