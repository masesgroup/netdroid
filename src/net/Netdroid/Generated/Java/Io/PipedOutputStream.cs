...
namespace Java.Io
{
    #region PipedOutputStream declaration
    /// <summary>
    ...
    public partial class PipedOutputStream : Java.Io.OutputStream
    {
        ...
        public PipedOutputStream(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region PipedOutputStream implementation
    public partial class PipedOutputStream
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/io/PipedOutputStream.html#%3Cinit%3E()"/>
        /// </summary>
        public PipedOutputStream() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
