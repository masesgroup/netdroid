...
namespace Java.Io
{
    #region StringWriter declaration
    /// <summary>
    ...
    public partial class StringWriter : Java.Io.Writer
    {
        ...
        public StringWriter(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region StringWriter implementation
    public partial class StringWriter
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/io/StringWriter.html#%3Cinit%3E()"/>
        /// </summary>
        public StringWriter() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
