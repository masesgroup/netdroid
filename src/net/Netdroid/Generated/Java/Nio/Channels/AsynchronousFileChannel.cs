...
namespace Java.Nio.Channels
{
    ...
    public partial class AsynchronousFileChannel : Java.Nio.Channels.AsynchronousChannel
    {
        ...
        public AsynchronousFileChannel(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class AsynchronousFileChannel
    {
        ...
        {
            return SExecuteWithSignature<Java.Nio.Channels.AsynchronousFileChannel>(LocalBridgeClazz, "open", "(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/nio/channels/AsynchronousFileChannel;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg1, arg0));
        }
        /// <summary>
        ...
        {
            return SExecuteWithSignature<Java.Nio.Channels.AsynchronousFileChannel>(LocalBridgeClazz, "open", "(Ljava/nio/file/Path;Ljava/util/Set;Ljava/util/concurrent/ExecutorService;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/AsynchronousFileChannel;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg3, arg0, arg1, arg2));
        }
