...
{
    #region UserPrincipal declaration
    /// <summary>
    ...
    public partial class UserPrincipal : Java.Security.Principal
    {
        ...
        public UserPrincipal(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/nio/file/attribute/UserPrincipal.html"/>
    /// </summary>
    ...
    #region UserPrincipal implementation
    public partial class UserPrincipal : Java.Nio.File.Attribute.IUserPrincipal
    {
        #region Constructors
