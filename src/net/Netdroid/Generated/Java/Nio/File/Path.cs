...
namespace Java.Nio.File
{
    ...
    #region IPath
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/nio/file/Path.html"/>
    /// </summary>
    ...
    public partial class Path : Java.Nio.File.IPath, Java.Lang.IComparable<Java.Nio.File.Path>, Java.Lang.IIterable<Java.Nio.File.Path>, Java.Nio.File.IWatchable
    {
        ...
        {
            return SExecuteWithSignature<Java.Nio.File.Path>(LocalBridgeClazz, "of", "(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg1, arg0));
        }
        /// <summary>
        ...
        {
            return IExecuteWithSignature<Java.Nio.File.Path>("toRealPath", "([Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;", arg0);
        }
        /// <summary>
