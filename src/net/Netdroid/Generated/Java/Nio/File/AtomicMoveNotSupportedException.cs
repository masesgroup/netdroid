...
{
    #region AtomicMoveNotSupportedException declaration
    /// <summary>
    ...
    #region AtomicMoveNotSupportedException implementation
    public partial class AtomicMoveNotSupportedException
    {
        #region Constructors
