...
namespace Java.Time.Format
{
    ...
    public partial class DateTimeFormatterBuilder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DateTimeFormatterBuilder>
    {
        ...
        public DateTimeFormatterBuilder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DateTimeFormatterBuilder
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/time/format/DateTimeFormatterBuilder.html#%3Cinit%3E()"/>
        /// </summary>
        public DateTimeFormatterBuilder() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
