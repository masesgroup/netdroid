...
namespace Java.Text
{
    #region ParsePosition declaration
    /// <summary>
    ...
    public partial class ParsePosition : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ParsePosition>
    {
        ...
        public ParsePosition(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region ParsePosition implementation
    public partial class ParsePosition
    {
        ...
        public ParsePosition(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static ParsePosition CreatePoolableInstance(int arg0)
        {
