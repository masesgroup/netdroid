...
namespace Java.Util
{
    ...
    public partial class HashSet
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashSet.html#%3Cinit%3E()"/>
        /// </summary>
        public HashSet() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public HashSet(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
