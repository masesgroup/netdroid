...
{
    #region MemoryHandler declaration
    /// <summary>
    ...
    public partial class MemoryHandler : Java.Util.Logging.Handler
    {
        ...
        public MemoryHandler(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region MemoryHandler implementation
    public partial class MemoryHandler
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/logging/MemoryHandler.html#%3Cinit%3E()"/>
        /// </summary>
        public MemoryHandler() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
