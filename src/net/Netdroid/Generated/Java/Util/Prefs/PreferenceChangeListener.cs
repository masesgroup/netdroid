...
namespace Java.Util.Prefs
{
    ...
    public partial class PreferenceChangeListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public PreferenceChangeListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasPreferenceChangeListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasPreferenceChangeListenerSecondGate;
        ...
        /// <item><see cref="_hasPreferenceChangeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasPreferenceChangeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="PreferenceChangeListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="PreferenceChangeListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class PreferenceChangeListener : Java.Util.Prefs.IPreferenceChangeListener
    {
        ...
        {
            _PreferenceChangeEventHandlerIndex = AddEventHandler("preferenceChange", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(PreferenceChangeEventHandler));
            _hasOverridePreferenceChange = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(PreferenceChange), typeof(Java.Util.Prefs.PreferenceChangeEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _PreferenceChangeEventHandlerIndex) return PreferenceChangeEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="PreferenceChange"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _PreferenceChangeEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="PreferenceChange"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverridePreferenceChange;
        ...
        void PreferenceChangeEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!PreferenceChangeEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = PreferenceChangeEventOverridden();
        }
