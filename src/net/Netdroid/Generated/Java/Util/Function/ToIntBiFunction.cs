...
namespace Java.Util.Function
{
    ...
    public partial class ToIntBiFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ToIntBiFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public ToIntBiFunction(params object[] args) : base(args)
        {
            ...
            _hasToIntBiFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasToIntBiFunctionSecondGate;
        ...
        /// <item><see cref="_hasToIntBiFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasToIntBiFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ToIntBiFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ToIntBiFunction"/> instead.</para>
    /// </remarks>
    public partial class ToIntBiFunctionDirect : ToIntBiFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public ToIntBiFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ToIntBiFunctionDirect(params object[] args) : base(args) { }
    ...
    public partial class ToIntBiFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsInt = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsInt), typeof(object), typeof(object));
    ...
    /// <summary>
    /// .NET interface for org.mases.netdroid.generated.java.util.function.ToIntBiFunction implementing <see href="https://developer.android.com/reference/java/util/function/ToIntBiFunction.html"/>
    /// </summary>
    ...
    public partial class ToIntBiFunction<T, U> : Java.Util.Function.IToIntBiFunction<T, U>
    {
        ...
        {
            _ApplyAsIntEventHandlerIndex = AddEventHandler("applyAsInt", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ApplyAsIntEventHandler));
            _hasOverrideApplyAsInt = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsInt), typeof(T), typeof(U));
