...
namespace Java.Util.Function
{
    ...
    public partial class DoubleToIntFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleToIntFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public DoubleToIntFunction(params object[] args) : base(args)
        {
            ...
            _hasDoubleToIntFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasDoubleToIntFunctionSecondGate;
        ...
        /// <item><see cref="_hasDoubleToIntFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDoubleToIntFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DoubleToIntFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DoubleToIntFunction"/> instead.</para>
    /// </remarks>
    public partial class DoubleToIntFunctionDirect : DoubleToIntFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public DoubleToIntFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public DoubleToIntFunctionDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.netdroid.generated.java.util.function.DoubleToIntFunction implementing <see href="https://developer.android.com/reference/java/util/function/DoubleToIntFunction.html"/>
    /// </summary>
    ...
    public partial class DoubleToIntFunction : Java.Util.Function.IDoubleToIntFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsInt = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsInt), typeof(double));
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/java/util/function/DoubleToIntFunction.html#applyAsInt(double)"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/function/DoubleToIntFunction.html#applyAsInt(double)"/>
        /// </summary>
