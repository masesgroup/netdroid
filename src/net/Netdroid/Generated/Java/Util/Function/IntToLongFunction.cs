...
namespace Java.Util.Function
{
    ...
    public partial class IntToLongFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public IntToLongFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public IntToLongFunction(params object[] args) : base(args)
        {
            ...
            _hasIntToLongFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasIntToLongFunctionSecondGate;
        ...
        /// <item><see cref="_hasIntToLongFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIntToLongFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IntToLongFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IntToLongFunction"/> instead.</para>
    /// </remarks>
    public partial class IntToLongFunctionDirect : IntToLongFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public IntToLongFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public IntToLongFunctionDirect(params object[] args) : base(args) { }
    ...
    public partial class IntToLongFunction : Java.Util.Function.IIntToLongFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsLong = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(int));
