...
namespace Java.Util.Function
{
    ...
    public partial class LongSupplier : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// <item><see cref="_hasLongSupplierSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasLongSupplierSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="LongSupplier"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="LongSupplier"/> instead.</para>
    /// </remarks>
    ...
    public partial class LongSupplier : Java.Util.Function.ILongSupplier
    {
        ...
        {
            _GetAsLongEventHandlerIndex = AddEventHandler("getAsLong", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(GetAsLongEventHandler));
        ...
        {
            if (eventIndex == _GetAsLongEventHandlerIndex) return GetAsLongEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="GetAsLong"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _GetAsLongEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="GetAsLong"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void GetAsLongEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!GetAsLongEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.SetReturnData(GetAsLongEventOverridden(), executionResult);
