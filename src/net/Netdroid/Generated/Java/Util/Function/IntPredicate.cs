...
namespace Java.Util.Function
{
    ...
    public partial class IntPredicate : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public IntPredicate(params object[] args) : base(args)
        {
            ...
            _hasIntPredicateSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasIntPredicateSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIntPredicateSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IntPredicate"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IntPredicate"/> instead.</para>
    /// </remarks>
    ...
    public partial class IntPredicate : Java.Util.Function.IIntPredicate
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideTest = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Test), typeof(int));
            ...
            _hasOverrideAnd = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(And), typeof(Java.Util.Function.IntPredicate));
            ...
            _hasOverrideOr = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Or), typeof(Java.Util.Function.IntPredicate));
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.IntPredicate> OnAndDispose { get; set; } = null;
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.IntPredicate> OnNegateDispose { get; set; } = null;
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.IntPredicate> OnOrDispose { get; set; } = null;
