...
namespace Java.Util.Function
{
    ...
    public partial class DoubleSupplier : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleSupplier(params object[] args) : base(args)
        {
            ...
            _hasDoubleSupplierSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasDoubleSupplierSecondGate;
        ...
        /// <item><see cref="_hasDoubleSupplierSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDoubleSupplierSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DoubleSupplier"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DoubleSupplier"/> instead.</para>
    /// </remarks>
    ...
    public partial class DoubleSupplier : Java.Util.Function.IDoubleSupplier
    {
        ...
        {
            _GetAsDoubleEventHandlerIndex = AddEventHandler("getAsDouble", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(GetAsDoubleEventHandler));
            _hasOverrideGetAsDouble = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(GetAsDouble));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _GetAsDoubleEventHandlerIndex) return GetAsDoubleEventOverridden();
        ...
        /// </summary>
        /// <remarks>Set <see cref="OnGetAsDoubleDispose"/> when the event handler returns a JVM-backed object
        ...
        public global::System.Action<double> OnGetAsDoubleDispose { get; set; } = null;
        
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="GetAsDouble"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _GetAsDoubleEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="GetAsDouble"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideGetAsDouble;
        ...
        void GetAsDoubleEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!GetAsDoubleEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.SetReturnData(GetAsDoubleEventOverridden(), executionResult);
            OnGetAsDoubleDispose?.Invoke(executionResult);
        }
