...
namespace Java.Util.Function
{
    ...
    public partial class IntConsumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// <item><see cref="_hasIntConsumerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIntConsumerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IntConsumer"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IntConsumer"/> instead.</para>
    /// </remarks>
    ...
    public partial class IntConsumer : Java.Util.Function.IIntConsumer
    {
        ...
        public global::System.Action<Java.Util.Function.IntConsumer> OnAndThenDispose { get; set; } = null;
