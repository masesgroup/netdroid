...
namespace Java.Util.Function
{
    ...
    public partial class Consumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public Consumer(params object[] args) : base(args)
        {
            ...
            _hasConsumerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasConsumerSecondGate;
        ...
        /// <item><see cref="_hasConsumerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasConsumerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="Consumer"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="Consumer"/> instead.</para>
    /// </remarks>
    ...
    public partial class Consumer
    {
        ...
        {
            _AcceptEventHandlerIndex = AddEventHandler("accept", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AcceptEventHandler));
            _hasOverrideAccept = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Accept), typeof(object));
            ...
            _hasOverrideAndThen = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(AndThen), typeof(Java.Util.Function.Consumer));
        ...
        void AcceptEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = AcceptEventOverridden();
        }
        ...
        public global::System.Action<Java.Util.Function.Consumer> OnAndThenDispose { get; set; } = null;
    ...
    public partial class Consumer<T> : Java.Util.Function.IConsumer<T>
    {
        ...
        {
            _AcceptEventHandlerIndex = AddEventHandler("accept", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AcceptEventHandler));
            _hasOverrideAccept = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Accept), typeof(T));
            _AndThen<Arg0objectSuperT>EventHandlerIndex = AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AndThen<Arg0objectSuperT>EventHandler));
            _hasOverrideAndThen<Arg0objectSuperT> = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(AndThen<Arg0objectSuperT>), typeof(Java.Util.Function.Consumer<Arg0objectSuperT>));
        ...
        {
            if (eventIndex == _AcceptEventHandlerIndex) return AcceptEventOverridden();
            if (eventIndex == _AndThen<Arg0objectSuperT>EventHandlerIndex) return AndThen<Arg0objectSuperT>EventOverridden();
        ...
        /// Optional handler invoked after the event handler returns, to dispose the JVM object returned by this event.
        /// </summary>
        /// <remarks>Set <see cref="OnAndThen<Arg0objectSuperT>Dispose"/> when the event handler returns a JVM-backed object
        /// that is no longer needed after the call. The handler receives the return value and is responsible for calling
        /// <see cref="global::System.IDisposable.Dispose"/> on it, releasing the underlying JVM global reference immediately
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.Consumer<T>> OnAndThen<Arg0objectSuperT>Dispose { get; set; } = null;
        
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="AndThen<Arg0objectSuperT>"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _AndThen<Arg0objectSuperT>EventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="AndThen<Arg0objectSuperT>"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideAndThen<Arg0objectSuperT>;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool AndThen<Arg0objectSuperT>EventOverridden() => _hasOverrideAndThen<Arg0objectSuperT> || OnAndThen<Arg0objectSuperT> != null;
        
        void AndThen<Arg0objectSuperT>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!AndThen<Arg0objectSuperT>EventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            data.EventData.SetReturnData(AndThen<Arg0objectSuperT>EventOverridden(), executionResult);
            OnAndThen<Arg0objectSuperT>Dispose?.Invoke(executionResult);
        }
