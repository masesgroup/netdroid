...
namespace Java.Util.Function
{
    ...
    public partial class ToLongFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ToLongFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public ToLongFunction(params object[] args) : base(args)
        {
            ...
            _hasToLongFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasToLongFunctionSecondGate;
        ...
        /// <item><see cref="_hasToLongFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasToLongFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ToLongFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ToLongFunction"/> instead.</para>
    /// </remarks>
    public partial class ToLongFunctionDirect : ToLongFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public ToLongFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ToLongFunctionDirect(params object[] args) : base(args) { }
    ...
    public partial class ToLongFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsLong = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(object));
    ...
    public partial class ToLongFunction<T> : Java.Util.Function.IToLongFunction<T>
    {
        ...
        {
            _ApplyAsLongEventHandlerIndex = AddEventHandler("applyAsLong", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ApplyAsLongEventHandler));
            _hasOverrideApplyAsLong = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(T));
