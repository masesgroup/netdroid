...
namespace Java.Util.Function
{
    ...
    public partial class LongToDoubleFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public LongToDoubleFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public LongToDoubleFunction(params object[] args) : base(args)
        {
            ...
            _hasLongToDoubleFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasLongToDoubleFunctionSecondGate;
        ...
        /// <item><see cref="_hasLongToDoubleFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasLongToDoubleFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="LongToDoubleFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="LongToDoubleFunction"/> instead.</para>
    /// </remarks>
    public partial class LongToDoubleFunctionDirect : LongToDoubleFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public LongToDoubleFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public LongToDoubleFunctionDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.netdroid.generated.java.util.function.LongToDoubleFunction implementing <see href="https://developer.android.com/reference/java/util/function/LongToDoubleFunction.html"/>
    /// </summary>
    ...
    public partial class LongToDoubleFunction : Java.Util.Function.ILongToDoubleFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsDouble = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsDouble), typeof(long));
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/java/util/function/LongToDoubleFunction.html#applyAsDouble(long)"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/function/LongToDoubleFunction.html#applyAsDouble(long)"/>
        /// </summary>
