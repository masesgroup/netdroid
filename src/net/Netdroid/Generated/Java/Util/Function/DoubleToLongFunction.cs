...
namespace Java.Util.Function
{
    ...
    public partial class DoubleToLongFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleToLongFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public DoubleToLongFunction(params object[] args) : base(args)
        {
            ...
            _hasDoubleToLongFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasDoubleToLongFunctionSecondGate;
        ...
        /// <item><see cref="_hasDoubleToLongFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDoubleToLongFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DoubleToLongFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DoubleToLongFunction"/> instead.</para>
    /// </remarks>
    public partial class DoubleToLongFunctionDirect : DoubleToLongFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public DoubleToLongFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public DoubleToLongFunctionDirect(params object[] args) : base(args) { }
    ...
    public partial class DoubleToLongFunction : Java.Util.Function.IDoubleToLongFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsLong = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(double));
