...
namespace Java.Util.Function
{
    ...
    public partial class Predicate : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasPredicateSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    public partial class Predicate<T> : Java.Util.Function.IPredicate<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _And<Arg0objectSuperT>EventHandlerIndex = AddEventHandler("and", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(And<Arg0objectSuperT>EventHandler));
            ...
            _NegateEventHandlerIndex = AddEventHandler("negate", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(NegateEventHandler));
            _hasOverrideNegate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Negate));
            _Or<Arg0objectSuperT>EventHandlerIndex = AddEventHandler("or", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(Or<Arg0objectSuperT>EventHandler));
        ...
        {
            if (eventIndex == _TestEventHandlerIndex) return TestEventOverridden();
            if (eventIndex == _And<Arg0objectSuperT>EventHandlerIndex) return And<Arg0objectSuperT>EventOverridden();
            if (eventIndex == _NegateEventHandlerIndex) return NegateEventOverridden();
            if (eventIndex == _Or<Arg0objectSuperT>EventHandlerIndex) return Or<Arg0objectSuperT>EventOverridden();
        ...
        int _And<Arg0objectSuperT>EventHandlerIndex = 0;
        ...
        void And<Arg0objectSuperT>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.SetReturnData(And<Arg0objectSuperT>EventOverridden(), executionResult);
        ...
        int _Or<Arg0objectSuperT>EventHandlerIndex = 0;
        ...
        void Or<Arg0objectSuperT>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            var executionResult = methodToExecute.Invoke(data.EventData.GetAt<Java.Util.Function.Predicate<Arg0objectSuperT>>(0));
            data.EventData.SetReturnData(Or<Arg0objectSuperT>EventOverridden(), executionResult);
