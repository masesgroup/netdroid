...
namespace Java.Util.Function
{
    ...
    public partial class DoubleConsumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleConsumer(params object[] args) : base(args)
        {
            ...
            _hasDoubleConsumerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasDoubleConsumerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDoubleConsumerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DoubleConsumer"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DoubleConsumer"/> instead.</para>
    /// </remarks>
    ...
    public partial class DoubleConsumer : Java.Util.Function.IDoubleConsumer
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideAccept = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Accept), typeof(double));
            ...
            _hasOverrideAndThen = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(AndThen), typeof(Java.Util.Function.DoubleConsumer));
        ...
        public global::System.Action<Java.Util.Function.DoubleConsumer> OnAndThenDispose { get; set; } = null;
