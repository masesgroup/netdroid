...
namespace Java.Util.Function
{
    ...
    public partial class IntToDoubleFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public IntToDoubleFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public IntToDoubleFunction(params object[] args) : base(args)
        {
            ...
            _hasIntToDoubleFunctionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasIntToDoubleFunctionSecondGate;
        ...
        /// <item><see cref="_hasIntToDoubleFunctionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIntToDoubleFunctionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IntToDoubleFunction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IntToDoubleFunction"/> instead.</para>
    /// </remarks>
    public partial class IntToDoubleFunctionDirect : IntToDoubleFunction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public IntToDoubleFunctionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public IntToDoubleFunctionDirect(params object[] args) : base(args) { }
    ...
    public partial class IntToDoubleFunction : Java.Util.Function.IIntToDoubleFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsDouble = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsDouble), typeof(int));
