...
namespace Java.Util.RandomNs
{
    ...
    public partial class RandomGeneratorFactory : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RandomGeneratorFactory>
    {
        ...
        public RandomGeneratorFactory(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class RandomGeneratorFactory<T> : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RandomGeneratorFactory<T>> where T : Java.Util.RandomNs.IRandomGenerator
    {
        const string _bridgeClassName = "java.util.random.RandomGeneratorFactory";
        /// <summary>
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
