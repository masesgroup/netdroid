...
namespace Java.Util
{
    ...
    public partial class IdentityHashMap : Java.Util.AbstractMap
    {
        ...
        public IdentityHashMap(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class IdentityHashMap
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/IdentityHashMap.html#%3Cinit%3E()"/>
        /// </summary>
        public IdentityHashMap() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static IdentityHashMap CreatePoolableInstance()
        {
        ...
        public IdentityHashMap(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static IdentityHashMap CreatePoolableInstance(int arg0)
        {
        ...
        /// </summary>
        public static IdentityHashMap CreatePoolableInstance(Java.Util.Map arg0)
        {
            return JVMBridgeBase.New<IdentityHashMap>(arg0);
        }
    ...
    public partial class IdentityHashMap<K, V> : Java.Util.IMap<K, V>, Java.Io.ISerializable, Java.Lang.ICloneable
    {
        ...
        /// HPA initializer for IdentityHashMap()
        /// </summary>
        public static IdentityHashMap<K, V> CreatePoolableInstance()
        {
        ...
        /// HPA initializer for IdentityHashMap(int arg0)
        /// </summary>
        public static IdentityHashMap<K, V> CreatePoolableInstance(int arg0)
        {
        ...
        /// </summary>
        public static IdentityHashMap<K, V> CreatePoolableInstance(Java.Util.Map<K, V> arg0)
        {
            return JVMBridgeBase.New<IdentityHashMap<K, V>>(arg0);
        }
