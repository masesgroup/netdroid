...
namespace Java.Util
{
    ...
    public partial class HashMap : Java.Util.AbstractMap
    {
        ...
        public HashMap(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region HashMap<K, V> declaration
    /// <summary>
    /// <see href="https://developer.android.com/reference/java/util/HashMap.html"/>
    /// </summary>
    ...
    public partial class HashMap
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashMap.html#%3Cinit%3E()"/>
        /// </summary>
        public HashMap() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static HashMap CreatePoolableInstance()
        {
            return JVMBridgeBase.New<HashMap>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashMap.html#%3Cinit%3E(int,float)"/>
        /// </summary>
        ...
        /// </summary>
        public static HashMap CreatePoolableInstance(int arg0, float arg1)
        {
            return JVMBridgeBase.New<HashMap>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashMap.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public HashMap(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static HashMap CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<HashMap>(arg0);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashMap.html#%3Cinit%3E(java.util.Map)"/>
        /// </summary>
        ...
        /// </summary>
        public static HashMap CreatePoolableInstance(Java.Util.Map arg0)
        {
            return JVMBridgeBase.New<HashMap>(arg0);
        }
    ...
    #region HashMap<K, V> implementation
    public partial class HashMap<K, V> : Java.Util.IMap<K, V>, Java.Lang.ICloneable, Java.Io.ISerializable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/HashMap.html#%3Cinit%3E()"/>
        ...
        /// </summary>
        public static HashMap<K, V> CreatePoolableInstance(Java.Util.Map<K, V> arg0)
        {
            return JVMBridgeBase.New<HashMap<K, V>>(arg0);
        }
