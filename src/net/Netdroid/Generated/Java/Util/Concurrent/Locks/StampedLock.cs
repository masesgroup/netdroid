...
namespace Java.Util.Concurrent.Locks
{
    ...
    public partial class StampedLock
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/concurrent/locks/StampedLock.html#%3Cinit%3E()"/>
        /// </summary>
        public StampedLock() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
