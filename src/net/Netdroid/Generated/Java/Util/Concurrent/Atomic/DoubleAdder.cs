...
{
    #region DoubleAdder declaration
    /// <summary>
    ...
    public partial class DoubleAdder : Java.Io.Serializable
    {
        ...
        public DoubleAdder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region DoubleAdder implementation
    public partial class DoubleAdder
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/concurrent/atomic/DoubleAdder.html#%3Cinit%3E()"/>
        /// </summary>
        public DoubleAdder() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
