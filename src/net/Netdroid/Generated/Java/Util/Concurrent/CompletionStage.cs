...
namespace Java.Util.Concurrent
{
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/util/concurrent/CompletionStage.html"/>
    /// </summary>
    ...
    public partial class CompletionStage<T> : Java.Util.Concurrent.ICompletionStage<T>
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Concurrent.CompletionStage<T>>("exceptionallyAsync", "(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletionStage;", arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/concurrent/CompletionStage.html#exceptionallyAsync(java.util.function.Function)"/>
        /// </summary>
        ...
        {
            return IExecuteWithSignature<Java.Util.Concurrent.CompletionStage<T>>("exceptionallyComposeAsync", "(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletionStage;", arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/concurrent/CompletionStage.html#exceptionallyComposeAsync(java.util.function.Function)"/>
        /// </summary>
