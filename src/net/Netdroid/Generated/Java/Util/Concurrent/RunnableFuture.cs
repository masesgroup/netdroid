...
namespace Java.Util.Concurrent
{
    ...
    public partial class RunnableFuture : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RunnableFuture>
    {
        ...
        public RunnableFuture(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/util/concurrent/RunnableFuture.html"/>
    /// </summary>
    ...
    public partial class RunnableFuture<V> : Java.Util.Concurrent.IRunnableFuture<V>, Java.Lang.IRunnable, Java.Util.Concurrent.IFuture<V>
    {
        #region Constructors
