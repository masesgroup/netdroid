...
namespace Java.Util
{
    ...
    public partial class SplittableRandom : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SplittableRandom>
    {
        ...
        public SplittableRandom(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SplittableRandom : Java.Util.RandomNs.IRandomGenerator
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/SplittableRandom.html#%3Cinit%3E()"/>
        /// </summary>
        public SplittableRandom() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
