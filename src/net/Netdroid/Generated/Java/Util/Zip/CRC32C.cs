...
namespace Java.Util.Zip
{
    ...
    public partial class CRC32C
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/util/zip/CRC32C.html#%3Cinit%3E()"/>
        /// </summary>
        public CRC32C() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for CRC32C()
        /// </summary>
        public static CRC32C CreatePoolableInstance()
        {
            return JVMBridgeBase.New<CRC32C>();
        }
