...
{
    #region PermissionCollection declaration
    /// <summary>
    ...
    public partial class PermissionCollection : Java.Io.Serializable
    {
        ...
        public PermissionCollection(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region PermissionCollection implementation
    public partial class PermissionCollection
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/PermissionCollection.html#%3Cinit%3E()"/>
        /// </summary>
        public PermissionCollection() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static PermissionCollection CreatePoolableInstance()
        {
