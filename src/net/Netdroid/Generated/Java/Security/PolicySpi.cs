...
namespace Java.Security
{
    ...
    public partial class PolicySpi : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PolicySpi>
    {
        ...
        public PolicySpi(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region PolicySpi implementation
    public partial class PolicySpi
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/PolicySpi.html#%3Cinit%3E()"/>
        /// </summary>
        public PolicySpi() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
