...
namespace Java.Security
{
    ...
    public partial class KeyFactory : MASES.JCOBridge.C2JBridge.JVMBridgeBase<KeyFactory>
    {
        ...
        public KeyFactory(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class KeyFactory
    {
        ...
        public T GetKeySpec<T>(Java.Security.Key arg0, Java.Lang.Class arg1) where T : Java.Security.Spec.IKeySpec
        {
            return IExecuteWithSignature<T>("getKeySpec", "(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;", arg0, arg1);
        }
        /// <summary>
