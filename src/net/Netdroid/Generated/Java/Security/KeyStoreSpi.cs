...
namespace Java.Security
{
    ...
    public partial class KeyStoreSpi : MASES.JCOBridge.C2JBridge.JVMBridgeBase<KeyStoreSpi>
    {
        ...
        public KeyStoreSpi(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class KeyStoreSpi
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/KeyStoreSpi.html#%3Cinit%3E()"/>
        /// </summary>
        public KeyStoreSpi() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static KeyStoreSpi CreatePoolableInstance()
        {
