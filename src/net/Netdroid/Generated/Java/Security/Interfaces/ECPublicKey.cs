...
namespace Java.Security.Interfaces
{
    ...
    public partial class ECPublicKey : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ECPublicKey>
    {
        ...
        public ECPublicKey(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IECPublicKey
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/security/interfaces/ECPublicKey.html"/>
    /// </summary>
    ...
    public partial class ECPublicKey : Java.Security.Interfaces.IECPublicKey, Java.Security.IPublicKey, Java.Security.Interfaces.IECKey
    {
        #region Constructors
