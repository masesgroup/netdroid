...
{
    #region CertPathChecker declaration
    /// <summary>
    ...
    public partial class CertPathChecker : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CertPathChecker>
    {
        ...
        public CertPathChecker(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/java/security/cert/CertPathChecker.html"/>
    /// </summary>
    ...
    #region CertPathChecker implementation
