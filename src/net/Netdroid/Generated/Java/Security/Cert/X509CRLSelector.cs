...
namespace Java.Security.Cert
{
    ...
    public partial class X509CRLSelector : Java.Security.Cert.CRLSelector
    {
        ...
        public X509CRLSelector(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class X509CRLSelector
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/cert/X509CRLSelector.html#%3Cinit%3E()"/>
        /// </summary>
        public X509CRLSelector() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for X509CRLSelector()
        /// </summary>
        public static X509CRLSelector CreatePoolableInstance()
        {
            return JVMBridgeBase.New<X509CRLSelector>();
        }
