...
namespace Java.Security.Cert
{
    ...
    public partial class X509CertSelector : Java.Security.Cert.CertSelector
    {
        ...
        public X509CertSelector(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class X509CertSelector
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/cert/X509CertSelector.html#%3Cinit%3E()"/>
        /// </summary>
        public X509CertSelector() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
