...
namespace Java.Security.Cert
{
    ...
    public partial class CertPathValidatorSpi
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/cert/CertPathValidatorSpi.html#%3Cinit%3E()"/>
        /// </summary>
        public CertPathValidatorSpi() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for CertPathValidatorSpi()
        /// </summary>
        public static CertPathValidatorSpi CreatePoolableInstance()
        {
            return JVMBridgeBase.New<CertPathValidatorSpi>();
        }
        ...
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/cert/CertPathValidatorSpi.html#engineValidate(java.security.cert.CertPath,java.security.cert.CertPathParameters)"/>
        /// </summary>
        ...
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/security/cert/CertPathValidatorSpi.html#engineGetRevocationChecker()"/>
        /// </summary>
