...
{
    #region EncodedKeySpec declaration
    /// <summary>
    ...
    public partial class EncodedKeySpec : Java.Security.Spec.KeySpec
    {
        ...
        public EncodedKeySpec(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region EncodedKeySpec implementation
    public partial class EncodedKeySpec
    {
        ...
        public EncodedKeySpec(byte[] arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for EncodedKeySpec(byte[] arg0)
        /// </summary>
        public static EncodedKeySpec CreatePoolableInstance(byte[] arg0)
        {
            return JVMBridgeBase.New<EncodedKeySpec>(arg0);
        }
