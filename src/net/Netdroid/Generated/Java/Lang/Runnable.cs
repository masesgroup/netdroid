...
namespace Java.Lang
{
    ...
    public partial class Runnable : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// <item><see cref="_hasRunnableSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasRunnableSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    
        const string _bridgeClassName = "org.mases.netdroid.generated.java.lang.Runnable";
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="Runnable"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="Runnable"/> instead.</para>
    /// </remarks>
    ...
    #region IRunnable
    /// <summary>
    /// .NET interface for org.mases.netdroid.generated.java.lang.Runnable implementing <see href="https://developer.android.com/reference/java/lang/Runnable.html"/>
    /// </summary>
    ...
    public partial class Runnable : Java.Lang.IRunnable
    {
        ...
        {
            _RunEventHandlerIndex = AddEventHandler("run", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(RunEventHandler));
        ...
        {
            if (eventIndex == _RunEventHandlerIndex) return RunEventOverridden();

            return false; // no one can manage event, continues to caller
        }
        
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/java/lang/Runnable.html#run()"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="Run"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _RunEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="Run"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void RunEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!RunEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = RunEventOverridden();
        }
