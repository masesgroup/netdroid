...
namespace Java.Net
{
    #region SecureCacheResponse declaration
    /// <summary>
    ...
    public partial class SecureCacheResponse : Java.Net.CacheResponse
    {
        ...
        public SecureCacheResponse(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region SecureCacheResponse implementation
    public partial class SecureCacheResponse
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/SecureCacheResponse.html#%3Cinit%3E()"/>
        /// </summary>
        public SecureCacheResponse() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
