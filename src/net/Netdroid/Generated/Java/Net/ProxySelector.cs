...
namespace Java.Net
{
    #region ProxySelector declaration
    /// <summary>
    ...
    public partial class ProxySelector : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ProxySelector>
    {
        ...
        public ProxySelector(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region ProxySelector implementation
    public partial class ProxySelector
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/ProxySelector.html#%3Cinit%3E()"/>
        /// </summary>
        public ProxySelector() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static ProxySelector CreatePoolableInstance()
        {
