...
namespace Java.Net
{
    ...
    public partial class CacheRequest : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CacheRequest>
    {
        ...
        public CacheRequest(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class CacheRequest
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/CacheRequest.html#%3Cinit%3E()"/>
        /// </summary>
        public CacheRequest() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
