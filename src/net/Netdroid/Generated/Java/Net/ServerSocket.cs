...
namespace Java.Net
{
    ...
    public partial class ServerSocket
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/ServerSocket.html#%3Cinit%3E()"/>
        /// </summary>

        /// <exception cref="Java.Io.IOException"/>
        public ServerSocket() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// <param name="arg1"><see cref="int"/></param>
        /// <exception cref="Java.Io.IOException"/>
        public ServerSocket(int arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
        {
