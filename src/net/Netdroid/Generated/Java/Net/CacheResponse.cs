...
namespace Java.Net
{
    #region CacheResponse declaration
    /// <summary>
    ...
    public partial class CacheResponse : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CacheResponse>
    {
        ...
        public CacheResponse(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region CacheResponse implementation
    public partial class CacheResponse
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/CacheResponse.html#%3Cinit%3E()"/>
        /// </summary>
        public CacheResponse() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for CacheResponse()
        /// </summary>
        public static CacheResponse CreatePoolableInstance()
        {
            return JVMBridgeBase.New<CacheResponse>();
        }
