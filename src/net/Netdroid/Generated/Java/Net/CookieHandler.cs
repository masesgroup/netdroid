...
namespace Java.Net
{
    ...
    public partial class CookieHandler : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CookieHandler>
    {
        ...
        public CookieHandler(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class CookieHandler
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/java/net/CookieHandler.html#%3Cinit%3E()"/>
        /// </summary>
        public CookieHandler() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static CookieHandler CreatePoolableInstance()
        {
