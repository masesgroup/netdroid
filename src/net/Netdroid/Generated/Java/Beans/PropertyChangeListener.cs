...
namespace Java.Beans
{
    ...
    public partial class PropertyChangeListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasPropertyChangeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasPropertyChangeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="PropertyChangeListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="PropertyChangeListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class PropertyChangeListener : Java.Beans.IPropertyChangeListener
    {
        ...
        {
            _PropertyChangeEventHandlerIndex = AddEventHandler("propertyChange", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(PropertyChangeEventHandler));
        ...
        {
            if (eventIndex == _PropertyChangeEventHandlerIndex) return PropertyChangeEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="PropertyChange"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _PropertyChangeEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="PropertyChange"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void PropertyChangeEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!PropertyChangeEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = PropertyChangeEventOverridden();
        }
