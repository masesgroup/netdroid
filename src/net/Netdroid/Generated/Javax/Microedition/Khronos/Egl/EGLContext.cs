...
namespace Javax.Microedition.Khronos.Egl
{
    ...
    public partial class EGLContext : MASES.JCOBridge.C2JBridge.JVMBridgeBase<EGLContext>
    {
        ...
        public EGLContext(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class EGLContext
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/javax/microedition/khronos/egl/EGLContext.html#%3Cinit%3E()"/>
        /// </summary>
        public EGLContext() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for EGLContext()
        /// </summary>
        public static EGLContext CreatePoolableInstance()
        {
            return JVMBridgeBase.New<EGLContext>();
        }
