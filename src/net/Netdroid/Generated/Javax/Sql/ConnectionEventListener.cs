...
namespace Javax.Sql
{
    ...
    public partial class ConnectionEventListener : Java.Util.EventListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasConnectionEventListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    public partial class ConnectionEventListener : Javax.Sql.IConnectionEventListener
    {
        ...
        {
            _ConnectionClosedEventHandlerIndex = AddEventHandler("connectionClosed", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ConnectionClosedEventHandler));
            ...
            _ConnectionErrorOccurredEventHandlerIndex = AddEventHandler("connectionErrorOccurred", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ConnectionErrorOccurredEventHandler));
        ...
        void ConnectionClosedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = ConnectionClosedEventOverridden();
        }
        ...
        void ConnectionErrorOccurredEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.ConnectionEvent>(0));
            data.EventData.HasOverride = ConnectionErrorOccurredEventOverridden();
        }
