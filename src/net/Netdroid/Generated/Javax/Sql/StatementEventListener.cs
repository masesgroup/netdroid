...
namespace Javax.Sql
{
    ...
    public partial class StatementEventListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public StatementEventListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasStatementEventListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasStatementEventListenerSecondGate;
        ...
        /// <item><see cref="_hasStatementEventListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasStatementEventListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="StatementEventListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="StatementEventListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class StatementEventListener : Javax.Sql.IStatementEventListener
    {
        ...
        {
            _StatementClosedEventHandlerIndex = AddEventHandler("statementClosed", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(StatementClosedEventHandler));
            _hasOverrideStatementClosed = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(StatementClosed), typeof(Javax.Sql.StatementEvent));
            _StatementErrorOccurredEventHandlerIndex = AddEventHandler("statementErrorOccurred", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(StatementErrorOccurredEventHandler));
            _hasOverrideStatementErrorOccurred = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(StatementErrorOccurred), typeof(Javax.Sql.StatementEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _StatementClosedEventHandlerIndex) return StatementClosedEventOverridden();
            if (eventIndex == _StatementErrorOccurredEventHandlerIndex) return StatementErrorOccurredEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="StatementClosed"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _StatementClosedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="StatementClosed"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideStatementClosed;
        ...
        void StatementClosedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!StatementClosedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = StatementClosedEventOverridden();
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="StatementErrorOccurred"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _StatementErrorOccurredEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="StatementErrorOccurred"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideStatementErrorOccurred;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool StatementErrorOccurredEventOverridden() => _hasOverrideStatementErrorOccurred || OnStatementErrorOccurred != null;
        
        void StatementErrorOccurredEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!StatementErrorOccurredEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.StatementEvent>(0));
            data.EventData.HasOverride = StatementErrorOccurredEventOverridden();
        }
