...
namespace Javax.Sql
{
    ...
    public partial class RowSetListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasRowSetListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasRowSetListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="RowSetListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="RowSetListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class RowSetListener : Javax.Sql.IRowSetListener
    {
        ...
        {
            _CursorMovedEventHandlerIndex = AddEventHandler("cursorMoved", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(CursorMovedEventHandler));
            ...
            _RowChangedEventHandlerIndex = AddEventHandler("rowChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(RowChangedEventHandler));
            ...
            _RowSetChangedEventHandlerIndex = AddEventHandler("rowSetChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(RowSetChangedEventHandler));
        ...
        {
            if (eventIndex == _CursorMovedEventHandlerIndex) return CursorMovedEventOverridden();
            if (eventIndex == _RowChangedEventHandlerIndex) return RowChangedEventOverridden();
            if (eventIndex == _RowSetChangedEventHandlerIndex) return RowSetChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="CursorMoved"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _CursorMovedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="CursorMoved"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void CursorMovedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!CursorMovedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = CursorMovedEventOverridden();
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="RowChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _RowChangedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="RowChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void RowChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!RowChangedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.RowSetEvent>(0));
            data.EventData.HasOverride = RowChangedEventOverridden();
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="RowSetChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _RowSetChangedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="RowSetChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void RowSetChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!RowSetChangedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.RowSetEvent>(0));
            data.EventData.HasOverride = RowSetChangedEventOverridden();
        }
