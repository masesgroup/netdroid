...
namespace Javax.Sql
{
    ...
    public partial class PooledConnection : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PooledConnection>
    {
        ...
        public PooledConnection(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/javax/sql/PooledConnection.html"/>
    /// </summary>
