...
namespace Javax.Xml.Transform
{
    ...
    /// <summary>
    /// <see href="https://developer.android.com/reference/javax/xml/transform/ErrorListener.html"/>
    /// </summary>
    public partial class ErrorListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasErrorListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    public partial class ErrorListener : Javax.Xml.Transform.IErrorListener
    {
        ...
        {
            _ErrorEventHandlerIndex = AddEventHandler("error", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ErrorEventHandler));
            ...
            _FatalErrorEventHandlerIndex = AddEventHandler("fatalError", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(FatalErrorEventHandler));
            ...
            _WarningEventHandlerIndex = AddEventHandler("warning", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(WarningEventHandler));
        ...
        void ErrorEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = ErrorEventOverridden();
        }
        ...
        void FatalErrorEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            methodToExecute.Invoke(JVMBridgeException.New(data.EventData.ExtraData.Get(0) as MASES.JCOBridge.C2JBridge.JVMInterop.IJavaObject));
            data.EventData.HasOverride = FatalErrorEventOverridden();
        }
        ...
        void WarningEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            methodToExecute.Invoke(JVMBridgeException.New(data.EventData.ExtraData.Get(0) as MASES.JCOBridge.C2JBridge.JVMInterop.IJavaObject));
            data.EventData.HasOverride = WarningEventOverridden();
        }
