...
namespace Android.Service.Textservice
{
    ...
    public partial class SpellCheckerService : Android.App.Service
    {
        ...
        public SpellCheckerService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SpellCheckerService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/service/textservice/SpellCheckerService.html#%3Cinit%3E()"/>
        /// </summary>
        public SpellCheckerService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SpellCheckerService()
        /// </summary>
        public static SpellCheckerService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SpellCheckerService>();
        }
        ...
        public partial class Session
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/service/textservice/SpellCheckerService.Session.html#%3Cinit%3E()"/>
            /// </summary>
            public Session() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for Session()
            /// </summary>
            public static Session CreatePoolableInstance()
            {
                return JVMBridgeBase.New<Session>();
            }
