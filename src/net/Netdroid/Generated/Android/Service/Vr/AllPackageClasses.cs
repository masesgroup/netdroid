...
namespace Android.Service.Vr
{
    ...
    public partial class VrListenerService : Android.App.Service
    {
        ...
        /// </summary>
        [Obsolete("VrListenerService class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
