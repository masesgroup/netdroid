...
namespace Android.Service.Voice
{
    ...
    public partial class VoiceInteractionSession : MASES.JCOBridge.C2JBridge.JVMBridgeBase<VoiceInteractionSession>
    {
        ...
        public partial class VisibleActivityCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<VisibleActivityCallback>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("VisibleActivityCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
    ...
    public partial class VoiceInteractionSessionService : Android.App.Service
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("VoiceInteractionSessionService class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
