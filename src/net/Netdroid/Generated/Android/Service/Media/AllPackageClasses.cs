...
namespace Android.Service.Media
{
    ...
    public partial class CameraPrewarmService : Android.App.Service
    {
        ...
        /// </summary>
        [Obsolete("CameraPrewarmService class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
    ...
    public partial class MediaBrowserService : Android.App.Service
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("MediaBrowserService class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
