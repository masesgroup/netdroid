...
namespace Android.Service.Dreams
{
    ...
    public partial class DreamService : Android.App.Service
    {
        ...
        public DreamService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DreamService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/service/dreams/DreamService.html#%3Cinit%3E()"/>
        /// </summary>
        public DreamService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DreamService()
        /// </summary>
        public static DreamService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DreamService>();
        }
        ...
        /// </summary>
        public static Java.Lang.String DREAM_META_DATA { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "DREAM_META_DATA"); } set { SSetField(LocalBridgeClazz, "DREAM_META_DATA", value); } }
        /// <summary>
