...
namespace Android.Content
{
    ...
    public partial class UriRelativeFilterGroup : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UriRelativeFilterGroup>
    {
        ...
        public UriRelativeFilterGroup(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class UriRelativeFilterGroup
    {
        ...
        public UriRelativeFilterGroup(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for UriRelativeFilterGroup(int arg0)
        /// </summary>
        public static UriRelativeFilterGroup CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<UriRelativeFilterGroup>(arg0);
        }
        ...
        /// </summary>
        public static int ACTION_ALLOW { get { return SGetField<int>(LocalBridgeClazz, "ACTION_ALLOW"); } set { SSetField(LocalBridgeClazz, "ACTION_ALLOW", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/UriRelativeFilterGroup.html#ACTION_BLOCK"/>
        /// </summary>
        public static int ACTION_BLOCK { get { return SGetField<int>(LocalBridgeClazz, "ACTION_BLOCK"); } set { SSetField(LocalBridgeClazz, "ACTION_BLOCK", value); } }
