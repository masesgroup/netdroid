...
namespace Android.Content
{
    ...
    public partial class AttributionSource : Android.Os.Parcelable
    {
        ...
        public AttributionSource(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AttributionSource
    {
        ...
        public partial class Builder
        {
            ...
            public Builder(Android.Content.AttributionSource arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Builder(Android.Content.AttributionSource arg0)
            /// </summary>
            public static Builder CreatePoolableInstance(Android.Content.AttributionSource arg0)
            {
