...
namespace Android.Content.Pm
{
    ...
    public partial class InstrumentationInfo : Android.Content.Pm.PackageItemInfo
    {
        ...
        public InstrumentationInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class InstrumentationInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/InstrumentationInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public InstrumentationInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for InstrumentationInfo()
        /// </summary>
        public static InstrumentationInfo CreatePoolableInstance()
        {
            return JVMBridgeBase.New<InstrumentationInfo>();
        }
        /// <summary>
        ...
        public InstrumentationInfo(Android.Content.Pm.InstrumentationInfo arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for InstrumentationInfo(Android.Content.Pm.InstrumentationInfo arg0)
        /// </summary>
        public static InstrumentationInfo CreatePoolableInstance(Android.Content.Pm.InstrumentationInfo arg0)
        {
            return JVMBridgeBase.New<InstrumentationInfo>(arg0);
        }
