...
namespace Android.Content.Pm
{
    ...
    public partial class PackageItemInfo : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PackageItemInfo>
    {
        ...
        public PackageItemInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class PackageItemInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/PackageItemInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public PackageItemInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PackageItemInfo()
        /// </summary>
        public static PackageItemInfo CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PackageItemInfo>();
        }
        /// <summary>
        ...
        public PackageItemInfo(Android.Content.Pm.PackageItemInfo arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for PackageItemInfo(Android.Content.Pm.PackageItemInfo arg0)
        /// </summary>
        public static PackageItemInfo CreatePoolableInstance(Android.Content.Pm.PackageItemInfo arg0)
        {
            return JVMBridgeBase.New<PackageItemInfo>(arg0);
        }
        ...
        {
            return IExecuteWithSignature<Android.Content.Res.XmlResourceParser>("loadXmlMetaData", "(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;", arg0, arg1);
        }
        /// <summary>
