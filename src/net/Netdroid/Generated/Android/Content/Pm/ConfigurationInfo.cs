...
{
    #region ConfigurationInfo declaration
    /// <summary>
    ...
    public partial class ConfigurationInfo : Android.Os.Parcelable
    {
        ...
        public ConfigurationInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region ConfigurationInfo implementation
    public partial class ConfigurationInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/ConfigurationInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public ConfigurationInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ConfigurationInfo()
        /// </summary>
        public static ConfigurationInfo CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ConfigurationInfo>();
        }
        /// <summary>
        ...
        public ConfigurationInfo(Android.Content.Pm.ConfigurationInfo arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ConfigurationInfo(Android.Content.Pm.ConfigurationInfo arg0)
        /// </summary>
        public static ConfigurationInfo CreatePoolableInstance(Android.Content.Pm.ConfigurationInfo arg0)
        {
            return JVMBridgeBase.New<ConfigurationInfo>(arg0);
        }
        ...
        /// </summary>
        public static int GL_ES_VERSION_UNDEFINED { get { return SGetField<int>(LocalBridgeClazz, "GL_ES_VERSION_UNDEFINED"); } set { SSetField(LocalBridgeClazz, "GL_ES_VERSION_UNDEFINED", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/ConfigurationInfo.html#INPUT_FEATURE_FIVE_WAY_NAV"/>
        /// </summary>
        public static int INPUT_FEATURE_FIVE_WAY_NAV { get { return SGetField<int>(LocalBridgeClazz, "INPUT_FEATURE_FIVE_WAY_NAV"); } set { SSetField(LocalBridgeClazz, "INPUT_FEATURE_FIVE_WAY_NAV", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/ConfigurationInfo.html#INPUT_FEATURE_HARD_KEYBOARD"/>
        /// </summary>
        public static int INPUT_FEATURE_HARD_KEYBOARD { get { return SGetField<int>(LocalBridgeClazz, "INPUT_FEATURE_HARD_KEYBOARD"); } set { SSetField(LocalBridgeClazz, "INPUT_FEATURE_HARD_KEYBOARD", value); } }
