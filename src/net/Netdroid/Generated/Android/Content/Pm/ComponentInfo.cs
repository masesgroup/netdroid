...
namespace Android.Content.Pm
{
    ...
    public partial class ComponentInfo : Android.Content.Pm.PackageItemInfo
    {
        ...
        public ComponentInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ComponentInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/ComponentInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public ComponentInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<ComponentInfo>();
        }
        /// <summary>
        ...
        public ComponentInfo(Android.Content.Pm.ComponentInfo arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static ComponentInfo CreatePoolableInstance(Android.Content.Pm.ComponentInfo arg0)
        {
            return JVMBridgeBase.New<ComponentInfo>(arg0);
        }
