...
namespace Android.Content.Pm
{
    ...
    public partial class ProviderInfo : Android.Content.Pm.ComponentInfo
    {
        ...
        public ProviderInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ProviderInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/content/pm/ProviderInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public ProviderInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ProviderInfo()
        /// </summary>
        public static ProviderInfo CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ProviderInfo>();
        }
        /// <summary>
        ...
        public ProviderInfo(Android.Content.Pm.ProviderInfo arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ProviderInfo(Android.Content.Pm.ProviderInfo arg0)
        /// </summary>
        public static ProviderInfo CreatePoolableInstance(Android.Content.Pm.ProviderInfo arg0)
        {
            return JVMBridgeBase.New<ProviderInfo>(arg0);
        }
