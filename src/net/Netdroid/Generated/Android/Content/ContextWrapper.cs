...
namespace Android.Content
{
    ...
    public partial class ContextWrapper : Android.Content.Context
    {
        ...
        public ContextWrapper(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ContextWrapper
    {
        ...
        public ContextWrapper(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ContextWrapper(Android.Content.Context arg0)
        /// </summary>
        public static ContextWrapper CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<ContextWrapper>(arg0);
        }
