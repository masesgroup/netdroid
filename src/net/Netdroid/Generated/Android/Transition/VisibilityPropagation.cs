...
namespace Android.Transition
{
    ...
    public partial class VisibilityPropagation
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/transition/VisibilityPropagation.html#%3Cinit%3E()"/>
        /// </summary>
        public VisibilityPropagation() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for VisibilityPropagation()
        /// </summary>
        public static VisibilityPropagation CreatePoolableInstance()
        {
            return JVMBridgeBase.New<VisibilityPropagation>();
        }
