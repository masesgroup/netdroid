...
namespace Android.Transition
{
    ...
    public partial class TransitionManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<TransitionManager>
    {
        ...
        public TransitionManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class TransitionManager
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/transition/TransitionManager.html#%3Cinit%3E()"/>
        /// </summary>
        public TransitionManager() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for TransitionManager()
        /// </summary>
        public static TransitionManager CreatePoolableInstance()
        {
            return JVMBridgeBase.New<TransitionManager>();
        }
