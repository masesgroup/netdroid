...
namespace Android.Transition
{
    ...
    public partial class PatternPathMotion : Android.Transition.PathMotion
    {
        ...
        public PatternPathMotion(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class PatternPathMotion
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/transition/PatternPathMotion.html#%3Cinit%3E()"/>
        /// </summary>
        public PatternPathMotion() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PatternPathMotion()
        /// </summary>
        public static PatternPathMotion CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PatternPathMotion>();
        }
        /// <summary>
        ...
        public PatternPathMotion(Android.Content.Context arg0, Android.Util.AttributeSet arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for PatternPathMotion(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        /// </summary>
        public static PatternPathMotion CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        {
            return JVMBridgeBase.New<PatternPathMotion>(arg0, arg1);
        }
        /// <summary>
        ...
        public PatternPathMotion(Android.Graphics.Path arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for PatternPathMotion(Android.Graphics.Path arg0)
        /// </summary>
        public static PatternPathMotion CreatePoolableInstance(Android.Graphics.Path arg0)
        {
            return JVMBridgeBase.New<PatternPathMotion>(arg0);
        }
