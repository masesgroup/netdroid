...
namespace Android.Webkit
{
    ...
    public partial class ServiceWorkerWebSettings
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/webkit/ServiceWorkerWebSettings.html#%3Cinit%3E()"/>
        /// </summary>
        public ServiceWorkerWebSettings() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ServiceWorkerWebSettings()
        /// </summary>
        public static ServiceWorkerWebSettings CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ServiceWorkerWebSettings>();
        }
