...
namespace Android.Webkit
{
    ...
    public partial class WebBackForwardList : Java.Lang.ICloneable, Java.Io.ISerializable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/webkit/WebBackForwardList.html#%3Cinit%3E()"/>
        /// </summary>
        public WebBackForwardList() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<WebBackForwardList>();
        }
