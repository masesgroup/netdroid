...
namespace Android.Webkit
{
    ...
    public partial class DownloadListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DownloadListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public DownloadListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasDownloadListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasDownloadListenerSecondGate;
        ...
        /// <item><see cref="_hasDownloadListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDownloadListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DownloadListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DownloadListener"/> instead.</para>
    /// </remarks>
    public partial class DownloadListenerDirect : DownloadListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public DownloadListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public DownloadListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class DownloadListener : Android.Webkit.IDownloadListener
    {
        ...
        {
            _OnDownloadStartEventHandlerIndex = AddEventHandler("onDownloadStart", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnDownloadStartEventHandler));
            _hasOverrideOnDownloadStart = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnDownloadStart), typeof(Java.Lang.String), typeof(Java.Lang.String), typeof(Java.Lang.String), typeof(Java.Lang.String), typeof(long));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _OnDownloadStartEventHandlerIndex) return OnDownloadStartEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnDownloadStart"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnDownloadStartEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnDownloadStart"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnDownloadStart;
        ...
        bool OnDownloadStartEventOverridden() => _hasOverrideOnDownloadStart || OnOnDownloadStart != null;
        
        void OnDownloadStartEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnDownloadStartEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = OnDownloadStartEventOverridden();
        }
