...
namespace Android.Webkit
{
    ...
    public partial class ClientCertRequest : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ClientCertRequest>
    {
        ...
        public ClientCertRequest(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ClientCertRequest
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/webkit/ClientCertRequest.html#%3Cinit%3E()"/>
        /// </summary>
        public ClientCertRequest() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ClientCertRequest()
        /// </summary>
        public static ClientCertRequest CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ClientCertRequest>();
        }
