...
namespace Android.Webkit
{
    ...
    public partial class URLUtil : MASES.JCOBridge.C2JBridge.JVMBridgeBase<URLUtil>
    {
        ...
        public URLUtil(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class URLUtil
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/webkit/URLUtil.html#%3Cinit%3E()"/>
        /// </summary>
        public URLUtil() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<URLUtil>();
        }
