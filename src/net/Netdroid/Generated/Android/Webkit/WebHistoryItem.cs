...
namespace Android.Webkit
{
    ...
    public partial class WebHistoryItem
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/webkit/WebHistoryItem.html#%3Cinit%3E()"/>
        /// </summary>
        public WebHistoryItem() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for WebHistoryItem()
        /// </summary>
        public static WebHistoryItem CreatePoolableInstance()
        {
            return JVMBridgeBase.New<WebHistoryItem>();
        }
