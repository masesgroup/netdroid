...
namespace Android.Widget
{
    ...
    public partial class ViewFlipper : Android.Widget.ViewAnimator
    {
        ...
        public ViewFlipper(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ViewFlipper
    {
        ...
        public ViewFlipper(Android.Content.Context arg0, Android.Util.AttributeSet arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for ViewFlipper(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        /// </summary>
        public static ViewFlipper CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        {
            return JVMBridgeBase.New<ViewFlipper>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/widget/ViewFlipper.html#%3Cinit%3E(android.content.Context)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        public ViewFlipper(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ViewFlipper(Android.Content.Context arg0)
        /// </summary>
        public static ViewFlipper CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<ViewFlipper>(arg0);
        }
