...
namespace Android.Widget
{
    ...
    public partial class Filter : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Filter>
    {
        ...
        public partial class FilterListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public FilterListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public FilterListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasFilterListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasFilterListenerSecondGate;
            ...
            /// <item><see cref="_hasFilterListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasFilterListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="FilterListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="FilterListener"/> instead.</para>
        /// </remarks>
        public partial class FilterListenerDirect : FilterListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public FilterListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public FilterListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class Filter
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/widget/Filter.html#%3Cinit%3E()"/>
        /// </summary>
        public Filter() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static Filter CreatePoolableInstance()
        {
        ...
        {
            IExecuteWithSignature("filter", "(Ljava/lang/CharSequence;Landroid/widget/Filter$FilterListener;)V", arg0, arg1);
        }
        /// <summary>
        ...
        public partial class FilterListener
        {
            ...
            {
                _OnFilterCompleteEventHandlerIndex = AddEventHandler("onFilterComplete", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnFilterCompleteEventHandler));
                _hasOverrideOnFilterComplete = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnFilterComplete), typeof(int));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnFilterCompleteEventHandlerIndex) return OnFilterCompleteEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnFilterComplete"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnFilterCompleteEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnFilterComplete"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnFilterComplete;
            ...
            bool OnFilterCompleteEventOverridden() => _hasOverrideOnFilterComplete || OnOnFilterComplete != null;
            
            void OnFilterCompleteEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnFilterCompleteEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.HasOverride = OnFilterCompleteEventOverridden();
            }
