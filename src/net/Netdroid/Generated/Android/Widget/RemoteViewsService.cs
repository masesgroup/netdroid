...
namespace Android.Widget
{
    ...
    public partial class RemoteViewsService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/widget/RemoteViewsService.html#%3Cinit%3E()"/>
        /// </summary>
        public RemoteViewsService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for RemoteViewsService()
        /// </summary>
        public static RemoteViewsService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<RemoteViewsService>();
        }
