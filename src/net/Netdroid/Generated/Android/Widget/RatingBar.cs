...
namespace Android.Widget
{
    ...
    public partial class RatingBar : Android.Widget.AbsSeekBar
    {
        ...
        public RatingBar(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class OnRatingBarChangeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public OnRatingBarChangeListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnRatingBarChangeListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasOnRatingBarChangeListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasOnRatingBarChangeListenerSecondGate;
            ...
            /// <item><see cref="_hasOnRatingBarChangeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasOnRatingBarChangeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="OnRatingBarChangeListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="OnRatingBarChangeListener"/> instead.</para>
        /// </remarks>
        public partial class OnRatingBarChangeListenerDirect : OnRatingBarChangeListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnRatingBarChangeListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnRatingBarChangeListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class RatingBar
    {
        ...
        public RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2, int arg3) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1, arg2, arg3);
        }
        /// <summary>
        /// HPA initializer for RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2, int arg3)
        /// </summary>
        public static RatingBar CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2, int arg3)
        {
            return JVMBridgeBase.New<RatingBar>(arg0, arg1, arg2, arg3);
        }
        /// <summary>
        ...
        /// <param name="arg1"><see cref="Android.Util.AttributeSet"/></param>
        /// <param name="arg2"><see cref="int"/></param>
        public RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1, arg2);
        }
        /// <summary>
        /// HPA initializer for RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2)
        /// </summary>
        public static RatingBar CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2)
        {
            return JVMBridgeBase.New<RatingBar>(arg0, arg1, arg2);
        }
        /// <summary>
        ...
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        /// <param name="arg1"><see cref="Android.Util.AttributeSet"/></param>
        public RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for RatingBar(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        /// </summary>
        public static RatingBar CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        {
            return JVMBridgeBase.New<RatingBar>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/widget/RatingBar.html#%3Cinit%3E(android.content.Context)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        public RatingBar(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for RatingBar(Android.Content.Context arg0)
        /// </summary>
        public static RatingBar CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<RatingBar>(arg0);
        }
        ...
        public partial class OnRatingBarChangeListener
        {
            ...
            {
                _OnRatingChangedEventHandlerIndex = AddEventHandler("onRatingChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnRatingChangedEventHandler));
                _hasOverrideOnRatingChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnRatingChanged), typeof(Android.Widget.RatingBar), typeof(float), typeof(bool));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnRatingChangedEventHandlerIndex) return OnRatingChangedEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnRatingChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnRatingChangedEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnRatingChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnRatingChanged;
            ...
            bool OnRatingChangedEventOverridden() => _hasOverrideOnRatingChanged || OnOnRatingChanged != null;
            
            void OnRatingChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnRatingChangedEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.HasOverride = OnRatingChangedEventOverridden();
            }
