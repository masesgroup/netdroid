...
namespace Android.Companion.Virtual
{
    ...
    public partial class VirtualDeviceManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<VirtualDeviceManager>
    {
        ...
        public VirtualDeviceManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class VirtualDeviceListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public VirtualDeviceListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public VirtualDeviceListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasVirtualDeviceListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasVirtualDeviceListenerSecondGate;
            ...
            /// <item><see cref="_hasVirtualDeviceListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasVirtualDeviceListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="VirtualDeviceListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="VirtualDeviceListener"/> instead.</para>
        /// </remarks>
        public partial class VirtualDeviceListenerDirect : VirtualDeviceListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public VirtualDeviceListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public VirtualDeviceListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class VirtualDeviceManager
    {
        ...
        {
            IExecuteWithSignature("registerVirtualDeviceListener", "(Ljava/util/concurrent/Executor;Landroid/companion/virtual/VirtualDeviceManager$VirtualDeviceListener;)V", arg0, arg1);
        }
        /// <summary>
        ...
        public partial class VirtualDeviceListener
        {
            ...
            {
                _OnVirtualDeviceClosedEventHandlerIndex = AddEventHandler("onVirtualDeviceClosed", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnVirtualDeviceClosedEventHandler));
                _hasOverrideOnVirtualDeviceClosed = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnVirtualDeviceClosed), typeof(int));
                _OnVirtualDeviceCreatedEventHandlerIndex = AddEventHandler("onVirtualDeviceCreated", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnVirtualDeviceCreatedEventHandler));
                _hasOverrideOnVirtualDeviceCreated = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnVirtualDeviceCreated), typeof(int));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnVirtualDeviceClosedEventHandlerIndex) return OnVirtualDeviceClosedEventOverridden();
                if (eventIndex == _OnVirtualDeviceCreatedEventHandlerIndex) return OnVirtualDeviceCreatedEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnVirtualDeviceClosed"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnVirtualDeviceClosedEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnVirtualDeviceClosed"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnVirtualDeviceClosed;
            ...
            bool OnVirtualDeviceClosedEventOverridden() => _hasOverrideOnVirtualDeviceClosed || OnOnVirtualDeviceClosed != null;
            
            void OnVirtualDeviceClosedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnVirtualDeviceClosedEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.HasOverride = OnVirtualDeviceClosedEventOverridden();
            }
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnVirtualDeviceCreated"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnVirtualDeviceCreatedEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnVirtualDeviceCreated"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnVirtualDeviceCreated;
            
            /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
            [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            bool OnVirtualDeviceCreatedEventOverridden() => _hasOverrideOnVirtualDeviceCreated || OnOnVirtualDeviceCreated != null;
            
            void OnVirtualDeviceCreatedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnVirtualDeviceCreatedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                      // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                      // but protects against user overrides of ListenerShallManageEvent that bypass the check.
                {
                    // data.EventData.HasOverride is false by default — JVM receives no return value.
                ...
                methodToExecute.Invoke(data.EventData.GetAt<int>(0));
                data.EventData.HasOverride = OnVirtualDeviceCreatedEventOverridden();
            }
