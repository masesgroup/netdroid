...
namespace Android.Provider
{
    ...
    public partial class DocumentsProvider : Android.Content.ContentProvider
    {
        ...
        public DocumentsProvider(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DocumentsProvider
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/provider/DocumentsProvider.html#%3Cinit%3E()"/>
        /// </summary>
        public DocumentsProvider() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<DocumentsProvider>();
        }
