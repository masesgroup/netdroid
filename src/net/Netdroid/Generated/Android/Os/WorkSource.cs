...
namespace Android.Os
{
    ...
    public partial class WorkSource : Android.Os.Parcelable
    {
        ...
        public WorkSource(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region WorkSource implementation
    public partial class WorkSource
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/os/WorkSource.html#%3Cinit%3E()"/>
        /// </summary>
        public WorkSource() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for WorkSource()
        /// </summary>
        public static WorkSource CreatePoolableInstance()
        {
            return JVMBridgeBase.New<WorkSource>();
        }
        /// <summary>
        ...
        public WorkSource(Android.Os.WorkSource arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for WorkSource(Android.Os.WorkSource arg0)
        /// </summary>
        public static WorkSource CreatePoolableInstance(Android.Os.WorkSource arg0)
        {
            return JVMBridgeBase.New<WorkSource>(arg0);
        }
