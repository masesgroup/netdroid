...
namespace Android.Os
{
    ...
    public partial class ProxyFileDescriptorCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ProxyFileDescriptorCallback>
    {
        ...
        public ProxyFileDescriptorCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ProxyFileDescriptorCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/os/ProxyFileDescriptorCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public ProxyFileDescriptorCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ProxyFileDescriptorCallback()
        /// </summary>
        public static ProxyFileDescriptorCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ProxyFileDescriptorCallback>();
        }
