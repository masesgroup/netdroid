...
namespace Android.Os
{
    ...
    public partial class Message
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/os/Message.html#%3Cinit%3E()"/>
        /// </summary>
        public Message() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Message()
        /// </summary>
        public static Message CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Message>();
        }
