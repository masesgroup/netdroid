...
namespace Android.Os
{
    ...
    public partial class AsyncTask
    {
        ...
        {
            if (arg1.Length == 0) return IExecuteWithSignature<Android.Os.AsyncTask>("executeOnExecutor", "(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;", arg0); else return IExecuteWithSignature<Android.Os.AsyncTask>("executeOnExecutor", "(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;", arg0, arg1);
        }
        /// <summary>
    ...
    public partial class AsyncTask<Params, Progress, Result>
    {
        ...
        {
            if (arg1.Length == 0) return IExecuteWithSignature<Android.Os.AsyncTask<Params, Progress, Result>>("executeOnExecutor", "(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;", arg0); else return IExecuteWithSignature<Android.Os.AsyncTask<Params, Progress, Result>>("executeOnExecutor", "(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;", arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/os/AsyncTask.html#getStatus()"/>
        /// </summary>
