...
namespace Android.Os
{
    ...
    public partial class WorkDuration
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/os/WorkDuration.html#%3Cinit%3E()"/>
        /// </summary>
        public WorkDuration() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for WorkDuration()
        /// </summary>
        public static WorkDuration CreatePoolableInstance()
        {
            return JVMBridgeBase.New<WorkDuration>();
        }
