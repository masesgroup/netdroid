...
namespace Android.Os
{
    ...
    public partial class RemoteCallbackList : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RemoteCallbackList>
    {
        ...
        public partial class Builder<E> : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Builder<E>> where E : Android.Os.IIInterface
        {
            const string _bridgeClassName = "android.os.RemoteCallbackList$Builder";
            /// <summary>
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            ...
            /// </summary>
            /// <typeparam name="E"><see cref="Android.Os.IIInterface"/></typeparam>
            public partial class InterfaceDiedCallback<E> : MASES.JCOBridge.C2JBridge.JVMBridgeBase<InterfaceDiedCallback<E>> where E : Android.Os.IIInterface
            {
                const string _bridgeClassName = "android.os.RemoteCallbackList$Builder$InterfaceDiedCallback";
                /// <summary>
                /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
    ...
    /// </summary>
    /// <typeparam name="E"><see cref="Android.Os.IIInterface"/></typeparam>
    public partial class RemoteCallbackList<E> : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RemoteCallbackList<E>> where E : Android.Os.IIInterface
    {
        const string _bridgeClassName = "android.os.RemoteCallbackList";
        /// <summary>
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
