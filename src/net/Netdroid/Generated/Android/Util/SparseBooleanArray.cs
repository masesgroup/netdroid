...
namespace Android.Util
{
    ...
    public partial class SparseBooleanArray
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseBooleanArray.html#%3Cinit%3E()"/>
        /// </summary>
        public SparseBooleanArray() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SparseBooleanArray()
        /// </summary>
        public static SparseBooleanArray CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SparseBooleanArray>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseBooleanArray.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public SparseBooleanArray(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for SparseBooleanArray(int arg0)
        /// </summary>
        public static SparseBooleanArray CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<SparseBooleanArray>(arg0);
        }
