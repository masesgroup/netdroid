...
namespace Android.Util
{
    ...
    public partial class SparseIntArray : Java.Lang.Cloneable
    {
        ...
        public SparseIntArray(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SparseIntArray
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseIntArray.html#%3Cinit%3E()"/>
        /// </summary>
        public SparseIntArray() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SparseIntArray()
        /// </summary>
        public static SparseIntArray CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SparseIntArray>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseIntArray.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public SparseIntArray(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for SparseIntArray(int arg0)
        /// </summary>
        public static SparseIntArray CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<SparseIntArray>(arg0);
        }
