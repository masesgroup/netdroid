...
namespace Android.Util
{
    ...
    public partial class SparseLongArray : Java.Lang.Cloneable
    {
        ...
        public SparseLongArray(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SparseLongArray
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseLongArray.html#%3Cinit%3E()"/>
        /// </summary>
        public SparseLongArray() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SparseLongArray()
        /// </summary>
        public static SparseLongArray CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SparseLongArray>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseLongArray.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public SparseLongArray(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for SparseLongArray(int arg0)
        /// </summary>
        public static SparseLongArray CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<SparseLongArray>(arg0);
        }
