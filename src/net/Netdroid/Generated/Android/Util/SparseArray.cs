...
namespace Android.Util
{
    ...
    public partial class SparseArray : Java.Lang.Cloneable
    {
        ...
        public SparseArray(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SparseArray
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseArray.html#%3Cinit%3E()"/>
        /// </summary>
        public SparseArray() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SparseArray()
        /// </summary>
        public static SparseArray CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SparseArray>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseArray.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public SparseArray(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for SparseArray(int arg0)
        /// </summary>
        public static SparseArray CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<SparseArray>(arg0);
        }
    ...
    public partial class SparseArray<E>
    {
        ...
        /// HPA initializer for SparseArray()
        /// </summary>
        public static SparseArray<E> CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SparseArray<E>>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/SparseArray.html#%3Cinit%3E(int)"/>
        /// </summary>
        ...
        /// HPA initializer for SparseArray(int arg0)
        /// </summary>
        public static SparseArray<E> CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<SparseArray<E>>(arg0);
        }
