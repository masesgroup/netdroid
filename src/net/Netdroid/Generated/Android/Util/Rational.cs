...
namespace Android.Util
{
    ...
    public partial class Rational : Java.Lang.Number
    {
        ...
        public Rational(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Rational
    {
        ...
        public Rational(int arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for Rational(int arg0, int arg1)
        /// </summary>
        public static Rational CreatePoolableInstance(int arg0, int arg1)
        {
            return JVMBridgeBase.New<Rational>(arg0, arg1);
        }
        ...
        /// </summary>
        public static Android.Util.Rational NaN { get { return SGetField<Android.Util.Rational>(LocalBridgeClazz, "NaN"); } set { SSetField(LocalBridgeClazz, "NaN", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/Rational.html#NEGATIVE_INFINITY"/>
        /// </summary>
        public static Android.Util.Rational NEGATIVE_INFINITY { get { return SGetField<Android.Util.Rational>(LocalBridgeClazz, "NEGATIVE_INFINITY"); } set { SSetField(LocalBridgeClazz, "NEGATIVE_INFINITY", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/Rational.html#POSITIVE_INFINITY"/>
        /// </summary>
        public static Android.Util.Rational POSITIVE_INFINITY { get { return SGetField<Android.Util.Rational>(LocalBridgeClazz, "POSITIVE_INFINITY"); } set { SSetField(LocalBridgeClazz, "POSITIVE_INFINITY", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/util/Rational.html#ZERO"/>
        /// </summary>
        public static Android.Util.Rational ZERO { get { return SGetField<Android.Util.Rational>(LocalBridgeClazz, "ZERO"); } set { SSetField(LocalBridgeClazz, "ZERO", value); } }
