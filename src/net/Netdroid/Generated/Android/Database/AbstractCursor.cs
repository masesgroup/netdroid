...
namespace Android.Database
{
    ...
    public partial class AbstractCursor : Android.Database.CrossProcessCursor
    {
        ...
        public AbstractCursor(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AbstractCursor
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/database/AbstractCursor.html#%3Cinit%3E()"/>
        /// </summary>
        public AbstractCursor() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AbstractCursor()
        /// </summary>
        public static AbstractCursor CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AbstractCursor>();
        }
