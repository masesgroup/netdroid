...
namespace Android.Database.Sqlite
{
    ...
    public partial class SQLiteQueryBuilder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SQLiteQueryBuilder>
    {
        ...
        public SQLiteQueryBuilder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SQLiteQueryBuilder
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/database/sqlite/SQLiteQueryBuilder.html#%3Cinit%3E()"/>
        /// </summary>
        public SQLiteQueryBuilder() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SQLiteQueryBuilder()
        /// </summary>
        public static SQLiteQueryBuilder CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SQLiteQueryBuilder>();
        }
