...
namespace Android.Drm
{
    ...
    public partial class DrmUtils : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DrmUtils>
    {
        ...
        public DrmUtils(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class ExtendedMetadataParser : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ExtendedMetadataParser>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public ExtendedMetadataParser(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DrmUtils
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/drm/DrmUtils.html#%3Cinit%3E()"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public DrmUtils() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DrmUtils()
        /// </summary>
        public static DrmUtils CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DrmUtils>();
        }
