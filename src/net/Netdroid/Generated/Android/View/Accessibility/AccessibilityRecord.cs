...
namespace Android.View.Accessibility
{
    ...
    public partial class AccessibilityRecord : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AccessibilityRecord>
    {
        ...
        public AccessibilityRecord(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AccessibilityRecord
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/accessibility/AccessibilityRecord.html#%3Cinit%3E()"/>
        /// </summary>
        public AccessibilityRecord() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AccessibilityRecord()
        /// </summary>
        public static AccessibilityRecord CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AccessibilityRecord>();
        }
        /// <summary>
        ...
        public AccessibilityRecord(Android.View.Accessibility.AccessibilityRecord arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for AccessibilityRecord(Android.View.Accessibility.AccessibilityRecord arg0)
        /// </summary>
        public static AccessibilityRecord CreatePoolableInstance(Android.View.Accessibility.AccessibilityRecord arg0)
        {
            return JVMBridgeBase.New<AccessibilityRecord>(arg0);
        }
