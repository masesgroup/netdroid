...
namespace Android.View.Accessibility
{
    ...
    public partial class AccessibilityNodeProvider : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AccessibilityNodeProvider>
    {
        ...
        public AccessibilityNodeProvider(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AccessibilityNodeProvider
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/accessibility/AccessibilityNodeProvider.html#%3Cinit%3E()"/>
        /// </summary>
        public AccessibilityNodeProvider() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AccessibilityNodeProvider()
        /// </summary>
        public static AccessibilityNodeProvider CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AccessibilityNodeProvider>();
        }
        ...
        /// </summary>
        public static int HOST_VIEW_ID { get { return SGetField<int>(LocalBridgeClazz, "HOST_VIEW_ID"); } set { SSetField(LocalBridgeClazz, "HOST_VIEW_ID", value); } }
