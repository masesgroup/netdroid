...
namespace Android.View.Inputmethod
{
    ...
    public partial class ExtractedText : Android.Os.Parcelable
    {
        ...
        public ExtractedText(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ExtractedText
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/inputmethod/ExtractedText.html#%3Cinit%3E()"/>
        /// </summary>
        public ExtractedText() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ExtractedText()
        /// </summary>
        public static ExtractedText CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ExtractedText>();
        }
        ...
        /// </summary>
        public static int FLAG_SELECTING { get { return SGetField<int>(LocalBridgeClazz, "FLAG_SELECTING"); } set { SSetField(LocalBridgeClazz, "FLAG_SELECTING", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/inputmethod/ExtractedText.html#FLAG_SINGLE_LINE"/>
        /// </summary>
        public static int FLAG_SINGLE_LINE { get { return SGetField<int>(LocalBridgeClazz, "FLAG_SINGLE_LINE"); } set { SSetField(LocalBridgeClazz, "FLAG_SINGLE_LINE", value); } }
