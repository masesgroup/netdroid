...
namespace Android.View
{
    ...
    public partial class Window : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Window>
    {
        ...
        public Window(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class OnFrameMetricsAvailableListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public OnFrameMetricsAvailableListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnFrameMetricsAvailableListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasOnFrameMetricsAvailableListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasOnFrameMetricsAvailableListenerSecondGate;
            ...
            /// <item><see cref="_hasOnFrameMetricsAvailableListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasOnFrameMetricsAvailableListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="OnFrameMetricsAvailableListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="OnFrameMetricsAvailableListener"/> instead.</para>
        /// </remarks>
        public partial class OnFrameMetricsAvailableListenerDirect : OnFrameMetricsAvailableListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnFrameMetricsAvailableListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnFrameMetricsAvailableListenerDirect(params object[] args) : base(args) { }
        ...
        public partial class OnRestrictedCaptionAreaChangedListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnRestrictedCaptionAreaChangedListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnRestrictedCaptionAreaChangedListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasOnRestrictedCaptionAreaChangedListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
                InitializeHandlers(listenerRuntimeType);
            }
            ...
            /// returns <see langword="true"/> so that the second gate is reached regardless of whether individual event handlers are registered.
            /// </summary>
            readonly bool _hasOnRestrictedCaptionAreaChangedListenerSecondGate;
            ...
            /// <item><see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ListenerShallManageEventIndex"/> delegate — index-based, no string conversion, lowest overhead.</item>
            /// <item><see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ListenerShallManageEventName"/> delegate — name-based, resolves via <see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ConvertListenerEventIndexToEventName"/>.</item>
            /// <item><see cref="_hasOnRestrictedCaptionAreaChangedListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            /// <item><see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ListenerShallManageEventIndexWithData"/> delegate with data — index-based, no string conversion, lowest overhead.</item>
            /// <item><see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ListenerShallManageEventNameWithData"/> delegate with data — name-based, resolves via <see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.ConvertListenerEventIndexToEventName"/>.</item>
            /// </list>
            /// </remarks>
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                if (ListenerShallManageEventName != null) return ListenerShallManageEventName(ConvertListenerEventIndexToEventName(eventIndex));
                if (ListenerShallManageEventHandlers(eventIndex)) return true;
                return _hasOnRestrictedCaptionAreaChangedListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="OnRestrictedCaptionAreaChangedListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        /// When the JVM returns an instance of this listener type, JCOBridge needs a concrete CLR class to wrap it.
        /// A full listener implementation cannot be used in this scenario because it would require user-provided handler code
        ...
        /// returns <see langword="false"/> discarding all events immediately, and <see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener.AutoInit"/> is <see langword="false"/>
        /// to prevent automatic JVM-side registration.
        /// <para>Do not use this class directly to register event handlers — use <see cref="OnRestrictedCaptionAreaChangedListener"/> instead.</para>
        /// </remarks>
        public partial class OnRestrictedCaptionAreaChangedListenerDirect : OnRestrictedCaptionAreaChangedListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnRestrictedCaptionAreaChangedListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnRestrictedCaptionAreaChangedListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class Window
    {
        ...
        public Window(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for Window(Android.Content.Context arg0)
        /// </summary>
        public static Window CreatePoolableInstance(Android.Content.Context arg0)
        {
        ...
        /// </summary>
        public static int DECOR_CAPTION_SHADE_AUTO { get { return SGetField<int>(LocalBridgeClazz, "DECOR_CAPTION_SHADE_AUTO"); } set { SSetField(LocalBridgeClazz, "DECOR_CAPTION_SHADE_AUTO", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#DECOR_CAPTION_SHADE_DARK"/>
        /// </summary>
        public static int DECOR_CAPTION_SHADE_DARK { get { return SGetField<int>(LocalBridgeClazz, "DECOR_CAPTION_SHADE_DARK"); } set { SSetField(LocalBridgeClazz, "DECOR_CAPTION_SHADE_DARK", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#DECOR_CAPTION_SHADE_LIGHT"/>
        /// </summary>
        public static int DECOR_CAPTION_SHADE_LIGHT { get { return SGetField<int>(LocalBridgeClazz, "DECOR_CAPTION_SHADE_LIGHT"); } set { SSetField(LocalBridgeClazz, "DECOR_CAPTION_SHADE_LIGHT", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_ACTION_BAR"/>
        /// </summary>
        public static int FEATURE_ACTION_BAR { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_ACTION_BAR"); } set { SSetField(LocalBridgeClazz, "FEATURE_ACTION_BAR", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_ACTION_BAR_OVERLAY"/>
        /// </summary>
        public static int FEATURE_ACTION_BAR_OVERLAY { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_ACTION_BAR_OVERLAY"); } set { SSetField(LocalBridgeClazz, "FEATURE_ACTION_BAR_OVERLAY", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_ACTION_MODE_OVERLAY"/>
        /// </summary>
        public static int FEATURE_ACTION_MODE_OVERLAY { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_ACTION_MODE_OVERLAY"); } set { SSetField(LocalBridgeClazz, "FEATURE_ACTION_MODE_OVERLAY", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_ACTIVITY_TRANSITIONS"/>
        /// </summary>
        public static int FEATURE_ACTIVITY_TRANSITIONS { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_ACTIVITY_TRANSITIONS"); } set { SSetField(LocalBridgeClazz, "FEATURE_ACTIVITY_TRANSITIONS", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_CONTENT_TRANSITIONS"/>
        /// </summary>
        public static int FEATURE_CONTENT_TRANSITIONS { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_CONTENT_TRANSITIONS"); } set { SSetField(LocalBridgeClazz, "FEATURE_CONTENT_TRANSITIONS", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_CONTEXT_MENU"/>
        /// </summary>
        public static int FEATURE_CONTEXT_MENU { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_CONTEXT_MENU"); } set { SSetField(LocalBridgeClazz, "FEATURE_CONTEXT_MENU", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_CUSTOM_TITLE"/>
        /// </summary>
        public static int FEATURE_CUSTOM_TITLE { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_CUSTOM_TITLE"); } set { SSetField(LocalBridgeClazz, "FEATURE_CUSTOM_TITLE", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_INDETERMINATE_PROGRESS"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int FEATURE_INDETERMINATE_PROGRESS { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_INDETERMINATE_PROGRESS"); } set { SSetField(LocalBridgeClazz, "FEATURE_INDETERMINATE_PROGRESS", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_LEFT_ICON"/>
        /// </summary>
        public static int FEATURE_LEFT_ICON { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_LEFT_ICON"); } set { SSetField(LocalBridgeClazz, "FEATURE_LEFT_ICON", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_NO_TITLE"/>
        /// </summary>
        public static int FEATURE_NO_TITLE { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_NO_TITLE"); } set { SSetField(LocalBridgeClazz, "FEATURE_NO_TITLE", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_OPTIONS_PANEL"/>
        /// </summary>
        public static int FEATURE_OPTIONS_PANEL { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_OPTIONS_PANEL"); } set { SSetField(LocalBridgeClazz, "FEATURE_OPTIONS_PANEL", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_PROGRESS"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int FEATURE_PROGRESS { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_PROGRESS"); } set { SSetField(LocalBridgeClazz, "FEATURE_PROGRESS", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_RIGHT_ICON"/>
        /// </summary>
        public static int FEATURE_RIGHT_ICON { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_RIGHT_ICON"); } set { SSetField(LocalBridgeClazz, "FEATURE_RIGHT_ICON", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#FEATURE_SWIPE_TO_DISMISS"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int FEATURE_SWIPE_TO_DISMISS { get { return SGetField<int>(LocalBridgeClazz, "FEATURE_SWIPE_TO_DISMISS"); } set { SSetField(LocalBridgeClazz, "FEATURE_SWIPE_TO_DISMISS", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#ID_ANDROID_CONTENT"/>
        /// </summary>
        public static int ID_ANDROID_CONTENT { get { return SGetField<int>(LocalBridgeClazz, "ID_ANDROID_CONTENT"); } set { SSetField(LocalBridgeClazz, "ID_ANDROID_CONTENT", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_END"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_END { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_END"); } set { SSetField(LocalBridgeClazz, "PROGRESS_END", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_INDETERMINATE_OFF"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_INDETERMINATE_OFF { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_INDETERMINATE_OFF"); } set { SSetField(LocalBridgeClazz, "PROGRESS_INDETERMINATE_OFF", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_INDETERMINATE_ON"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_INDETERMINATE_ON { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_INDETERMINATE_ON"); } set { SSetField(LocalBridgeClazz, "PROGRESS_INDETERMINATE_ON", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_SECONDARY_END"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_SECONDARY_END { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_SECONDARY_END"); } set { SSetField(LocalBridgeClazz, "PROGRESS_SECONDARY_END", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_SECONDARY_START"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_SECONDARY_START { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_SECONDARY_START"); } set { SSetField(LocalBridgeClazz, "PROGRESS_SECONDARY_START", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_START"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_START { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_START"); } set { SSetField(LocalBridgeClazz, "PROGRESS_START", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_VISIBILITY_OFF"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_VISIBILITY_OFF { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_VISIBILITY_OFF"); } set { SSetField(LocalBridgeClazz, "PROGRESS_VISIBILITY_OFF", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#PROGRESS_VISIBILITY_ON"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public static int PROGRESS_VISIBILITY_ON { get { return SGetField<int>(LocalBridgeClazz, "PROGRESS_VISIBILITY_ON"); } set { SSetField(LocalBridgeClazz, "PROGRESS_VISIBILITY_ON", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME"/>
        /// </summary>
        public static Java.Lang.String NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME"); } set { SSetField(LocalBridgeClazz, "NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/Window.html#STATUS_BAR_BACKGROUND_TRANSITION_NAME"/>
        /// </summary>
        public static Java.Lang.String STATUS_BAR_BACKGROUND_TRANSITION_NAME { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "STATUS_BAR_BACKGROUND_TRANSITION_NAME"); } set { SSetField(LocalBridgeClazz, "STATUS_BAR_BACKGROUND_TRANSITION_NAME", value); } }
        ...
        public partial class OnFrameMetricsAvailableListener
        {
            ...
            {
                _OnFrameMetricsAvailableEventHandlerIndex = AddEventHandler("onFrameMetricsAvailable", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnFrameMetricsAvailableEventHandler));
                _hasOverrideOnFrameMetricsAvailable = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnFrameMetricsAvailable), typeof(Android.View.Window), typeof(Android.View.FrameMetrics), typeof(int));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnFrameMetricsAvailableEventHandlerIndex) return OnFrameMetricsAvailableEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnFrameMetricsAvailable"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnFrameMetricsAvailableEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnFrameMetricsAvailable"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnFrameMetricsAvailable;
            ...
            bool OnFrameMetricsAvailableEventOverridden() => _hasOverrideOnFrameMetricsAvailable || OnOnFrameMetricsAvailable != null;
            
            void OnFrameMetricsAvailableEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnFrameMetricsAvailableEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.HasOverride = OnFrameMetricsAvailableEventOverridden();
            }
        ...
        public partial class OnRestrictedCaptionAreaChangedListener
        {
            ...
            protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
            {
                _OnRestrictedCaptionAreaChangedEventHandlerIndex = AddEventHandler("onRestrictedCaptionAreaChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnRestrictedCaptionAreaChangedEventHandler));
                _hasOverrideOnRestrictedCaptionAreaChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnRestrictedCaptionAreaChanged), typeof(Android.Graphics.Rect));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnRestrictedCaptionAreaChangedEventHandlerIndex) return OnRestrictedCaptionAreaChangedEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnRestrictedCaptionAreaChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnRestrictedCaptionAreaChangedEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnRestrictedCaptionAreaChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnRestrictedCaptionAreaChanged;
            
            /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
            [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            bool OnRestrictedCaptionAreaChangedEventOverridden() => _hasOverrideOnRestrictedCaptionAreaChanged || OnOnRestrictedCaptionAreaChanged != null;
            
            void OnRestrictedCaptionAreaChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnRestrictedCaptionAreaChangedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                      // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                      // but protects against user overrides of ListenerShallManageEvent that bypass the check.
                {
                    // data.EventData.HasOverride is false by default — JVM receives no return value.
                ...
                data.EventData.HasOverride = OnRestrictedCaptionAreaChangedEventOverridden();
            }
