...
namespace Android.View
{
    ...
    public partial class ActionMode : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ActionMode>
    {
        ...
        public ActionMode(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ActionMode
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/ActionMode.html#%3Cinit%3E()"/>
        /// </summary>
        public ActionMode() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ActionMode()
        /// </summary>
        public static ActionMode CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ActionMode>();
        }
        ...
        /// </summary>
        public static int DEFAULT_HIDE_DURATION { get { return SGetField<int>(LocalBridgeClazz, "DEFAULT_HIDE_DURATION"); } set { SSetField(LocalBridgeClazz, "DEFAULT_HIDE_DURATION", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/ActionMode.html#TYPE_FLOATING"/>
        /// </summary>
        public static int TYPE_FLOATING { get { return SGetField<int>(LocalBridgeClazz, "TYPE_FLOATING"); } set { SSetField(LocalBridgeClazz, "TYPE_FLOATING", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/ActionMode.html#TYPE_PRIMARY"/>
        /// </summary>
        public static int TYPE_PRIMARY { get { return SGetField<int>(LocalBridgeClazz, "TYPE_PRIMARY"); } set { SSetField(LocalBridgeClazz, "TYPE_PRIMARY", value); } }
        ...
        public partial class Callback2
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/view/ActionMode.Callback2.html#%3Cinit%3E()"/>
            /// </summary>
            public Callback2() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for Callback2()
            /// </summary>
            public static Callback2 CreatePoolableInstance()
            {
                return JVMBridgeBase.New<Callback2>();
            }
