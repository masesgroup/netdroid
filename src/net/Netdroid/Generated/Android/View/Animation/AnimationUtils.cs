...
namespace Android.View.Animation
{
    ...
    public partial class AnimationUtils
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/view/animation/AnimationUtils.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimationUtils() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AnimationUtils()
        /// </summary>
        public static AnimationUtils CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AnimationUtils>();
        }
