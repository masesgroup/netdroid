...
namespace Android.Gesture
{
    ...
    public partial class GestureStroke : MASES.JCOBridge.C2JBridge.JVMBridgeBase<GestureStroke>
    {
        ...
        public GestureStroke(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class GestureStroke
    {
        ...
        public GestureStroke(Java.Util.ArrayList<Android.Gesture.GesturePoint> arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static GestureStroke CreatePoolableInstance(Java.Util.ArrayList<Android.Gesture.GesturePoint> arg0)
        {
            return JVMBridgeBase.New<GestureStroke>(arg0);
        }
        ...
        /// </summary>
        public Android.Graphics.RectF boundingBox { get { return IGetField<Android.Graphics.RectF>("boundingBox"); } set { ISetField("boundingBox", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStroke.html#length"/>
        /// </summary>
        public float length { get { return IGetField<float>("length"); } set { ISetField("length", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStroke.html#points"/>
        /// </summary>
        public float[] points { get { return IGetFieldArray<float>("points"); } set { ISetField("points", value); } }
        ...
        {
            return IExecuteWithSignature<Android.Graphics.Path>("toPath", "(FFI)Landroid/graphics/Path;", arg0, arg1, arg2);
        }
        /// <summary>
