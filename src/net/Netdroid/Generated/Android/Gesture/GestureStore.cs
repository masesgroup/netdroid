...
namespace Android.Gesture
{
    ...
    public partial class GestureStore : MASES.JCOBridge.C2JBridge.JVMBridgeBase<GestureStore>
    {
        ...
        public GestureStore(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class GestureStore
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStore.html#%3Cinit%3E()"/>
        /// </summary>
        public GestureStore() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<GestureStore>();
        }
        ...
        /// </summary>
        public static int ORIENTATION_INVARIANT { get { return SGetField<int>(LocalBridgeClazz, "ORIENTATION_INVARIANT"); } set { SSetField(LocalBridgeClazz, "ORIENTATION_INVARIANT", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStore.html#ORIENTATION_SENSITIVE"/>
        /// </summary>
        public static int ORIENTATION_SENSITIVE { get { return SGetField<int>(LocalBridgeClazz, "ORIENTATION_SENSITIVE"); } set { SSetField(LocalBridgeClazz, "ORIENTATION_SENSITIVE", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStore.html#SEQUENCE_INVARIANT"/>
        /// </summary>
        public static int SEQUENCE_INVARIANT { get { return SGetField<int>(LocalBridgeClazz, "SEQUENCE_INVARIANT"); } set { SSetField(LocalBridgeClazz, "SEQUENCE_INVARIANT", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/gesture/GestureStore.html#SEQUENCE_SENSITIVE"/>
        /// </summary>
        public static int SEQUENCE_SENSITIVE { get { return SGetField<int>(LocalBridgeClazz, "SEQUENCE_SENSITIVE"); } set { SSetField(LocalBridgeClazz, "SEQUENCE_SENSITIVE", value); } }
        ...
        {
            IExecuteWithSignature("addGesture", "(Ljava/lang/String;Landroid/gesture/Gesture;)V", arg0, arg1);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("load", "(Ljava/io/InputStream;Z)V", arg0, arg1);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("removeGesture", "(Ljava/lang/String;Landroid/gesture/Gesture;)V", arg0, arg1);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("save", "(Ljava/io/OutputStream;Z)V", arg0, arg1);
        }
        /// <summary>
