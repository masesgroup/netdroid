...
namespace Android.Location
{
    ...
    public partial class OnNmeaMessageListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public OnNmeaMessageListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasOnNmeaMessageListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasOnNmeaMessageListenerSecondGate;
        ...
        /// <item><see cref="_hasOnNmeaMessageListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasOnNmeaMessageListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="OnNmeaMessageListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="OnNmeaMessageListener"/> instead.</para>
    /// </remarks>
    public partial class OnNmeaMessageListenerDirect : OnNmeaMessageListener
    {
        ...
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public OnNmeaMessageListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class OnNmeaMessageListener : Android.Location.IOnNmeaMessageListener
    {
        ...
        {
            _OnNmeaMessageEventHandlerIndex = AddEventHandler("onNmeaMessage", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnNmeaMessageEventHandler));
            _hasOverrideOnNmeaMessage = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnNmeaMessage), typeof(Java.Lang.String), typeof(long));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _OnNmeaMessageEventHandlerIndex) return OnNmeaMessageEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnNmeaMessage"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnNmeaMessageEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnNmeaMessage"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnNmeaMessage;
        ...
        bool OnNmeaMessageEventOverridden() => _hasOverrideOnNmeaMessage || OnOnNmeaMessage != null;
        
        void OnNmeaMessageEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnNmeaMessageEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = OnNmeaMessageEventOverridden();
        }
