...
namespace Android.Location
{
    ...
    public partial class Geocoder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Geocoder>
    {
        ...
        public Geocoder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class GeocodeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public GeocodeListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public GeocodeListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasGeocodeListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasGeocodeListenerSecondGate;
            ...
            /// <item><see cref="_hasGeocodeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasGeocodeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="GeocodeListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="GeocodeListener"/> instead.</para>
        /// </remarks>
        public partial class GeocodeListenerDirect : GeocodeListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public GeocodeListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public GeocodeListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class Geocoder
    {
        ...
        public Geocoder(Android.Content.Context arg0, Java.Util.Locale arg1) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static Geocoder CreatePoolableInstance(Android.Content.Context arg0, Java.Util.Locale arg1)
        {
            return JVMBridgeBase.New<Geocoder>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/location/Geocoder.html#%3Cinit%3E(android.content.Context)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        public Geocoder(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static Geocoder CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<Geocoder>(arg0);
        }
        ...
        public partial class GeocodeListener
        {
            ...
            {
                _OnGeocodeEventHandlerIndex = AddEventHandler("onGeocode", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnGeocodeEventHandler));
                _hasOverrideOnGeocode = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnGeocode), typeof(Java.Util.List<Android.Location.Address>));
                ...
                _hasOverrideOnError = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnError), typeof(Java.Lang.String));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnGeocodeEventHandlerIndex) return OnGeocodeEventOverridden();
            ...
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnGeocode"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnGeocodeEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnGeocode"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnGeocode;
            ...
            bool OnGeocodeEventOverridden() => _hasOverrideOnGeocode || OnOnGeocode != null;
            
            void OnGeocodeEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnGeocodeEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.HasOverride = OnGeocodeEventOverridden();
            }
