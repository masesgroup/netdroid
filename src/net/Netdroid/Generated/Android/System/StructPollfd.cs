...
{
    #region StructPollfd declaration
    /// <summary>
    ...
    public partial class StructPollfd : MASES.JCOBridge.C2JBridge.JVMBridgeBase<StructPollfd>
    {
        ...
        public StructPollfd(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region StructPollfd implementation
    public partial class StructPollfd
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/system/StructPollfd.html#%3Cinit%3E()"/>
        /// </summary>
        public StructPollfd() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for StructPollfd()
        /// </summary>
        public static StructPollfd CreatePoolableInstance()
        {
            return JVMBridgeBase.New<StructPollfd>();
        }
