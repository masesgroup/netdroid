...
namespace Android.Net.Http
{
    ...
    public partial class UrlResponseInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/http/UrlResponseInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public UrlResponseInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for UrlResponseInfo()
        /// </summary>
        public static UrlResponseInfo CreatePoolableInstance()
        {
            return JVMBridgeBase.New<UrlResponseInfo>();
        }
