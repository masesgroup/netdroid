...
namespace Android.Net.Http
{
    ...
    public partial class UploadDataSink
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/http/UploadDataSink.html#%3Cinit%3E()"/>
        /// </summary>
        public UploadDataSink() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for UploadDataSink()
        /// </summary>
        public static UploadDataSink CreatePoolableInstance()
        {
            return JVMBridgeBase.New<UploadDataSink>();
        }
