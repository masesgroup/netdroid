...
namespace Android.Net.Http
{
    ...
    public partial class HeaderBlock
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/http/HeaderBlock.html#%3Cinit%3E()"/>
        /// </summary>
        public HeaderBlock() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for HeaderBlock()
        /// </summary>
        public static HeaderBlock CreatePoolableInstance()
        {
            return JVMBridgeBase.New<HeaderBlock>();
        }
