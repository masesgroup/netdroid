...
namespace Android.Net.Sip
{
    ...
    public partial class SipRegistrationListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public SipRegistrationListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public SipRegistrationListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasSipRegistrationListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasSipRegistrationListenerSecondGate;
        ...
        /// <item><see cref="_hasSipRegistrationListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasSipRegistrationListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="SipRegistrationListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="SipRegistrationListener"/> instead.</para>
    /// </remarks>
    public partial class SipRegistrationListenerDirect : SipRegistrationListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public SipRegistrationListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public SipRegistrationListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class SipRegistrationListener : Android.Net.Sip.ISipRegistrationListener
    {
        ...
        {
            _OnRegisteringEventHandlerIndex = AddEventHandler("onRegistering", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnRegisteringEventHandler));
            _hasOverrideOnRegistering = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnRegistering), typeof(Java.Lang.String));
            _OnRegistrationDoneEventHandlerIndex = AddEventHandler("onRegistrationDone", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnRegistrationDoneEventHandler));
            _hasOverrideOnRegistrationDone = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnRegistrationDone), typeof(Java.Lang.String), typeof(long));
            ...
            _hasOverrideOnRegistrationFailed = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnRegistrationFailed), typeof(Java.Lang.String), typeof(int), typeof(Java.Lang.String));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _OnRegisteringEventHandlerIndex) return OnRegisteringEventOverridden();
            if (eventIndex == _OnRegistrationDoneEventHandlerIndex) return OnRegistrationDoneEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnRegistering"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnRegisteringEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnRegistering"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnRegistering;
        ...
        bool OnRegisteringEventOverridden() => _hasOverrideOnRegistering || OnOnRegistering != null;
        
        void OnRegisteringEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnRegisteringEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = OnRegisteringEventOverridden();
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnRegistrationDone"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnRegistrationDoneEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnRegistrationDone"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnRegistrationDone;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool OnRegistrationDoneEventOverridden() => _hasOverrideOnRegistrationDone || OnOnRegistrationDone != null;
        
        void OnRegistrationDoneEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnRegistrationDoneEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            data.EventData.HasOverride = OnRegistrationDoneEventOverridden();
        }
