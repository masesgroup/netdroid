...
namespace Android.Net
{
    ...
    public partial class Network : Android.Os.Parcelable
    {
        ...
        public Network(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Network
    {
        ...
        {
            return IExecuteWithSignature<Java.Net.URLConnection>("openConnection", "(Ljava/net/URL;Ljava/net/Proxy;)Ljava/net/URLConnection;", arg0, arg1);
        }
        /// <summary>
