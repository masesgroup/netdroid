...
namespace Android.Net.Wifi.Aware
{
    ...
    public partial class AttachCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AttachCallback>
    {
        ...
        public AttachCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AttachCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/wifi/aware/AttachCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public AttachCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AttachCallback()
        /// </summary>
        public static AttachCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AttachCallback>();
        }
