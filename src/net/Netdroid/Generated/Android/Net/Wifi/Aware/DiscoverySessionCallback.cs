...
namespace Android.Net.Wifi.Aware
{
    ...
    public partial class DiscoverySessionCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/wifi/aware/DiscoverySessionCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public DiscoverySessionCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DiscoverySessionCallback()
        /// </summary>
        public static DiscoverySessionCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DiscoverySessionCallback>();
        }
