...
namespace Android.Net.Wifi.Aware
{
    ...
    public partial class IdentityChangedListener : MASES.JCOBridge.C2JBridge.JVMBridgeBase<IdentityChangedListener>
    {
        ...
        public IdentityChangedListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class IdentityChangedListener
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/wifi/aware/IdentityChangedListener.html#%3Cinit%3E()"/>
        /// </summary>
        public IdentityChangedListener() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for IdentityChangedListener()
        /// </summary>
        public static IdentityChangedListener CreatePoolableInstance()
        {
            return JVMBridgeBase.New<IdentityChangedListener>();
        }
        ...
        /// </summary>
        public static int CLUSTER_CHANGE_EVENT_JOINED { get { return SGetField<int>(LocalBridgeClazz, "CLUSTER_CHANGE_EVENT_JOINED"); } set { SSetField(LocalBridgeClazz, "CLUSTER_CHANGE_EVENT_JOINED", value); } }
        /// <summary>
        ...
        /// </summary>
        public static int CLUSTER_CHANGE_EVENT_STARTED { get { return SGetField<int>(LocalBridgeClazz, "CLUSTER_CHANGE_EVENT_STARTED"); } set { SSetField(LocalBridgeClazz, "CLUSTER_CHANGE_EVENT_STARTED", value); } }
