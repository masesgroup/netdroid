...
{
    #region WifiP2pDeviceList declaration
    /// <summary>
    ...
    public partial class WifiP2pDeviceList : Android.Os.Parcelable
    {
        ...
        public WifiP2pDeviceList(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region WifiP2pDeviceList implementation
    public partial class WifiP2pDeviceList
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/wifi/p2p/WifiP2pDeviceList.html#%3Cinit%3E()"/>
        /// </summary>
        public WifiP2pDeviceList() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for WifiP2pDeviceList()
        /// </summary>
        public static WifiP2pDeviceList CreatePoolableInstance()
        {
            return JVMBridgeBase.New<WifiP2pDeviceList>();
        }
        /// <summary>
        ...
        public WifiP2pDeviceList(Android.Net.Wifi.P2p.WifiP2pDeviceList arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for WifiP2pDeviceList(Android.Net.Wifi.P2p.WifiP2pDeviceList arg0)
        /// </summary>
        public static WifiP2pDeviceList CreatePoolableInstance(Android.Net.Wifi.P2p.WifiP2pDeviceList arg0)
        {
            return JVMBridgeBase.New<WifiP2pDeviceList>(arg0);
        }
