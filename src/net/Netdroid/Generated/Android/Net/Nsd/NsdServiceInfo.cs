...
namespace Android.Net.Nsd
{
    ...
    public partial class NsdServiceInfo : Android.Os.Parcelable
    {
        ...
        public NsdServiceInfo(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class NsdServiceInfo
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/nsd/NsdServiceInfo.html#%3Cinit%3E()"/>
        /// </summary>
        public NsdServiceInfo() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<NsdServiceInfo>();
        }
