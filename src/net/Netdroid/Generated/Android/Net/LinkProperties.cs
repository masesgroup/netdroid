...
namespace Android.Net
{
    ...
    public partial class LinkProperties : Android.Os.Parcelable
    {
        ...
        public LinkProperties(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class LinkProperties
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/net/LinkProperties.html#%3Cinit%3E()"/>
        /// </summary>
        public LinkProperties() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<LinkProperties>();
        }
