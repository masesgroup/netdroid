...
namespace Android.Telecom
{
    ...
    public partial class ConnectionService : Android.App.Service
    {
        ...
        public ConnectionService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ConnectionService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/telecom/ConnectionService.html#%3Cinit%3E()"/>
        /// </summary>
        public ConnectionService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ConnectionService()
        /// </summary>
        public static ConnectionService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ConnectionService>();
        }
