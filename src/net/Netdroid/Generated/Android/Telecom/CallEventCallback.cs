...
{
    #region CallEventCallback declaration
    /// <summary>
    ...
    public partial class CallEventCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CallEventCallback>
    {
        ...
        public CallEventCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/android/telecom/CallEventCallback.html"/>
    /// </summary>
    ...
    #region CallEventCallback implementation
    public partial class CallEventCallback : Android.Telecom.ICallEventCallback
    {
        ...
        {
            IExecuteWithSignature("onEvent", "(Ljava/lang/String;Landroid/os/Bundle;)V", arg0, arg1);
        }
        /// <summary>
