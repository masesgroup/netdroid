...
namespace Android.Appwidget
{
    ...
    public partial class AppWidgetProvider
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/appwidget/AppWidgetProvider.html#%3Cinit%3E()"/>
        /// </summary>
        public AppWidgetProvider() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AppWidgetProvider()
        /// </summary>
        public static AppWidgetProvider CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AppWidgetProvider>();
        }
