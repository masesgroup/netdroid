...
namespace Android.Printservice
{
    ...
    public partial class PrinterDiscoverySession : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PrinterDiscoverySession>
    {
        ...
        public PrinterDiscoverySession(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class PrinterDiscoverySession
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/printservice/PrinterDiscoverySession.html#%3Cinit%3E()"/>
        /// </summary>
        public PrinterDiscoverySession() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PrinterDiscoverySession()
        /// </summary>
        public static PrinterDiscoverySession CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PrinterDiscoverySession>();
        }
