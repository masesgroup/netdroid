...
namespace Android.Preference
{
    ...
    public partial class PreferenceFragment : Android.App.Fragment
    {
        ...
        public PreferenceFragment(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class OnPreferenceStartFragmentCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<OnPreferenceStartFragmentCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public OnPreferenceStartFragmentCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class PreferenceFragment
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/preference/PreferenceFragment.html#%3Cinit%3E()"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public PreferenceFragment() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PreferenceFragment()
        /// </summary>
        public static PreferenceFragment CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PreferenceFragment>();
        }
