...
{
    #region BluetoothHealthCallback declaration
    /// <summary>
    ...
    public partial class BluetoothHealthCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<BluetoothHealthCallback>
    {
        ...
        public BluetoothHealthCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region BluetoothHealthCallback implementation
    public partial class BluetoothHealthCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/bluetooth/BluetoothHealthCallback.html#%3Cinit%3E()"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public BluetoothHealthCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for BluetoothHealthCallback()
        /// </summary>
        public static BluetoothHealthCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<BluetoothHealthCallback>();
        }
