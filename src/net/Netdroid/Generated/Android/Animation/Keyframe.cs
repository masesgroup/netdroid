...
namespace Android.Animation
{
    ...
    public partial class Keyframe : Java.Lang.Cloneable
    {
        ...
        public Keyframe(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Keyframe
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/Keyframe.html#%3Cinit%3E()"/>
        /// </summary>
        public Keyframe() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Keyframe()
        /// </summary>
        public static Keyframe CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Keyframe>();
        }
