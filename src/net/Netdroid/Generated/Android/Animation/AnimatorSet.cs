...
namespace Android.Animation
{
    ...
    public partial class AnimatorSet : Android.Animation.Animator
    {
        ...
        public AnimatorSet(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AnimatorSet
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/AnimatorSet.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimatorSet() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<AnimatorSet>();
        }
        ...
        {
            IExecuteWithSignature("playSequentially", "([Landroid/animation/Animator;)V", arg0);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("playTogether", "([Landroid/animation/Animator;)V", arg0);
        }
        /// <summary>
