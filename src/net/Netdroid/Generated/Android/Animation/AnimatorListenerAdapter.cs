...
namespace Android.Animation
{
    ...
    public partial class AnimatorListenerAdapter : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AnimatorListenerAdapter>
    {
        ...
        public AnimatorListenerAdapter(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AnimatorListenerAdapter
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/AnimatorListenerAdapter.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimatorListenerAdapter() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AnimatorListenerAdapter()
        /// </summary>
        public static AnimatorListenerAdapter CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AnimatorListenerAdapter>();
        }
