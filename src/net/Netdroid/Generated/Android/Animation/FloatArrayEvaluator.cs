...
namespace Android.Animation
{
    ...
    public partial class FloatArrayEvaluator : Android.Animation.TypeEvaluator<float[]>
    {
        ...
        public FloatArrayEvaluator(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class FloatArrayEvaluator
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/FloatArrayEvaluator.html#%3Cinit%3E()"/>
        /// </summary>
        public FloatArrayEvaluator() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for FloatArrayEvaluator()
        /// </summary>
        public static FloatArrayEvaluator CreatePoolableInstance()
        {
            return JVMBridgeBase.New<FloatArrayEvaluator>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/FloatArrayEvaluator.html#%3Cinit%3E(float[])"/>
        /// </summary>
        /// <param name="arg0"><see cref="float"/></param>
        public FloatArrayEvaluator(float[] arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for FloatArrayEvaluator(float[] arg0)
        /// </summary>
        public static FloatArrayEvaluator CreatePoolableInstance(float[] arg0)
        {
            return JVMBridgeBase.New<FloatArrayEvaluator>(arg0);
        }
