...
{
    #region IntEvaluator declaration
    /// <summary>
    ...
    public partial class IntEvaluator : Android.Animation.TypeEvaluator<Java.Lang.Integer>
    {
        ...
        public IntEvaluator(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region IntEvaluator implementation
    public partial class IntEvaluator
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/animation/IntEvaluator.html#%3Cinit%3E()"/>
        /// </summary>
        public IntEvaluator() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for IntEvaluator()
        /// </summary>
        public static IntEvaluator CreatePoolableInstance()
        {
            return JVMBridgeBase.New<IntEvaluator>();
        }
