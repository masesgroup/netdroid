...
namespace Android.Adservices.Ondevicepersonalization
{
    ...
    public partial class IsolatedService : Android.App.Service
    {
        ...
        public IsolatedService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class IsolatedService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/adservices/ondevicepersonalization/IsolatedService.html#%3Cinit%3E()"/>
        /// </summary>
        public IsolatedService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for IsolatedService()
        /// </summary>
        public static IsolatedService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<IsolatedService>();
        }
