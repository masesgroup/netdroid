...
namespace Android.Adservices.Appsetid
{
    ...
    public partial class AppSetIdManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AppSetIdManager>
    {
        ...
        public AppSetIdManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class AppSetIdManager
    {
        ...
        {
            IExecuteWithSignature("getAppSetId", "(Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V", arg0, arg1);
        }
