...
namespace Android.Adservices.Signals
{
    ...
    public partial class ProtectedSignalsManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ProtectedSignalsManager>
    {
        ...
        public ProtectedSignalsManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class ProtectedSignalsManager
    {
        ...
        {
            IExecuteWithSignature("updateSignals", "(Landroid/adservices/signals/UpdateSignalsRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V", arg0, arg1, arg2);
        }
