...
namespace Android.Security.Keystore
{
    ...
    public partial class KeyProtection : Java.Security.KeyStore.ProtectionParameter
    {
        ...
        public KeyProtection(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class KeyProtection
    {
        ...
        public partial class Builder
        {
            ...
            {
                return IExecuteWithSignature<Android.Security.Keystore.KeyProtection.Builder>("setBlockModes", "([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;", arg0);
            }
            /// <summary>
            ...
            {
                return IExecuteWithSignature<Android.Security.Keystore.KeyProtection.Builder>("setDigests", "([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;", arg0);
            }
            /// <summary>
            ...
            {
                return IExecuteWithSignature<Android.Security.Keystore.KeyProtection.Builder>("setEncryptionPaddings", "([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;", arg0);
            }
            /// <summary>
            ...
            {
                return IExecuteWithSignature<Android.Security.Keystore.KeyProtection.Builder>("setMgf1Digests", "([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;", arg0);
            }
            /// <summary>
            ...
            {
                return IExecuteWithSignature<Android.Security.Keystore.KeyProtection.Builder>("setSignaturePaddings", "([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;", arg0);
            }
            /// <summary>
