...
namespace Android.Security
{
    ...
    public partial class ConfirmationCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/security/ConfirmationCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public ConfirmationCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ConfirmationCallback()
        /// </summary>
        public static ConfirmationCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ConfirmationCallback>();
        }
