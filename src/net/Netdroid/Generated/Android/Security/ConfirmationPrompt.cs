...
namespace Android.Security
{
    ...
    public partial class ConfirmationPrompt : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ConfirmationPrompt>
    {
        ...
        public ConfirmationPrompt(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ConfirmationPrompt
    {
        ...
        {
            IExecuteWithSignature("presentPrompt", "(Ljava/util/concurrent/Executor;Landroid/security/ConfirmationCallback;)V", arg0, arg1);
        }
