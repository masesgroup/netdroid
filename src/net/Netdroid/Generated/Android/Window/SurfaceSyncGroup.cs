...
namespace Android.Window
{
    ...
    public partial class SurfaceSyncGroup : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SurfaceSyncGroup>
    {
        ...
        public SurfaceSyncGroup(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SurfaceSyncGroup
    {
        ...
        public SurfaceSyncGroup(Java.Lang.String arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for SurfaceSyncGroup(Java.Lang.String arg0)
        /// </summary>
        public static SurfaceSyncGroup CreatePoolableInstance(Java.Lang.String arg0)
        {
            return JVMBridgeBase.New<SurfaceSyncGroup>(arg0);
        }
