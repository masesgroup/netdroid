...
namespace Android.Opengl
{
    ...
    public partial class GLES10Ext : MASES.JCOBridge.C2JBridge.JVMBridgeBase<GLES10Ext>
    {
        ...
        public GLES10Ext(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region GLES10Ext implementation
    public partial class GLES10Ext
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/opengl/GLES10Ext.html#%3Cinit%3E()"/>
        /// </summary>
        public GLES10Ext() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for GLES10Ext()
        /// </summary>
        public static GLES10Ext CreatePoolableInstance()
        {
            return JVMBridgeBase.New<GLES10Ext>();
        }
