...
namespace Android.Graphics.Drawable
{
    ...
    public partial class AnimationDrawable : Android.Graphics.Drawable.DrawableContainer
    {
        ...
        public AnimationDrawable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AnimationDrawable : Android.Graphics.Drawable.IAnimatable, Java.Lang.IRunnable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/drawable/AnimationDrawable.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimationDrawable() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AnimationDrawable()
        /// </summary>
        public static AnimationDrawable CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AnimationDrawable>();
        }
