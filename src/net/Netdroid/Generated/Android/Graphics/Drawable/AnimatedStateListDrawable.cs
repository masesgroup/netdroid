...
namespace Android.Graphics.Drawable
{
    ...
    public partial class AnimatedStateListDrawable : Android.Graphics.Drawable.StateListDrawable
    {
        ...
        public AnimatedStateListDrawable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AnimatedStateListDrawable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/drawable/AnimatedStateListDrawable.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimatedStateListDrawable() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AnimatedStateListDrawable()
        /// </summary>
        public static AnimatedStateListDrawable CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AnimatedStateListDrawable>();
        }
        ...
        public void AddTransition<T>(int arg0, int arg1, T arg2, bool arg3) where T : Android.Graphics.Drawable.Drawable, Android.Graphics.Drawable.IAnimatable
        {
