...
namespace Android.Graphics.Drawable
{
    ...
    public partial class AnimatedImageDrawable : Android.Graphics.Drawable.Drawable
    {
        ...
        public AnimatedImageDrawable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AnimatedImageDrawable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/drawable/AnimatedImageDrawable.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimatedImageDrawable() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AnimatedImageDrawable()
        /// </summary>
        public static AnimatedImageDrawable CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AnimatedImageDrawable>();
        }
        ...
        /// </summary>
        public static int REPEAT_INFINITE { get { return SGetField<int>(LocalBridgeClazz, "REPEAT_INFINITE"); } set { SSetField(LocalBridgeClazz, "REPEAT_INFINITE", value); } }
