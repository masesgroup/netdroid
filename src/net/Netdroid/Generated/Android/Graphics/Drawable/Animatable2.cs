...
namespace Android.Graphics.Drawable
{
    ...
    public partial class Animatable2 : Android.Graphics.Drawable.Animatable
    {
        ...
        public Animatable2(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class AnimationCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AnimationCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public AnimationCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region IAnimatable2
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/android/graphics/drawable/Animatable2.html"/>
    /// </summary>
    ...
    public partial class Animatable2 : Android.Graphics.Drawable.IAnimatable2
    {
        ...
        public partial class AnimationCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/drawable/Animatable2.AnimationCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public AnimationCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for AnimationCallback()
            /// </summary>
            public static AnimationCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<AnimationCallback>();
            }
