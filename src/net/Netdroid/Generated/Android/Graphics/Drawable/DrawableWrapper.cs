...
namespace Android.Graphics.Drawable
{
    ...
    public partial class DrawableWrapper : Android.Graphics.Drawable.Drawable
    {
        ...
        public DrawableWrapper(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DrawableWrapper
    {
        ...
        public DrawableWrapper(Android.Graphics.Drawable.Drawable arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for DrawableWrapper(Android.Graphics.Drawable.Drawable arg0)
        /// </summary>
        public static DrawableWrapper CreatePoolableInstance(Android.Graphics.Drawable.Drawable arg0)
        {
            return JVMBridgeBase.New<DrawableWrapper>(arg0);
        }
