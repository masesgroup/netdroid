...
namespace Android.Graphics.Drawable
{
    ...
    public partial class RotateDrawable : Android.Graphics.Drawable.DrawableWrapper
    {
        ...
        public RotateDrawable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class RotateDrawable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/drawable/RotateDrawable.html#%3Cinit%3E()"/>
        /// </summary>
        public RotateDrawable() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for RotateDrawable()
        /// </summary>
        public static RotateDrawable CreatePoolableInstance()
        {
            return JVMBridgeBase.New<RotateDrawable>();
        }
