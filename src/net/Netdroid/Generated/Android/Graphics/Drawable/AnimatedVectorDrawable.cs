...
{
    #region AnimatedVectorDrawable declaration
    /// <summary>
    ...
    public partial class AnimatedVectorDrawable : Android.Graphics.Drawable.Drawable
    {
        ...
        public AnimatedVectorDrawable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region AnimatedVectorDrawable implementation
    public partial class AnimatedVectorDrawable
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/drawable/AnimatedVectorDrawable.html#%3Cinit%3E()"/>
        /// </summary>
        public AnimatedVectorDrawable() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<AnimatedVectorDrawable>();
        }
