...
namespace Android.Graphics
{
    ...
    public partial class Camera
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/Camera.html#%3Cinit%3E()"/>
        /// </summary>
        public Camera() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Camera()
        /// </summary>
        public static Camera CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Camera>();
        }
