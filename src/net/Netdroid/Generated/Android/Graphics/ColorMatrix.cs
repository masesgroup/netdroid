...
namespace Android.Graphics
{
    ...
    public partial class ColorMatrix : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ColorMatrix>
    {
        ...
        public ColorMatrix(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ColorMatrix
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/ColorMatrix.html#%3Cinit%3E()"/>
        /// </summary>
        public ColorMatrix() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ColorMatrix()
        /// </summary>
        public static ColorMatrix CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ColorMatrix>();
        }
        /// <summary>
        ...
        public ColorMatrix(Android.Graphics.ColorMatrix arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ColorMatrix(Android.Graphics.ColorMatrix arg0)
        /// </summary>
        public static ColorMatrix CreatePoolableInstance(Android.Graphics.ColorMatrix arg0)
        {
            return JVMBridgeBase.New<ColorMatrix>(arg0);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/ColorMatrix.html#%3Cinit%3E(float[])"/>
        /// </summary>
        /// <param name="arg0"><see cref="float"/></param>
        public ColorMatrix(float[] arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ColorMatrix(float[] arg0)
        /// </summary>
        public static ColorMatrix CreatePoolableInstance(float[] arg0)
        {
            return JVMBridgeBase.New<ColorMatrix>(arg0);
        }
