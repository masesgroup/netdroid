...
namespace Android.Graphics
{
    ...
    public partial class Shader : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Shader>
    {
        ...
        public Shader(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class TileMode : Java.Lang.Enum<Android.Graphics.Shader.TileMode>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public TileMode(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Shader
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/Shader.html#%3Cinit%3E()"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public Shader() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Shader()
        /// </summary>
        public static Shader CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Shader>();
        }
        ...
        public partial class TileMode
        {
            ...
            /// </summary>
            public static Android.Graphics.Shader.TileMode CLAMP { get { return SGetField<Android.Graphics.Shader.TileMode>(LocalBridgeClazz, "CLAMP"); } set { SSetField(LocalBridgeClazz, "CLAMP", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/Shader.TileMode.html#DECAL"/>
            /// </summary>
            public static Android.Graphics.Shader.TileMode DECAL { get { return SGetField<Android.Graphics.Shader.TileMode>(LocalBridgeClazz, "DECAL"); } set { SSetField(LocalBridgeClazz, "DECAL", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/Shader.TileMode.html#MIRROR"/>
            /// </summary>
            public static Android.Graphics.Shader.TileMode MIRROR { get { return SGetField<Android.Graphics.Shader.TileMode>(LocalBridgeClazz, "MIRROR"); } set { SSetField(LocalBridgeClazz, "MIRROR", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/Shader.TileMode.html#REPEAT"/>
            /// </summary>
            public static Android.Graphics.Shader.TileMode REPEAT { get { return SGetField<Android.Graphics.Shader.TileMode>(LocalBridgeClazz, "REPEAT"); } set { SSetField(LocalBridgeClazz, "REPEAT", value); } }
