...
namespace Android.Graphics
{
    ...
    public partial class PointF : Android.Os.Parcelable
    {
        ...
        public PointF(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region PointF implementation
    public partial class PointF
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/graphics/PointF.html#%3Cinit%3E()"/>
        /// </summary>
        public PointF() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PointF()
        /// </summary>
        public static PointF CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PointF>();
        }
        /// <summary>
        ...
        public PointF(Android.Graphics.Point arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for PointF(Android.Graphics.Point arg0)
        /// </summary>
        public static PointF CreatePoolableInstance(Android.Graphics.Point arg0)
        {
            return JVMBridgeBase.New<PointF>(arg0);
        }
        /// <summary>
        ...
        public PointF(Android.Graphics.PointF arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for PointF(Android.Graphics.PointF arg0)
        /// </summary>
        public static PointF CreatePoolableInstance(Android.Graphics.PointF arg0)
        {
            return JVMBridgeBase.New<PointF>(arg0);
        }
        /// <summary>
        ...
        public PointF(float arg0, float arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for PointF(float arg0, float arg1)
        /// </summary>
        public static PointF CreatePoolableInstance(float arg0, float arg1)
        {
            return JVMBridgeBase.New<PointF>(arg0, arg1);
        }
        ...
        {
            return SExecuteWithSignature<float>(LocalBridgeClazz, "length", "(FF)F", arg0, arg1);
        }
        ...
        {
            return IExecuteWithSignature<bool>("equals", "(FF)Z", arg0, arg1);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("set", "(FF)V", arg0, arg1);
        }
        /// <summary>
