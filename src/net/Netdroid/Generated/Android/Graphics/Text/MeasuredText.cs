...
namespace Android.Graphics.Text
{
    ...
    public partial class MeasuredText : MASES.JCOBridge.C2JBridge.JVMBridgeBase<MeasuredText>
    {
        ...
        public MeasuredText(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class MeasuredText
    {
        ...
        public partial class Builder
        {
            ...
            public Builder(Android.Graphics.Text.MeasuredText arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Builder(Android.Graphics.Text.MeasuredText arg0)
            /// </summary>
            public static Builder CreatePoolableInstance(Android.Graphics.Text.MeasuredText arg0)
            {
            ...
            public Builder(char[] arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Builder(char[] arg0)
            /// </summary>
            public static Builder CreatePoolableInstance(char[] arg0)
            {
                return JVMBridgeBase.New<Builder>(arg0);
            }
            ...
            /// </summary>
            public static int HYPHENATION_MODE_FAST { get { return SGetField<int>(LocalBridgeClazz, "HYPHENATION_MODE_FAST"); } set { SSetField(LocalBridgeClazz, "HYPHENATION_MODE_FAST", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/text/MeasuredText.Builder.html#HYPHENATION_MODE_NONE"/>
            /// </summary>
            public static int HYPHENATION_MODE_NONE { get { return SGetField<int>(LocalBridgeClazz, "HYPHENATION_MODE_NONE"); } set { SSetField(LocalBridgeClazz, "HYPHENATION_MODE_NONE", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/graphics/text/MeasuredText.Builder.html#HYPHENATION_MODE_NORMAL"/>
            /// </summary>
            public static int HYPHENATION_MODE_NORMAL { get { return SGetField<int>(LocalBridgeClazz, "HYPHENATION_MODE_NORMAL"); } set { SSetField(LocalBridgeClazz, "HYPHENATION_MODE_NORMAL", value); } }
