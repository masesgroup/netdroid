...
namespace Android.Speech
{
    ...
    public partial class RecognitionService : Android.App.Service
    {
        ...
        public RecognitionService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class SupportCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SupportCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public SupportCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class RecognitionService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/speech/RecognitionService.html#%3Cinit%3E()"/>
        /// </summary>
        public RecognitionService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for RecognitionService()
        /// </summary>
        public static RecognitionService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<RecognitionService>();
        }
