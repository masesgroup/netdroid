...
{
    #region TextToSpeechService declaration
    /// <summary>
    ...
    public partial class TextToSpeechService : Android.App.Service
    {
        ...
        public TextToSpeechService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region TextToSpeechService implementation
    public partial class TextToSpeechService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/speech/tts/TextToSpeechService.html#%3Cinit%3E()"/>
        /// </summary>
        public TextToSpeechService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for TextToSpeechService()
        /// </summary>
        public static TextToSpeechService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<TextToSpeechService>();
        }
        ...
        {
            return IExecuteWithSignature<Java.Lang.String>("onGetDefaultVoiceNameFor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", arg0, arg1, arg2);
        }
        /// <summary>
