...
namespace Android.Speech.Tts
{
    ...
    public partial class UtteranceProgressListener : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UtteranceProgressListener>
    {
        ...
        public UtteranceProgressListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class UtteranceProgressListener
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/speech/tts/UtteranceProgressListener.html#%3Cinit%3E()"/>
        /// </summary>
        public UtteranceProgressListener() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for UtteranceProgressListener()
        /// </summary>
        public static UtteranceProgressListener CreatePoolableInstance()
        {
            return JVMBridgeBase.New<UtteranceProgressListener>();
        }
