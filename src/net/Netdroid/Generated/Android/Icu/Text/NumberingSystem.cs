...
namespace Android.Icu.Text
{
    ...
    public partial class NumberingSystem : MASES.JCOBridge.C2JBridge.JVMBridgeBase<NumberingSystem>
    {
        ...
        public NumberingSystem(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class NumberingSystem
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/icu/text/NumberingSystem.html#%3Cinit%3E()"/>
        /// </summary>
        public NumberingSystem() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for NumberingSystem()
        /// </summary>
        public static NumberingSystem CreatePoolableInstance()
        {
            return JVMBridgeBase.New<NumberingSystem>();
        }
        ...
        /// </summary>
        public static Android.Icu.Text.NumberingSystem LATIN { get { return SGetField<Android.Icu.Text.NumberingSystem>(LocalBridgeClazz, "LATIN"); } set { SSetField(LocalBridgeClazz, "LATIN", value); } }
