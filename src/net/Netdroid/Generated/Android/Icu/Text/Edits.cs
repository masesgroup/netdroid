...
namespace Android.Icu.Text
{
    ...
    public partial class Edits : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Edits>
    {
        ...
        public Edits(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Edits
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/icu/text/Edits.html#%3Cinit%3E()"/>
        /// </summary>
        public Edits() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Edits()
        /// </summary>
        public static Edits CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Edits>();
        }
