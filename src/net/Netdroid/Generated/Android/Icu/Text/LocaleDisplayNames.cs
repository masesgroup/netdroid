...
namespace Android.Icu.Text
{
    ...
    public partial class LocaleDisplayNames : MASES.JCOBridge.C2JBridge.JVMBridgeBase<LocaleDisplayNames>
    {
        ...
        public LocaleDisplayNames(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class DialectHandling : Java.Lang.Enum<Android.Icu.Text.LocaleDisplayNames.DialectHandling>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public DialectHandling(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class UiListItem : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UiListItem>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public UiListItem(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class LocaleDisplayNames
    {
        ...
        {
            return SExecuteWithSignature<Android.Icu.Text.LocaleDisplayNames>(LocalBridgeClazz, "getInstance", "(Landroid/icu/util/ULocale;[Landroid/icu/text/DisplayContext;)Landroid/icu/text/LocaleDisplayNames;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg1, arg0));
        }
        /// <summary>
        ...
        {
            return SExecuteWithSignature<Android.Icu.Text.LocaleDisplayNames>(LocalBridgeClazz, "getInstance", "(Ljava/util/Locale;[Landroid/icu/text/DisplayContext;)Landroid/icu/text/LocaleDisplayNames;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg1, arg0));
        }
        /// <summary>
        ...
        public partial class DialectHandling
        {
            ...
            /// </summary>
            public static Android.Icu.Text.LocaleDisplayNames.DialectHandling DIALECT_NAMES { get { return SGetField<Android.Icu.Text.LocaleDisplayNames.DialectHandling>(LocalBridgeClazz, "DIALECT_NAMES"); } set { SSetField(LocalBridgeClazz, "DIALECT_NAMES", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/icu/text/LocaleDisplayNames.DialectHandling.html#STANDARD_NAMES"/>
            /// </summary>
            public static Android.Icu.Text.LocaleDisplayNames.DialectHandling STANDARD_NAMES { get { return SGetField<Android.Icu.Text.LocaleDisplayNames.DialectHandling>(LocalBridgeClazz, "STANDARD_NAMES"); } set { SSetField(LocalBridgeClazz, "STANDARD_NAMES", value); } }
        ...
        public partial class UiListItem
        {
            ...
            public UiListItem(Android.Icu.Util.ULocale arg0, Android.Icu.Util.ULocale arg1, Java.Lang.String arg2, Java.Lang.String arg3) : base(JVMBridgeBase.InitializerInstance)
            {
            ...
            /// </summary>
            public static UiListItem CreatePoolableInstance(Android.Icu.Util.ULocale arg0, Android.Icu.Util.ULocale arg1, Java.Lang.String arg2, Java.Lang.String arg3)
            {
                return JVMBridgeBase.New<UiListItem>(arg0, arg1, arg2, arg3);
            }
            ...
            /// </summary>
            public Android.Icu.Util.ULocale minimized { get { return IGetField<Android.Icu.Util.ULocale>("minimized"); } set { ISetField("minimized", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/icu/text/LocaleDisplayNames.UiListItem.html#modified"/>
            /// </summary>
            public Android.Icu.Util.ULocale modified { get { return IGetField<Android.Icu.Util.ULocale>("modified"); } set { ISetField("modified", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/icu/text/LocaleDisplayNames.UiListItem.html#nameInDisplayLocale"/>
            /// </summary>
            public Java.Lang.String nameInDisplayLocale { get { return IGetField<Java.Lang.String>("nameInDisplayLocale"); } set { ISetField("nameInDisplayLocale", value); } }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/icu/text/LocaleDisplayNames.UiListItem.html#nameInSelf"/>
            /// </summary>
            public Java.Lang.String nameInSelf { get { return IGetField<Java.Lang.String>("nameInSelf"); } set { ISetField("nameInSelf", value); } }
