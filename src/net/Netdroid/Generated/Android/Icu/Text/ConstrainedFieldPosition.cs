...
namespace Android.Icu.Text
{
    ...
    public partial class ConstrainedFieldPosition : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ConstrainedFieldPosition>
    {
        ...
        public ConstrainedFieldPosition(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ConstrainedFieldPosition
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/icu/text/ConstrainedFieldPosition.html#%3Cinit%3E()"/>
        /// </summary>
        public ConstrainedFieldPosition() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ConstrainedFieldPosition()
        /// </summary>
        public static ConstrainedFieldPosition CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ConstrainedFieldPosition>();
        }
