...
namespace Android.Icu.Util
{
    ...
    public partial class ValueIterator : Android.Icu.Util.IValueIterator
    {
        ...
        public partial class Element
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/icu/util/ValueIterator.Element.html#%3Cinit%3E()"/>
            /// </summary>
            public Element() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for Element()
            /// </summary>
            public static Element CreatePoolableInstance()
            {
                return JVMBridgeBase.New<Element>();
            }
