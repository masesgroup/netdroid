...
namespace Android.Sax
{
    ...
    public partial class ElementListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ElementListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ElementListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasElementListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasElementListenerSecondGate;
        ...
        /// <item><see cref="_hasElementListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasElementListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ElementListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ElementListener"/> instead.</para>
    /// </remarks>
    public partial class ElementListenerDirect : ElementListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public ElementListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ElementListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class ElementListener : Android.Sax.IElementListener, Android.Sax.IEndElementListener, Android.Sax.IStartElementListener
    {
        ...
        {
            _EndEventHandlerIndex = AddEventHandler("end", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(EndEventHandler));
            _hasOverrideEnd = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(End));
            _StartEventHandlerIndex = AddEventHandler("start", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(StartEventHandler));
            _hasOverrideStart = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Start), typeof(Org.Xml.Sax.Attributes));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _EndEventHandlerIndex) return EndEventOverridden();
            if (eventIndex == _StartEventHandlerIndex) return StartEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="End"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _EndEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="End"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideEnd;
        ...
        bool EndEventOverridden() => _hasOverrideEnd || OnEnd != null;
        
        void EndEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!EndEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = EndEventOverridden();
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="Start"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _StartEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="Start"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideStart;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool StartEventOverridden() => _hasOverrideStart || OnStart != null;
        
        void StartEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!StartEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            data.EventData.HasOverride = StartEventOverridden();
        }
