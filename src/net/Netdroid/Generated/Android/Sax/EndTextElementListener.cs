...
{
    #region EndTextElementListener declaration
    /// <summary>
    ...
    public partial class EndTextElementListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public EndTextElementListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public EndTextElementListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasEndTextElementListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasEndTextElementListenerSecondGate;
        ...
        /// <item><see cref="_hasEndTextElementListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasEndTextElementListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    #region EndTextElementListenerDirect declaration
    /// <summary>
    /// Concrete CLR representation of <see cref="EndTextElementListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="EndTextElementListener"/> instead.</para>
    /// </remarks>
    public partial class EndTextElementListenerDirect : EndTextElementListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public EndTextElementListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public EndTextElementListenerDirect(params object[] args) : base(args) { }
    ...
    #region EndTextElementListener implementation
    ...
    #region EndTextElementListenerDirect implementation
