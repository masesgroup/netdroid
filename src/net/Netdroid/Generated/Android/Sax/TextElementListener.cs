...
namespace Android.Sax
{
    ...
    public partial class TextElementListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public TextElementListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasTextElementListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasTextElementListenerSecondGate;
        ...
        /// <item><see cref="_hasTextElementListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasTextElementListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="TextElementListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="TextElementListener"/> instead.</para>
    /// </remarks>
    public partial class TextElementListenerDirect : TextElementListener
    {
        ...
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public TextElementListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class TextElementListener : Android.Sax.ITextElementListener, Android.Sax.IEndTextElementListener, Android.Sax.IStartElementListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideEnd = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(End), typeof(Java.Lang.String));
