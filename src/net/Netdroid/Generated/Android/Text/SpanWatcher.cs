...
{
    #region SpanWatcher declaration
    /// <summary>
    ...
    public partial class SpanWatcher : Android.Text.NoCopySpan
    {
        ...
        public SpanWatcher(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region ISpanWatcher
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/android/text/SpanWatcher.html"/>
    /// </summary>
    ...
    #region SpanWatcher implementation
