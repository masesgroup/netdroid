...
namespace Android.Text.Util
{
    ...
    public partial class Rfc822Tokenizer : Android.Widget.MultiAutoCompleteTextView.Tokenizer
    {
        ...
        public Rfc822Tokenizer(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class Rfc822Tokenizer
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/util/Rfc822Tokenizer.html#%3Cinit%3E()"/>
        /// </summary>
        public Rfc822Tokenizer() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for Rfc822Tokenizer()
        /// </summary>
        public static Rfc822Tokenizer CreatePoolableInstance()
        {
            return JVMBridgeBase.New<Rfc822Tokenizer>();
        }
