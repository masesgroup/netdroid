...
namespace Android.Text
{
    ...
    public partial class TextPaint : Android.Graphics.Paint
    {
        ...
        public TextPaint(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class TextPaint
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/TextPaint.html#%3Cinit%3E()"/>
        /// </summary>
        public TextPaint() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for TextPaint()
        /// </summary>
        public static TextPaint CreatePoolableInstance()
        {
            return JVMBridgeBase.New<TextPaint>();
        }
        /// <summary>
        ...
        public TextPaint(Android.Graphics.Paint arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for TextPaint(Android.Graphics.Paint arg0)
        /// </summary>
        public static TextPaint CreatePoolableInstance(Android.Graphics.Paint arg0)
        {
            return JVMBridgeBase.New<TextPaint>(arg0);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/TextPaint.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public TextPaint(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for TextPaint(int arg0)
        /// </summary>
        public static TextPaint CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<TextPaint>(arg0);
        }
