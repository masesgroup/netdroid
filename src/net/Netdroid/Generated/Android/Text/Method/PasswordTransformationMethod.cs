...
namespace Android.Text.Method
{
    ...
    public partial class PasswordTransformationMethod : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PasswordTransformationMethod>
    {
        ...
        public PasswordTransformationMethod(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class PasswordTransformationMethod : Android.Text.ITextWatcher, Android.Text.Method.ITransformationMethod
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/PasswordTransformationMethod.html#%3Cinit%3E()"/>
        /// </summary>
        public PasswordTransformationMethod() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for PasswordTransformationMethod()
        /// </summary>
        public static PasswordTransformationMethod CreatePoolableInstance()
        {
            return JVMBridgeBase.New<PasswordTransformationMethod>();
        }
