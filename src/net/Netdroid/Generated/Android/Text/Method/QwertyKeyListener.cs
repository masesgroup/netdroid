...
namespace Android.Text.Method
{
    ...
    public partial class QwertyKeyListener
    {
        #region Constructors
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#getInstance(boolean,android.text.method.TextKeyListener.Capitalize)"/>
        /// </summary>
        /// <remarks>If <see cref="OnGetInstance"/> has a value it takes precedence over corresponding class method</remarks>
        public System.Func<bool, Android.Text.Method.TextKeyListener.Capitalize, Android.Text.Method.QwertyKeyListener> OnGetInstance { get; set; } = null;

        void GetInstanceEventHandler(object sender, CLRListenerEventArgs<CLREventData<bool>> data)
        {
        ...
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#getInstance(boolean,android.text.method.TextKeyListener.Capitalize)"/>
        /// </summary>
        /// <param name="arg0"><see cref="bool"/></param>
        /// <param name="arg1"><see cref="Android.Text.Method.TextKeyListener.Capitalize"/></param>
        /// <returns><see cref="Android.Text.Method.QwertyKeyListener"/></returns>
        public virtual Android.Text.Method.QwertyKeyListener GetInstance(bool arg0, Android.Text.Method.TextKeyListener.Capitalize arg1)
        {
            return default;
        }

        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#getInstanceForFullKeyboard()"/>
        /// </summary>
        /// <remarks>If <see cref="OnGetInstanceForFullKeyboard"/> has a value it takes precedence over corresponding class method</remarks>
        public System.Func<Android.Text.Method.QwertyKeyListener> OnGetInstanceForFullKeyboard { get; set; } = null;

        void GetInstanceForFullKeyboardEventHandler(object sender, CLRListenerEventArgs<CLREventData> data)
        {
            var methodToExecute = (OnGetInstanceForFullKeyboard != null) ? OnGetInstanceForFullKeyboard : GetInstanceForFullKeyboard;
            var executionResult = methodToExecute.Invoke();
            data.SetReturnValue(executionResult);
        }

        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#getInstanceForFullKeyboard()"/>
        /// </summary>
        /// <returns><see cref="Android.Text.Method.QwertyKeyListener"/></returns>
        public virtual Android.Text.Method.QwertyKeyListener GetInstanceForFullKeyboard()
        {
            return default;
        }
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#markAsReplaced(android.text.Spannable,int,int,java.lang.String)"/>
        /// </summary>
        /// <remarks>If <see cref="OnMarkAsReplaced"/> has a value it takes precedence over corresponding class method</remarks>
        public System.Action<Android.Text.Spannable, int, int, Java.Lang.String> OnMarkAsReplaced { get; set; } = null;

        void MarkAsReplacedEventHandler(object sender, CLRListenerEventArgs<CLREventData<Android.Text.Spannable>> data)
        {
            var methodToExecute = (OnMarkAsReplaced != null) ? OnMarkAsReplaced : MarkAsReplaced;
            methodToExecute.Invoke(data.EventData.TypedEventData, data.EventData.GetAt<int>(0), data.EventData.GetAt<int>(1), data.EventData.GetAt<Java.Lang.String>(2));
        }

        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/QwertyKeyListener.html#markAsReplaced(android.text.Spannable,int,int,java.lang.String)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Text.Spannable"/></param>
        /// <param name="arg1"><see cref="int"/></param>
        /// <param name="arg2"><see cref="int"/></param>
        /// <param name="arg3"><see cref="Java.Lang.String"/></param>
        public virtual void MarkAsReplaced(Android.Text.Spannable arg0, int arg1, int arg2, Java.Lang.String arg3)
        {
        ...
        /// <summary>
        /// Handlers initializer for <see cref="QwertyKeyListener"/>
        /// </summary>
    ...
    public partial class QwertyKeyListenerDirect
    {
        #region Constructors
