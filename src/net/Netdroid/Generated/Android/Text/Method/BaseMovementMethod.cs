...
namespace Android.Text.Method
{
    ...
    public partial class BaseMovementMethod : Android.Text.Method.MovementMethod
    {
        ...
        public BaseMovementMethod(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class BaseMovementMethod
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/BaseMovementMethod.html#%3Cinit%3E()"/>
        /// </summary>
        public BaseMovementMethod() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<BaseMovementMethod>();
        }
        ...
        {
            return IExecuteWithSignature<bool>("nextParagraph", "(Landroid/widget/TextView;Landroid/text/Spannable;)Z", arg0, arg1);
        }
        /// <summary>
        ...
        {
            return IExecuteWithSignature<bool>("previousParagraph", "(Landroid/widget/TextView;Landroid/text/Spannable;)Z", arg0, arg1);
        }
        /// <summary>
