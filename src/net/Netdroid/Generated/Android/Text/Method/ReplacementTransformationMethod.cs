...
{
    #region ReplacementTransformationMethod declaration
    /// <summary>
    ...
    public partial class ReplacementTransformationMethod : Android.Text.Method.TransformationMethod
    {
        ...
        public ReplacementTransformationMethod(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region ReplacementTransformationMethod implementation
    public partial class ReplacementTransformationMethod
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/method/ReplacementTransformationMethod.html#%3Cinit%3E()"/>
        /// </summary>
        public ReplacementTransformationMethod() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ReplacementTransformationMethod()
        /// </summary>
        public static ReplacementTransformationMethod CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ReplacementTransformationMethod>();
        }
