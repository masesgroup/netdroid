...
namespace Android.Text.Method
{
    ...
    public partial class DateKeyListener
    {
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/text/method/DateKeyListener.html#getInstance()"/>
        /// </summary>
        /// <remarks>If <see cref="OnGetInstance"/> has a value it takes precedence over corresponding class method</remarks>
        public System.Func<Android.Text.Method.DateKeyListener> OnGetInstance { get; set; } = null;
        ...
        [System.Obsolete()]
        public virtual Android.Text.Method.DateKeyListener GetInstance()
        {
            return default;
        }

        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/text/method/DateKeyListener.html#getInstance(java.util.Locale)"/>
        /// </summary>
        /// <remarks>If <see cref="OnGetInstance1"/> has a value it takes precedence over corresponding class method</remarks>
        public System.Func<Java.Util.Locale, Android.Text.Method.DateKeyListener> OnGetInstance1 { get; set; } = null;
        ...
        /// <returns><see cref="Android.Text.Method.DateKeyListener"/></returns>
        public virtual Android.Text.Method.DateKeyListener GetInstance(Java.Util.Locale arg0)
        {
            return default;
        }
        ...
        /// <summary>
        /// Handlers initializer for <see cref="DateKeyListener"/>
        /// </summary>
        protected virtual void InitializeHandlers()
        {
            ...
            AddEventHandler("filter", new System.EventHandler<CLRListenerEventArgs<CLREventData<Java.Lang.CharSequence>>>(FilterEventHandler));
        ...
        public System.Func<Java.Lang.CharSequence, int, int, Android.Text.Spanned, int, int, Java.Lang.CharSequence> OnFilter { get; set; } = null;

        void FilterEventHandler(object sender, CLRListenerEventArgs<CLREventData<Java.Lang.CharSequence>> data)
        {
            var methodToExecute = (OnFilter != null) ? OnFilter : Filter;
            var executionResult = methodToExecute.Invoke(data.EventData.TypedEventData, data.EventData.GetAt<int>(0), data.EventData.GetAt<int>(1), data.EventData.GetAt<Android.Text.Spanned>(2), data.EventData.GetAt<int>(3), data.EventData.GetAt<int>(4));
            data.SetReturnValue(executionResult);
        }
    ...
    public partial class DateKeyListenerDirect
    {
        #region Constructors
