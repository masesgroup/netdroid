...
namespace Android.Text
{
    ...
    public partial class Spannable : Android.Text.Spanned
    {
        ...
        public Spannable(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region ISpannable
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/android/text/Spannable.html"/>
    /// </summary>
    ...
    public partial class Spannable : Android.Text.ISpannable
    {
        ...
        public partial class Factory
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/text/Spannable.Factory.html#%3Cinit%3E()"/>
            /// </summary>
            public Factory() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for Factory()
            /// </summary>
            public static Factory CreatePoolableInstance()
            {
                return JVMBridgeBase.New<Factory>();
            }
