...
namespace Android.Text
{
    ...
    public partial class Highlights
    {
        ...
        public partial class Builder
        {
            ...
            {
                if (arg1.Length == 0) return IExecuteWithSignature<Android.Text.Highlights.Builder>("addRanges", "(Landroid/graphics/Paint;[I)Landroid/text/Highlights$Builder;", arg0); else return IExecuteWithSignature<Android.Text.Highlights.Builder>("addRanges", "(Landroid/graphics/Paint;[I)Landroid/text/Highlights$Builder;", arg0, arg1);
            }
