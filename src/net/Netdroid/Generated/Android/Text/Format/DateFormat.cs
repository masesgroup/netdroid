...
namespace Android.Text.Format
{
    ...
    public partial class DateFormat
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/format/DateFormat.html#%3Cinit%3E()"/>
        /// </summary>
        public DateFormat() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DateFormat()
        /// </summary>
        public static DateFormat CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DateFormat>();
        }
