...
namespace Android.Text.Style
{
    ...
    public partial class LeadingMarginSpan : Android.Text.Style.ILeadingMarginSpan
    {
        ...
        public partial class Standard : Android.Text.Style.ILeadingMarginSpan, Android.Text.IParcelableSpan
        {
            ...
            public Standard(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Standard(Android.Os.Parcel arg0)
            /// </summary>
            public static Standard CreatePoolableInstance(Android.Os.Parcel arg0)
            {
                return JVMBridgeBase.New<Standard>(arg0);
            }
            /// <summary>
            ...
            public Standard(int arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0, arg1);
            }
            /// <summary>
            /// HPA initializer for Standard(int arg0, int arg1)
            /// </summary>
            public static Standard CreatePoolableInstance(int arg0, int arg1)
            {
                return JVMBridgeBase.New<Standard>(arg0, arg1);
            }
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/text/style/LeadingMarginSpan.Standard.html#%3Cinit%3E(int)"/>
            /// </summary>
            /// <param name="arg0"><see cref="int"/></param>
            public Standard(int arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Standard(int arg0)
            /// </summary>
            public static Standard CreatePoolableInstance(int arg0)
            {
                return JVMBridgeBase.New<Standard>(arg0);
            }
