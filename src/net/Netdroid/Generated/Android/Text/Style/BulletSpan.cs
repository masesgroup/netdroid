...
namespace Android.Text.Style
{
    ...
    public partial class BulletSpan : MASES.JCOBridge.C2JBridge.JVMBridgeBase<BulletSpan>
    {
        ...
        public BulletSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class BulletSpan : Android.Text.Style.ILeadingMarginSpan, Android.Text.IParcelableSpan
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/BulletSpan.html#%3Cinit%3E()"/>
        /// </summary>
        public BulletSpan() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for BulletSpan()
        /// </summary>
        public static BulletSpan CreatePoolableInstance()
        {
            return JVMBridgeBase.New<BulletSpan>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/BulletSpan.html#%3Cinit%3E(android.os.Parcel)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Os.Parcel"/></param>
        public BulletSpan(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for BulletSpan(Android.Os.Parcel arg0)
        /// </summary>
        public static BulletSpan CreatePoolableInstance(Android.Os.Parcel arg0)
        {
            return JVMBridgeBase.New<BulletSpan>(arg0);
        }
        /// <summary>
        ...
        public BulletSpan(int arg0, int arg1, int arg2) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1, arg2);
        }
        /// <summary>
        /// HPA initializer for BulletSpan(int arg0, int arg1, int arg2)
        /// </summary>
        public static BulletSpan CreatePoolableInstance(int arg0, int arg1, int arg2)
        {
            return JVMBridgeBase.New<BulletSpan>(arg0, arg1, arg2);
        }
        /// <summary>
        ...
        /// <param name="arg0"><see cref="int"/></param>
        /// <param name="arg1"><see cref="int"/></param>
        public BulletSpan(int arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for BulletSpan(int arg0, int arg1)
        /// </summary>
        public static BulletSpan CreatePoolableInstance(int arg0, int arg1)
        {
            return JVMBridgeBase.New<BulletSpan>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/BulletSpan.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public BulletSpan(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for BulletSpan(int arg0)
        /// </summary>
        public static BulletSpan CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<BulletSpan>(arg0);
        }
        ...
        /// </summary>
        public static int STANDARD_GAP_WIDTH { get { return SGetField<int>(LocalBridgeClazz, "STANDARD_GAP_WIDTH"); } set { SSetField(LocalBridgeClazz, "STANDARD_GAP_WIDTH", value); } }
