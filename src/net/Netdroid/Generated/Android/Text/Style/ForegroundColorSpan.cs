...
{
    #region ForegroundColorSpan declaration
    /// <summary>
    ...
    public partial class ForegroundColorSpan : Android.Text.Style.CharacterStyle
    {
        ...
        public ForegroundColorSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ForegroundColorSpan : Android.Text.IParcelableSpan, Android.Text.Style.IUpdateAppearance
    {
        ...
        public ForegroundColorSpan(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ForegroundColorSpan(Android.Os.Parcel arg0)
        /// </summary>
        public static ForegroundColorSpan CreatePoolableInstance(Android.Os.Parcel arg0)
        {
            return JVMBridgeBase.New<ForegroundColorSpan>(arg0);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/ForegroundColorSpan.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public ForegroundColorSpan(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for ForegroundColorSpan(int arg0)
        /// </summary>
        public static ForegroundColorSpan CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<ForegroundColorSpan>(arg0);
        }
