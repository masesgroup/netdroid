...
namespace Android.Text.Style
{
    ...
    public partial class ReplacementSpan : Android.Text.Style.MetricAffectingSpan
    {
        ...
        public ReplacementSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ReplacementSpan
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/ReplacementSpan.html#%3Cinit%3E()"/>
        /// </summary>
        public ReplacementSpan() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ReplacementSpan()
        /// </summary>
        public static ReplacementSpan CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ReplacementSpan>();
        }
