...
namespace Android.Text.Style
{
    ...
    public partial class CharacterStyle
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/CharacterStyle.html#%3Cinit%3E()"/>
        /// </summary>
        public CharacterStyle() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for CharacterStyle()
        /// </summary>
        public static CharacterStyle CreatePoolableInstance()
        {
            return JVMBridgeBase.New<CharacterStyle>();
        }
