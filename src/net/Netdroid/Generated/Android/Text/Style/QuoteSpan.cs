...
namespace Android.Text.Style
{
    ...
    public partial class QuoteSpan : MASES.JCOBridge.C2JBridge.JVMBridgeBase<QuoteSpan>
    {
        ...
        public QuoteSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class QuoteSpan : Android.Text.Style.ILeadingMarginSpan, Android.Text.IParcelableSpan
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/QuoteSpan.html#%3Cinit%3E()"/>
        /// </summary>
        public QuoteSpan() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for QuoteSpan()
        /// </summary>
        public static QuoteSpan CreatePoolableInstance()
        {
            return JVMBridgeBase.New<QuoteSpan>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/QuoteSpan.html#%3Cinit%3E(android.os.Parcel)"/>
        /// </summary>
        /// <param name="arg0"><see cref="Android.Os.Parcel"/></param>
        public QuoteSpan(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for QuoteSpan(Android.Os.Parcel arg0)
        /// </summary>
        public static QuoteSpan CreatePoolableInstance(Android.Os.Parcel arg0)
        {
            return JVMBridgeBase.New<QuoteSpan>(arg0);
        }
        /// <summary>
        ...
        public QuoteSpan(int arg0, int arg1, int arg2) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1, arg2);
        }
        /// <summary>
        /// HPA initializer for QuoteSpan(int arg0, int arg1, int arg2)
        /// </summary>
        public static QuoteSpan CreatePoolableInstance(int arg0, int arg1, int arg2)
        {
            return JVMBridgeBase.New<QuoteSpan>(arg0, arg1, arg2);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/QuoteSpan.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public QuoteSpan(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for QuoteSpan(int arg0)
        /// </summary>
        public static QuoteSpan CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<QuoteSpan>(arg0);
        }
        ...
        /// </summary>
        public static int STANDARD_COLOR { get { return SGetField<int>(LocalBridgeClazz, "STANDARD_COLOR"); } set { SSetField(LocalBridgeClazz, "STANDARD_COLOR", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/QuoteSpan.html#STANDARD_GAP_WIDTH_PX"/>
        /// </summary>
        public static int STANDARD_GAP_WIDTH_PX { get { return SGetField<int>(LocalBridgeClazz, "STANDARD_GAP_WIDTH_PX"); } set { SSetField(LocalBridgeClazz, "STANDARD_GAP_WIDTH_PX", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/QuoteSpan.html#STANDARD_STRIPE_WIDTH_PX"/>
        /// </summary>
        public static int STANDARD_STRIPE_WIDTH_PX { get { return SGetField<int>(LocalBridgeClazz, "STANDARD_STRIPE_WIDTH_PX"); } set { SSetField(LocalBridgeClazz, "STANDARD_STRIPE_WIDTH_PX", value); } }
