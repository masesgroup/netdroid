...
namespace Android.Text.Style
{
    ...
    public partial class AlignmentSpan : Android.Text.Style.ParagraphStyle
    {
        ...
        public AlignmentSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/android/text/style/AlignmentSpan.html"/>
    /// </summary>
    ...
    public partial class AlignmentSpan : Android.Text.Style.IAlignmentSpan
    {
        ...
        public partial class Standard : Android.Text.Style.IAlignmentSpan, Android.Text.IParcelableSpan
        {
            ...
            public Standard(Android.Text.Layout.Alignment arg0) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0);
            }
            /// <summary>
            /// HPA initializer for Standard(Android.Text.Layout.Alignment arg0)
            /// </summary>
            public static Standard CreatePoolableInstance(Android.Text.Layout.Alignment arg0)
            {
                return JVMBridgeBase.New<Standard>(arg0);
            }
