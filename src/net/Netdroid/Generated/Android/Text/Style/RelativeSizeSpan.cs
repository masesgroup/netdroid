...
namespace Android.Text.Style
{
    ...
    public partial class RelativeSizeSpan
    {
        ...
        public RelativeSizeSpan(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for RelativeSizeSpan(Android.Os.Parcel arg0)
        /// </summary>
        public static RelativeSizeSpan CreatePoolableInstance(Android.Os.Parcel arg0)
        {
            return JVMBridgeBase.New<RelativeSizeSpan>(arg0);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/RelativeSizeSpan.html#%3Cinit%3E(float)"/>
        /// </summary>
        /// <param name="arg0"><see cref="float"/></param>
        public RelativeSizeSpan(float arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for RelativeSizeSpan(float arg0)
        /// </summary>
        public static RelativeSizeSpan CreatePoolableInstance(float arg0)
        {
            return JVMBridgeBase.New<RelativeSizeSpan>(arg0);
        }
