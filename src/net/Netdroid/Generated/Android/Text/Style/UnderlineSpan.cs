...
namespace Android.Text.Style
{
    ...
    public partial class UnderlineSpan : Android.Text.Style.CharacterStyle
    {
        ...
        public UnderlineSpan(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class UnderlineSpan : Android.Text.IParcelableSpan, Android.Text.Style.IUpdateAppearance
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/text/style/UnderlineSpan.html#%3Cinit%3E()"/>
        /// </summary>
        public UnderlineSpan() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for UnderlineSpan()
        /// </summary>
        public static UnderlineSpan CreatePoolableInstance()
        {
            return JVMBridgeBase.New<UnderlineSpan>();
        }
        /// <summary>
        ...
        public UnderlineSpan(Android.Os.Parcel arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for UnderlineSpan(Android.Os.Parcel arg0)
        /// </summary>
        public static UnderlineSpan CreatePoolableInstance(Android.Os.Parcel arg0)
        {
            return JVMBridgeBase.New<UnderlineSpan>(arg0);
        }
