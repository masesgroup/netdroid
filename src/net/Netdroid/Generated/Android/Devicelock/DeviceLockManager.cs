...
namespace Android.Devicelock
{
    ...
    public partial class DeviceLockManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DeviceLockManager>
    {
        ...
        public DeviceLockManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DeviceLockManager
    {
        ...
        /// </summary>
        public static int DEVICE_LOCK_ROLE_FINANCING { get { return SGetField<int>(LocalBridgeClazz, "DEVICE_LOCK_ROLE_FINANCING"); } set { SSetField(LocalBridgeClazz, "DEVICE_LOCK_ROLE_FINANCING", value); } }
