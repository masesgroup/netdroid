...
namespace Android.App
{
    ...
    public partial class FragmentBreadCrumbs : Android.View.ViewGroup
    {
        ...
        public FragmentBreadCrumbs(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class OnBreadCrumbClickListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public OnBreadCrumbClickListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnBreadCrumbClickListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasOnBreadCrumbClickListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasOnBreadCrumbClickListenerSecondGate;
            ...
            /// <item><see cref="_hasOnBreadCrumbClickListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasOnBreadCrumbClickListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="OnBreadCrumbClickListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="OnBreadCrumbClickListener"/> instead.</para>
        /// </remarks>
        public partial class OnBreadCrumbClickListenerDirect : OnBreadCrumbClickListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnBreadCrumbClickListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnBreadCrumbClickListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class FragmentBreadCrumbs
    {
        ...
        [global::System.Obsolete("Deprecated in JVM")]
        public FragmentBreadCrumbs(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1, arg2);
        }
        /// <summary>
        /// HPA initializer for FragmentBreadCrumbs(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2)
        /// </summary>
        public static FragmentBreadCrumbs CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1, int arg2)
        {
            return JVMBridgeBase.New<FragmentBreadCrumbs>(arg0, arg1, arg2);
        }
        /// <summary>
        ...
        /// <param name="arg1"><see cref="Android.Util.AttributeSet"/></param>
        [global::System.Obsolete("Deprecated in JVM")]
        public FragmentBreadCrumbs(Android.Content.Context arg0, Android.Util.AttributeSet arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for FragmentBreadCrumbs(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        /// </summary>
        public static FragmentBreadCrumbs CreatePoolableInstance(Android.Content.Context arg0, Android.Util.AttributeSet arg1)
        {
            return JVMBridgeBase.New<FragmentBreadCrumbs>(arg0, arg1);
        }
        /// <summary>
        ...
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        [global::System.Obsolete("Deprecated in JVM")]
        public FragmentBreadCrumbs(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for FragmentBreadCrumbs(Android.Content.Context arg0)
        /// </summary>
        public static FragmentBreadCrumbs CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<FragmentBreadCrumbs>(arg0);
        }
        ...
        {
            IExecuteWithSignature("setTitle", "(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V", arg0, arg1);
        }
        ...
        public partial class OnBreadCrumbClickListener
        {
            ...
            {
                _OnBreadCrumbClickEventHandlerIndex = AddEventHandler("onBreadCrumbClick", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnBreadCrumbClickEventHandler));
                _hasOverrideOnBreadCrumbClick = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnBreadCrumbClick), typeof(Android.App.FragmentManager.BackStackEntry), typeof(int));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnBreadCrumbClickEventHandlerIndex) return OnBreadCrumbClickEventOverridden();
            ...
            /// </summary>
            /// <remarks>Set <see cref="OnOnBreadCrumbClickDispose"/> when the event handler returns a JVM-backed object
            ...
            public global::System.Action<bool> OnOnBreadCrumbClickDispose { get; set; } = null;
            
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnBreadCrumbClick"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnBreadCrumbClickEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnBreadCrumbClick"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnBreadCrumbClick;
            ...
            bool OnBreadCrumbClickEventOverridden() => _hasOverrideOnBreadCrumbClick || OnOnBreadCrumbClick != null;
            
            void OnBreadCrumbClickEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnBreadCrumbClickEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.SetReturnData(OnBreadCrumbClickEventOverridden(), executionResult);
                OnOnBreadCrumbClickDispose?.Invoke(executionResult);
            }
        ...
        public partial class OnBreadCrumbClickListenerDirect
        {
            ...
            {
                return IExecuteWithSignature<bool>("onBreadCrumbClick", "(Landroid/app/FragmentManager$BackStackEntry;I)Z", arg0, arg1);
            }
