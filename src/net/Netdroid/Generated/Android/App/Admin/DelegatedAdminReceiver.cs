...
namespace Android.App.Admin
{
    ...
    public partial class DelegatedAdminReceiver : Android.Content.BroadcastReceiver
    {
        ...
        public DelegatedAdminReceiver(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class DelegatedAdminReceiver
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/admin/DelegatedAdminReceiver.html#%3Cinit%3E()"/>
        /// </summary>
        public DelegatedAdminReceiver() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DelegatedAdminReceiver()
        /// </summary>
        public static DelegatedAdminReceiver CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DelegatedAdminReceiver>();
        }
