...
namespace Android.App.Admin
{
    ...
    public partial class DevicePolicyResourcesManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DevicePolicyResourcesManager>
    {
        ...
        public DevicePolicyResourcesManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class DevicePolicyResourcesManager
    {
        ...
        {
            return IExecuteWithSignature<Java.Lang.String>("getString", "(Ljava/lang/String;Ljava/util/function/Supplier;[Ljava/lang/Object;)Ljava/lang/String;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg2, arg0, arg1));
        }
        /// <summary>
