...
namespace Android.App
{
    ...
    public partial class AppComponentFactory : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AppComponentFactory>
    {
        ...
        public AppComponentFactory(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AppComponentFactory
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/AppComponentFactory.html#%3Cinit%3E()"/>
        /// </summary>
        public AppComponentFactory() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<AppComponentFactory>();
        }
