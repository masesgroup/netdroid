...
namespace Android.App
{
    ...
    #region ComponentCaller
    /// <summary>
    /// <see href="https://developer.android.com/reference/android/app/ComponentCaller.html"/>
    /// </summary>
    public partial class ComponentCaller : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ComponentCaller>
    {
        const string _bridgeClassName = "android.app.ComponentCaller";
        /// <summary>
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        ...
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public ComponentCaller(params object[] args) : base(args) { }
