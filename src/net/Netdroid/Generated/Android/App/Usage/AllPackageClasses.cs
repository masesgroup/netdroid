...
namespace Android.App.Usage
{
    ...
    public partial class NetworkStatsManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<NetworkStatsManager>
    {
        ...
        public partial class UsageCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UsageCallback>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("UsageCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
