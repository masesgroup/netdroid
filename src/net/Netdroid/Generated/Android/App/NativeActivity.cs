...
namespace Android.App
{
    ...
    public partial class NativeActivity : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public NativeActivity(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public NativeActivity(params object[] args) : base(args)
        {
            ...
            _hasNativeActivitySecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasNativeActivitySecondGate;
        ...
        /// <item><see cref="_hasNativeActivitySecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasNativeActivitySecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="NativeActivity"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="NativeActivity"/> instead.</para>
    /// </remarks>
    public partial class NativeActivityDirect : NativeActivity
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public NativeActivityDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public NativeActivityDirect(params object[] args) : base(args) { }
    ...
    public partial class NativeActivity
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/NativeActivity.html#%3Cinit%3E()"/>
        /// </summary>
        public NativeActivity() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        ...
        /// </summary>
        public static Java.Lang.String META_DATA_FUNC_NAME { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "META_DATA_FUNC_NAME"); } set { SSetField(LocalBridgeClazz, "META_DATA_FUNC_NAME", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/NativeActivity.html#META_DATA_LIB_NAME"/>
        /// </summary>
        public static Java.Lang.String META_DATA_LIB_NAME { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "META_DATA_LIB_NAME"); } set { SSetField(LocalBridgeClazz, "META_DATA_LIB_NAME", value); } }
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _OnInputQueueCreatedEventHandlerIndex = AddEventHandler("onInputQueueCreated", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnInputQueueCreatedEventHandler));
            _hasOverrideOnInputQueueCreated = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnInputQueueCreated), typeof(Android.View.InputQueue));
            _OnInputQueueDestroyedEventHandlerIndex = AddEventHandler("onInputQueueDestroyed", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnInputQueueDestroyedEventHandler));
            _hasOverrideOnInputQueueDestroyed = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnInputQueueDestroyed), typeof(Android.View.InputQueue));
        ...
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            ...
            if (eventIndex == _OnInputQueueCreatedEventHandlerIndex) return OnInputQueueCreatedEventOverridden();
            if (eventIndex == _OnInputQueueDestroyedEventHandlerIndex) return OnInputQueueDestroyedEventOverridden();
        ...
        {
            IExecuteWithSignature("surfaceRedrawNeededAsync", "(Landroid/view/SurfaceHolder;Ljava/lang/Runnable;)V", arg0, arg1);
        }
        /// <summary>
        ...
        {
            IExecuteWithSignature("onGlobalLayoutBase", "()V");
        }
        ...
        /// <see href="https://developer.android.com/reference/android/app/NativeActivity.html#onGlobalLayout()"/>
        /// </summary>
        /// <remarks>The method invokes the default implementation in the JVM interface using <see cref="OnGlobalLayoutBase"/>; override the method to implement a different behavior</remarks>
        ...
        {
            IExecuteWithSignature("onInputQueueCreatedBase", "(Landroid/view/InputQueue;)V", arg0);
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnInputQueueCreated"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnInputQueueCreatedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnInputQueueCreated"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnInputQueueCreated;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool OnInputQueueCreatedEventOverridden() => _hasOverrideOnInputQueueCreated || OnOnInputQueueCreated != null;
        
        void OnInputQueueCreatedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnInputQueueCreatedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            data.EventData.HasOverride = OnInputQueueCreatedEventOverridden();
        }
        ...
        /// </summary>
        /// <param name="arg0"><see cref="Android.View.InputQueue"/></param>
        /// <remarks>The method invokes the default implementation in the JVM interface using <see cref="OnInputQueueCreatedBase"/>; override the method to implement a different behavior</remarks>
        ...
        {
            IExecuteWithSignature("onInputQueueDestroyedBase", "(Landroid/view/InputQueue;)V", arg0);
        }
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnInputQueueDestroyed"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnInputQueueDestroyedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnInputQueueDestroyed"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnInputQueueDestroyed;
        
        /// <summary>Returns <see langword="true"/> if this event has an active handler — either a delegate assignment or a virtual method override. Used by <see cref="ListenerShallManageEvent(int)"/> to discard events with no registered handler without reading JVM argument data.</summary>
        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        bool OnInputQueueDestroyedEventOverridden() => _hasOverrideOnInputQueueDestroyed || OnOnInputQueueDestroyed != null;
        
        void OnInputQueueDestroyedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnInputQueueDestroyedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.HasOverride is false by default — JVM receives no return value.
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Android.View.InputQueue>(0));
            data.EventData.HasOverride = OnInputQueueDestroyedEventOverridden();
        }
        ...
        /// </summary>
        /// <param name="arg0"><see cref="Android.View.InputQueue"/></param>
        /// <remarks>The method invokes the default implementation in the JVM interface using <see cref="OnInputQueueDestroyedBase"/>; override the method to implement a different behavior</remarks>
