...
namespace Android.App.Backup
{
    ...
    public partial class BackupManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<BackupManager>
    {
        ...
        public BackupManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class BackupManager
    {
        ...
        public BackupManager(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for BackupManager(Android.Content.Context arg0)
        /// </summary>
        public static BackupManager CreatePoolableInstance(Android.Content.Context arg0)
        {
            return JVMBridgeBase.New<BackupManager>(arg0);
        }
