...
namespace Android.App.Assist
{
    ...
    public partial class AssistContent : Android.Os.Parcelable
    {
        ...
        public AssistContent(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AssistContent
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/assist/AssistContent.html#%3Cinit%3E()"/>
        /// </summary>
        public AssistContent() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AssistContent()
        /// </summary>
        public static AssistContent CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AssistContent>();
        }
        ...
        /// </summary>
        public static Java.Lang.String EXTRA_APP_FUNCTION_DATA { get { return SGetField<Java.Lang.String>(LocalBridgeClazz, "EXTRA_APP_FUNCTION_DATA"); } set { SSetField(LocalBridgeClazz, "EXTRA_APP_FUNCTION_DATA", value); } }
