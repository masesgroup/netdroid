...
namespace Android.App.Sdksandbox
{
    ...
    public partial class SandboxedSdkProvider : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SandboxedSdkProvider>
    {
        ...
        public SandboxedSdkProvider(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SandboxedSdkProvider
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/app/sdksandbox/SandboxedSdkProvider.html#%3Cinit%3E()"/>
        /// </summary>
        public SandboxedSdkProvider() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for SandboxedSdkProvider()
        /// </summary>
        public static SandboxedSdkProvider CreatePoolableInstance()
        {
            return JVMBridgeBase.New<SandboxedSdkProvider>();
        }
