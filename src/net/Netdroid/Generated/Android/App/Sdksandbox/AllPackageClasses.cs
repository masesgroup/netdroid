...
namespace Android.App.Sdksandbox
{
    ...
    public partial class SandboxedSdkProvider : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SandboxedSdkProvider>
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("SandboxedSdkProvider class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
    ...
    public partial class SdkSandboxManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SdkSandboxManager>
    {
        ...
        public partial class SdkSandboxProcessDeathCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SdkSandboxProcessDeathCallback>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("SdkSandboxProcessDeathCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
