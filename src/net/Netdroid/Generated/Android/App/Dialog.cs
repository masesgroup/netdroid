...
namespace Android.App
{
    ...
    public partial class Dialog : Android.Content.IDialogInterface
    {
        ...
        public Dialog(Android.Content.Context arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for Dialog(Android.Content.Context arg0, int arg1)
        /// </summary>
        public static Dialog CreatePoolableInstance(Android.Content.Context arg0, int arg1)
        {
        ...
        /// </summary>
        /// <param name="arg0"><see cref="Android.Content.Context"/></param>
        public Dialog(Android.Content.Context arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for Dialog(Android.Content.Context arg0)
        /// </summary>
        public static Dialog CreatePoolableInstance(Android.Content.Context arg0)
        {
