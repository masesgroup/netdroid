...
namespace Android.Hardware
{
    ...
    public partial class SensorEventCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SensorEventCallback>
    {
        ...
        public SensorEventCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class SensorEventCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/hardware/SensorEventCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public SensorEventCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<SensorEventCallback>();
        }
