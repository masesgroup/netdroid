...
namespace Android.Hardware.Camera2
{
    ...
    public partial class CameraManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CameraManager>
    {
        ...
        public CameraManager(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class AvailabilityCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AvailabilityCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public AvailabilityCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class TorchCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<TorchCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public TorchCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class CameraManager
    {
        ...
        public partial class AvailabilityCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/hardware/camera2/CameraManager.AvailabilityCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public AvailabilityCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for AvailabilityCallback()
            /// </summary>
            public static AvailabilityCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<AvailabilityCallback>();
            }
        ...
        public partial class TorchCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/hardware/camera2/CameraManager.TorchCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public TorchCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for TorchCallback()
            /// </summary>
            public static TorchCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<TorchCallback>();
            }
