...
namespace Android.Hardware
{
    ...
    public partial class DisplayLuts
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/hardware/DisplayLuts.html#%3Cinit%3E()"/>
        /// </summary>
        public DisplayLuts() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for DisplayLuts()
        /// </summary>
        public static DisplayLuts CreatePoolableInstance()
        {
            return JVMBridgeBase.New<DisplayLuts>();
        }
        ...
        public partial class Entry
        {
            ...
            public Entry(float[] arg0, int arg1, int arg2) : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer(arg0, arg1, arg2);
            }
            /// <summary>
            /// HPA initializer for Entry(float[] arg0, int arg1, int arg2)
            /// </summary>
            public static Entry CreatePoolableInstance(float[] arg0, int arg1, int arg2)
            {
