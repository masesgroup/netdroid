...
namespace Android.Hardware.Display
{
    ...
    public partial class HdrConversionMode : Android.Os.Parcelable
    {
        ...
        public HdrConversionMode(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class HdrConversionMode
    {
        ...
        public HdrConversionMode(int arg0, int arg1) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0, arg1);
        }
        /// <summary>
        /// HPA initializer for HdrConversionMode(int arg0, int arg1)
        /// </summary>
        public static HdrConversionMode CreatePoolableInstance(int arg0, int arg1)
        {
            return JVMBridgeBase.New<HdrConversionMode>(arg0, arg1);
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/hardware/display/HdrConversionMode.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public HdrConversionMode(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for HdrConversionMode(int arg0)
        /// </summary>
        public static HdrConversionMode CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<HdrConversionMode>(arg0);
        }
        ...
        /// </summary>
        public static int HDR_CONVERSION_FORCE { get { return SGetField<int>(LocalBridgeClazz, "HDR_CONVERSION_FORCE"); } set { SSetField(LocalBridgeClazz, "HDR_CONVERSION_FORCE", value); } }
        /// <summary>
        ...
        /// </summary>
        public static int HDR_CONVERSION_PASSTHROUGH { get { return SGetField<int>(LocalBridgeClazz, "HDR_CONVERSION_PASSTHROUGH"); } set { SSetField(LocalBridgeClazz, "HDR_CONVERSION_PASSTHROUGH", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/hardware/display/HdrConversionMode.html#HDR_CONVERSION_SYSTEM"/>
        /// </summary>
        public static int HDR_CONVERSION_SYSTEM { get { return SGetField<int>(LocalBridgeClazz, "HDR_CONVERSION_SYSTEM"); } set { SSetField(LocalBridgeClazz, "HDR_CONVERSION_SYSTEM", value); } }
        /// <summary>
        ...
        /// </summary>
        public static int HDR_CONVERSION_UNSUPPORTED { get { return SGetField<int>(LocalBridgeClazz, "HDR_CONVERSION_UNSUPPORTED"); } set { SSetField(LocalBridgeClazz, "HDR_CONVERSION_UNSUPPORTED", value); } }
