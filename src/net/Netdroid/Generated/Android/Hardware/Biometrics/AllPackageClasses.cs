...
namespace Android.Hardware.Biometrics
{
    ...
    public partial class BiometricManager : MASES.JCOBridge.C2JBridge.JVMBridgeBase<BiometricManager>
    {
        ...
        public partial class Authenticators : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Authenticators>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("Authenticators class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
