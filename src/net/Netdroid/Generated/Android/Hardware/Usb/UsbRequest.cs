...
namespace Android.Hardware.Usb
{
    ...
    public partial class UsbRequest : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UsbRequest>
    {
        ...
        public UsbRequest(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region UsbRequest implementation
    public partial class UsbRequest
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/hardware/usb/UsbRequest.html#%3Cinit%3E()"/>
        /// </summary>
        public UsbRequest() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for UsbRequest()
        /// </summary>
        public static UsbRequest CreatePoolableInstance()
        {
            return JVMBridgeBase.New<UsbRequest>();
        }
        ...
        {
            return IExecuteWithSignature<bool>("initialize", "(Landroid/hardware/usb/UsbDeviceConnection;Landroid/hardware/usb/UsbEndpoint;)Z", arg0, arg1);
        }
        /// <summary>
        ...
        {
            return IExecuteWithSignature<bool>("queue", "(Ljava/nio/ByteBuffer;I)Z", arg0, arg1);
        }
        /// <summary>
