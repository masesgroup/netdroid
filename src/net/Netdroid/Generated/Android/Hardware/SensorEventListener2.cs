...
namespace Android.Hardware
{
    ...
    public partial class SensorEventListener2 : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public SensorEventListener2(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public SensorEventListener2(params object[] args) : base(args)
        {
            ...
            _hasSensorEventListener2SecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasSensorEventListener2SecondGate;
        ...
        /// <item><see cref="_hasSensorEventListener2SecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasSensorEventListener2SecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="SensorEventListener2"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="SensorEventListener2"/> instead.</para>
    /// </remarks>
    public partial class SensorEventListener2Direct : SensorEventListener2
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public SensorEventListener2Direct(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public SensorEventListener2Direct(params object[] args) : base(args) { }
    ...
    public partial class SensorEventListener2 : Android.Hardware.ISensorEventListener2
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideOnFlushCompleted = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnFlushCompleted), typeof(Android.Hardware.Sensor));
