...
namespace Android.Media.Midi
{
    ...
    public partial class MidiDeviceService : Android.App.Service
    {
        ...
        public MidiDeviceService(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class MidiDeviceService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/midi/MidiDeviceService.html#%3Cinit%3E()"/>
        /// </summary>
        public MidiDeviceService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for MidiDeviceService()
        /// </summary>
        public static MidiDeviceService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<MidiDeviceService>();
        }
