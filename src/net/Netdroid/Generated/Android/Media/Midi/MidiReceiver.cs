...
namespace Android.Media.Midi
{
    ...
    public partial class MidiReceiver : MASES.JCOBridge.C2JBridge.JVMBridgeBase<MidiReceiver>
    {
        ...
        public MidiReceiver(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class MidiReceiver
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/midi/MidiReceiver.html#%3Cinit%3E()"/>
        /// </summary>
        public MidiReceiver() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for MidiReceiver()
        /// </summary>
        public static MidiReceiver CreatePoolableInstance()
        {
            return JVMBridgeBase.New<MidiReceiver>();
        }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/midi/MidiReceiver.html#%3Cinit%3E(int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public MidiReceiver(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for MidiReceiver(int arg0)
        /// </summary>
        public static MidiReceiver CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<MidiReceiver>(arg0);
        }
