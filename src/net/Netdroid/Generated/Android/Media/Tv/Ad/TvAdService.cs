...
namespace Android.Media.Tv.Ad
{
    ...
    public partial class TvAdService
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/tv/ad/TvAdService.html#%3Cinit%3E()"/>
        /// </summary>
        public TvAdService() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for TvAdService()
        /// </summary>
        public static TvAdService CreatePoolableInstance()
        {
            return JVMBridgeBase.New<TvAdService>();
        }
