...
namespace Android.Media
{
    ...
    public partial class AudioTimestamp : Android.Os.Parcelable
    {
        ...
        public AudioTimestamp(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AudioTimestamp
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/AudioTimestamp.html#%3Cinit%3E()"/>
        /// </summary>
        public AudioTimestamp() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AudioTimestamp()
        /// </summary>
        public static AudioTimestamp CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AudioTimestamp>();
        }
        ...
        /// </summary>
        public static int TIMEBASE_BOOTTIME { get { return SGetField<int>(LocalBridgeClazz, "TIMEBASE_BOOTTIME"); } set { SSetField(LocalBridgeClazz, "TIMEBASE_BOOTTIME", value); } }
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/AudioTimestamp.html#TIMEBASE_MONOTONIC"/>
        /// </summary>
        public static int TIMEBASE_MONOTONIC { get { return SGetField<int>(LocalBridgeClazz, "TIMEBASE_MONOTONIC"); } set { SSetField(LocalBridgeClazz, "TIMEBASE_MONOTONIC", value); } }
