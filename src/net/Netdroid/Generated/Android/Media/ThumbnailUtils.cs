...
namespace Android.Media
{
    ...
    public partial class ThumbnailUtils : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ThumbnailUtils>
    {
        ...
        public ThumbnailUtils(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class ThumbnailUtils
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/ThumbnailUtils.html#%3Cinit%3E()"/>
        /// </summary>
        public ThumbnailUtils() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ThumbnailUtils()
        /// </summary>
        public static ThumbnailUtils CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ThumbnailUtils>();
        }
        ...
        /// </summary>
        public static int OPTIONS_RECYCLE_INPUT { get { return SGetField<int>(LocalBridgeClazz, "OPTIONS_RECYCLE_INPUT"); } set { SSetField(LocalBridgeClazz, "OPTIONS_RECYCLE_INPUT", value); } }
