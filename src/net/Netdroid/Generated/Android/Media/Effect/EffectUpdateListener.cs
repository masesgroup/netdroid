...
namespace Android.Media.Effect
{
    ...
    public partial class EffectUpdateListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public EffectUpdateListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public EffectUpdateListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasEffectUpdateListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasEffectUpdateListenerSecondGate;
        ...
        /// <item><see cref="_hasEffectUpdateListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasEffectUpdateListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="EffectUpdateListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="EffectUpdateListener"/> instead.</para>
    /// </remarks>
    public partial class EffectUpdateListenerDirect : EffectUpdateListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public EffectUpdateListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    
        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public EffectUpdateListenerDirect(params object[] args) : base(args) { }
    ...
    public partial class EffectUpdateListener : Android.Media.Effect.IEffectUpdateListener
    {
        ...
        {
            _OnEffectUpdatedEventHandlerIndex = AddEventHandler("onEffectUpdated", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnEffectUpdatedEventHandler));
            _hasOverrideOnEffectUpdated = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnEffectUpdated), typeof(Android.Media.Effect.Effect), typeof(object));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _OnEffectUpdatedEventHandlerIndex) return OnEffectUpdatedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnEffectUpdated"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnEffectUpdatedEventHandlerIndex = 0;
        
        /// <summary><see langword="true"/> if the user has overridden <see cref="OnEffectUpdated"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnEffectUpdated;
        ...
        bool OnEffectUpdatedEventOverridden() => _hasOverrideOnEffectUpdated || OnOnEffectUpdated != null;
        
        void OnEffectUpdatedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnEffectUpdatedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = OnEffectUpdatedEventOverridden();
        }
    ...
    public partial class EffectUpdateListenerDirect : Android.Media.Effect.IEffectUpdateListener
    {
        ...
        {
            IExecuteWithSignature("onEffectUpdated", "(Landroid/media/effect/Effect;Ljava/lang/Object;)V", arg0, arg1);
        }
