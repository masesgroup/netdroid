    ...
    public partial class AudioManager
    {
        ...
        public partial class OnPreferredMixerAttributesChangedListener
        {
            ...
            void OnPreferredMixerAttributesChangedEventHandler(object sender, CLRListenerEventArgs<CLREventData<Android.Media.AudioAttributes>> data)
            {
                ...
                methodToExecute.Invoke(data.EventData.TypedEventData, data.EventData.GetAt<Android.Media.AudioDeviceInfo>(0), data.EventData.GetAt<Android.Media.AudioMixerAttributes>(1));
            }
