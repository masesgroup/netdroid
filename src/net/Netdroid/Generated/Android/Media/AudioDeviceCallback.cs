...
namespace Android.Media
{
    ...
    public partial class AudioDeviceCallback
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/android/media/AudioDeviceCallback.html#%3Cinit%3E()"/>
        /// </summary>
        public AudioDeviceCallback() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AudioDeviceCallback()
        /// </summary>
        public static AudioDeviceCallback CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AudioDeviceCallback>();
        }
