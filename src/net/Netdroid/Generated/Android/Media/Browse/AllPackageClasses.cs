...
namespace Android.Media.Browse
{
    ...
    public partial class MediaBrowser : MASES.JCOBridge.C2JBridge.JVMBridgeBase<MediaBrowser>
    {
        ...
        public partial class ItemCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ItemCallback>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("ItemCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public ItemCallback() { }
            /// <summary>
            /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
            /// </summary>
        ...
        public partial class SubscriptionCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<SubscriptionCallback>
        {
            ...
            /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
            /// </summary>
            [Obsolete("SubscriptionCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
