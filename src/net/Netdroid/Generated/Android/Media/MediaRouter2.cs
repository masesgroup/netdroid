...
namespace Android.Media
{
    ...
    public partial class MediaRouter2 : MASES.JCOBridge.C2JBridge.JVMBridgeBase<MediaRouter2>
    {
        ...
        public MediaRouter2(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class OnGetControllerHintsListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
        {
            ...
            public OnGetControllerHintsListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnGetControllerHintsListener(params object[] args) : base(args)
            {
                var listenerRuntimeType = GetType();
                _hasOnGetControllerHintsListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
            ...
            /// </summary>
            readonly bool _hasOnGetControllerHintsListenerSecondGate;
            ...
            /// <item><see cref="_hasOnGetControllerHintsListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
            ...
            protected override bool ListenerShallManageEvent(int eventIndex)
            {
                ...
                return _hasOnGetControllerHintsListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
            }
        ...
        /// <summary>
        /// Concrete CLR representation of <see cref="OnGetControllerHintsListener"/> returned by the JVM.
        /// </summary>
        /// <remarks>
        ...
        /// <para>Do not use this class directly to register event handlers — use <see cref="OnGetControllerHintsListener"/> instead.</para>
        /// </remarks>
        public partial class OnGetControllerHintsListenerDirect : OnGetControllerHintsListener
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
            public OnGetControllerHintsListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        
            /// <summary>
            /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
            /// </summary>
            public OnGetControllerHintsListenerDirect(params object[] args) : base(args) { }
        ...
        public partial class RouteCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RouteCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public RouteCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class RoutingController : MASES.JCOBridge.C2JBridge.JVMBridgeBase<RoutingController>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public RoutingController(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class ScanRequest : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ScanRequest>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public ScanRequest(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class ScanToken : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ScanToken>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public ScanToken(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public partial class TransferCallback : MASES.JCOBridge.C2JBridge.JVMBridgeBase<TransferCallback>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public TransferCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class MediaRouter2
    {
        ...
        public partial class ControllerCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/media/MediaRouter2.ControllerCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public ControllerCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for ControllerCallback()
            /// </summary>
            public static ControllerCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<ControllerCallback>();
            }
        ...
        public partial class OnGetControllerHintsListener
        {
            ...
            {
                _OnGetControllerHintsEventHandlerIndex = AddEventHandler("onGetControllerHints", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnGetControllerHintsEventHandler));
                _hasOverrideOnGetControllerHints = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnGetControllerHints), typeof(Android.Media.MediaRoute2Info));

            }
            /// <inheritdoc/>
            protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
            {
                if (eventIndex == _OnGetControllerHintsEventHandlerIndex) return OnGetControllerHintsEventOverridden();
            ...
            /// </summary>
            /// <remarks>Set <see cref="OnOnGetControllerHintsDispose"/> when the event handler returns a JVM-backed object
            ...
            public global::System.Action<Android.Os.Bundle> OnOnGetControllerHintsDispose { get; set; } = null;
            
            /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnGetControllerHints"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
            int _OnGetControllerHintsEventHandlerIndex = 0;
            
            /// <summary><see langword="true"/> if the user has overridden <see cref="OnGetControllerHints"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
            bool _hasOverrideOnGetControllerHints;
            ...
            bool OnGetControllerHintsEventOverridden() => _hasOverrideOnGetControllerHints || OnOnGetControllerHints != null;
            
            void OnGetControllerHintsEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
            {
                if (!OnGetControllerHintsEventOverridden()) // guard: no handler registered — return without reading data.
                ...
                data.EventData.SetReturnData(OnGetControllerHintsEventOverridden(), executionResult);
                OnOnGetControllerHintsDispose?.Invoke(executionResult);
            }
        ...
        public partial class RouteCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/media/MediaRouter2.RouteCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public RouteCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for RouteCallback()
            /// </summary>
            public static RouteCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<RouteCallback>();
            }
        ...
        public partial class ScanRequest
        {
            ...
            public partial class Builder
            {
                #region Constructors
                /// <summary>
                /// <see href="https://developer.android.com/reference/android/media/MediaRouter2.ScanRequest.Builder.html#%3Cinit%3E()"/>
                /// </summary>
        ...
        public partial class TransferCallback
        {
            #region Constructors
            /// <summary>
            /// <see href="https://developer.android.com/reference/android/media/MediaRouter2.TransferCallback.html#%3Cinit%3E()"/>
            /// </summary>
            public TransferCallback() : base(JVMBridgeBase.InitializerInstance)
            {
                InvokeInitializer();
            }
            /// <summary>
            /// HPA initializer for TransferCallback()
            /// </summary>
            public static TransferCallback CreatePoolableInstance()
            {
                return JVMBridgeBase.New<TransferCallback>();
            }
