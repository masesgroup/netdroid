...
{
    #region LoudnessEnhancer declaration
    /// <summary>
    ...
    public partial class LoudnessEnhancer : Android.Media.Audiofx.AudioEffect
    {
        ...
        public LoudnessEnhancer(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    #region LoudnessEnhancer implementation
    public partial class LoudnessEnhancer
    {
        ...
        public LoudnessEnhancer(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer(arg0);
        }
        /// <summary>
        /// HPA initializer for LoudnessEnhancer(int arg0)
        /// </summary>
        public static LoudnessEnhancer CreatePoolableInstance(int arg0)
        {
            return JVMBridgeBase.New<LoudnessEnhancer>(arg0);
        }
        ...
        /// </summary>
        public static int PARAM_TARGET_GAIN_MB { get { return SGetField<int>(LocalBridgeClazz, "PARAM_TARGET_GAIN_MB"); } set { SSetField(LocalBridgeClazz, "PARAM_TARGET_GAIN_MB", value); } }
