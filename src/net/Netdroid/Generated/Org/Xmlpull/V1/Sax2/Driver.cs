...
namespace Org.Xmlpull.V1.Sax2
{
    ...
    public partial class Driver : Org.Xml.Sax.IAttributes, Org.Xml.Sax.ILocator, Org.Xml.Sax.IXMLReader
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/org/xmlpull/v1/sax2/Driver.html#%3Cinit%3E()"/>
        /// </summary>

        /// <exception cref="Org.Xmlpull.V1.XmlPullParserException"/>
        public Driver() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        {
            return JVMBridgeBase.New<Driver>();
        }
        /// <summary>
        ...
        /// <exception cref="Org.Xmlpull.V1.XmlPullParserException"/>
        public Driver(Org.Xmlpull.V1.XmlPullParser arg0) : base(JVMBridgeBase.InitializerInstance)
        {
        ...
        /// </summary>
        public static Driver CreatePoolableInstance(Org.Xmlpull.V1.XmlPullParser arg0)
        {
            return JVMBridgeBase.New<Driver>(arg0);
        }
