...
namespace Org.Xml.Sax
{
    ...
    public partial class HandlerBase : Org.Xml.Sax.IEntityResolver, Org.Xml.Sax.IDTDHandler, Org.Xml.Sax.IDocumentHandler, Org.Xml.Sax.IErrorHandler
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/org/xml/sax/HandlerBase.html#%3Cinit%3E()"/>
        /// </summary>
        public HandlerBase() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        public static HandlerBase CreatePoolableInstance()
        {
