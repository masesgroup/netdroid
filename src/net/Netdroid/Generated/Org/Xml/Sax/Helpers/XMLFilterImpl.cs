...
namespace Org.Xml.Sax.Helpers
{
    ...
    public partial class XMLFilterImpl : MASES.JCOBridge.C2JBridge.JVMBridgeBase<XMLFilterImpl>
    {
        ...
        public XMLFilterImpl(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class XMLFilterImpl : Org.Xml.Sax.IXMLFilter, Org.Xml.Sax.IEntityResolver, Org.Xml.Sax.IDTDHandler, Org.Xml.Sax.IContentHandler, Org.Xml.Sax.IErrorHandler
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/org/xml/sax/helpers/XMLFilterImpl.html#%3Cinit%3E()"/>
        /// </summary>
        public XMLFilterImpl() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
