...
namespace Org.Xml.Sax.Helpers
{
    ...
    public partial class DefaultHandler : Org.Xml.Sax.IEntityResolver, Org.Xml.Sax.IDTDHandler, Org.Xml.Sax.IContentHandler, Org.Xml.Sax.IErrorHandler
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/org/xml/sax/helpers/DefaultHandler.html#%3Cinit%3E()"/>
        /// </summary>
        public DefaultHandler() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
