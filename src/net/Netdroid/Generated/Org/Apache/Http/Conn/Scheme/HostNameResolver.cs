...
{
    #region HostNameResolver declaration
    /// <summary>
    ...
    public partial class HostNameResolver : MASES.JCOBridge.C2JBridge.JVMBridgeBase<HostNameResolver>
    {
        ...
        public HostNameResolver(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IHostNameResolver
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/org/apache/http/conn/scheme/HostNameResolver.html"/>
    /// </summary>
    ...
    #region HostNameResolver implementation
