...
namespace Org.Apache.Http.Conn.Ssl
{
    ...
    public partial class AbstractVerifier : Org.Apache.Http.Conn.Ssl.X509HostnameVerifier
    {
        ...
        public AbstractVerifier(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class AbstractVerifier
    {
        #region Constructors
        /// <summary>
        /// <see href="https://developer.android.com/reference/org/apache/http/conn/ssl/AbstractVerifier.html#%3Cinit%3E()"/>
        /// </summary>
        [global::System.Obsolete("Deprecated in JVM")]
        public AbstractVerifier() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for AbstractVerifier()
        /// </summary>
        public static AbstractVerifier CreatePoolableInstance()
        {
            return JVMBridgeBase.New<AbstractVerifier>();
        }
