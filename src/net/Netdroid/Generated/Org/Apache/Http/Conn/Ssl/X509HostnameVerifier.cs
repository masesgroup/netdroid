...
{
    #region X509HostnameVerifier declaration
    /// <summary>
    ...
    public partial class X509HostnameVerifier : Javax.Net.Ssl.HostnameVerifier
    {
        ...
        public X509HostnameVerifier(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://developer.android.com/reference/org/apache/http/conn/ssl/X509HostnameVerifier.html"/>
    /// </summary>
    ...
    #region X509HostnameVerifier implementation
    public partial class X509HostnameVerifier : Org.Apache.Http.Conn.Ssl.IX509HostnameVerifier
    {
        ...
        {
            IExecuteWithSignature("verify", "(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V", arg0, arg1, arg2);
        }
        /// <summary>
