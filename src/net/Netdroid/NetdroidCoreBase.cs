...
namespace MASES.Netdroid
{
    ...
    /// <summary>
    /// Public entry point of <see cref="NetdroidCoreBase{T}"/>
    /// </summary>
    public abstract class NetdroidCoreBase<T> : SetupJVMWrapper<T> where T : NetdroidCoreBase<T>
    {
        #region Public const
        /// <summary>
